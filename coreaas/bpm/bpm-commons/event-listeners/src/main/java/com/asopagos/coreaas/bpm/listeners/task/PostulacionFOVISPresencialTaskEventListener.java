 ...
 *
 */
public class PostulacionFOVISPresencialTaskEventListener extends CoreTaskEventListener {

	/**
	 * Constructor por defecto de la clase
	 * @param runtimeManager
	 */
	public PostulacionFOVISPresencialTaskEventListener(RuntimeManager runtimeManager) {
