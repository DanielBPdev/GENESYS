...
public class SubsidioMonetarioEspecificoTaskEventListener extends CoreTaskEventListener {

	public SubsidioMonetarioEspecificoTaskEventListener(RuntimeManager runtimeManager) {
