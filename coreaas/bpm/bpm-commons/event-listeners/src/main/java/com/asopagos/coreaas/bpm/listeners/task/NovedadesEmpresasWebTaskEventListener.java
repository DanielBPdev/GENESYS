 ...
 *
 */
public class NovedadesEmpresasWebTaskEventListener extends CoreTaskEventListener {

	/**
	 * Constructor por defecto de la clase
	 * @param runtimeManager
	 */
	public NovedadesEmpresasWebTaskEventListener(RuntimeManager runtimeManager) {
