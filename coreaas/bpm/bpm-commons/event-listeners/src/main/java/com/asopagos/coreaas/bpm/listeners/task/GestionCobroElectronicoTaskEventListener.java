...
public class GestionCobroElectronicoTaskEventListener extends CoreTaskEventListener {

	public GestionCobroElectronicoTaskEventListener(RuntimeManager runtimeManager) {
