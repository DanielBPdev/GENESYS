 ...
 * proceso de Analisis de Novedad Persona que afecta postulacion FOVIS
 * @author Jose Arley Correa Salamanca <jocorrea@heinsohn.com.co>
 *
 */
public class AnalisisPostulacionFovisNovedadTaskEventListener extends CoreTaskEventListener {

    /**
     * Constructor por defecto de la clase
     * @param runtimeManager
     */
    public AnalisisPostulacionFovisNovedadTaskEventListener(RuntimeManager runtimeManager) {
        super(runtimeManager);
    }

    /**
     * Adiciona al contexto del proceso el identificador de la solicitud
     * de Analisis de Novedad Persona que afecta postulacion FOVIS.
     */
    @Override
