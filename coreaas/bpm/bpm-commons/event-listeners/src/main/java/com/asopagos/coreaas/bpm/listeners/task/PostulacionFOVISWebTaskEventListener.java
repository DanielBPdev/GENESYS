 ...
 *
 */
public class PostulacionFOVISWebTaskEventListener extends CoreTaskEventListener {

	/**
	 * Constructor por defecto de la clase
	 * @param runtimeManager
	 */
	public PostulacionFOVISWebTaskEventListener(RuntimeManager runtimeManager) {
