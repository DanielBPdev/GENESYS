...
public class GestionPreventivaCarteraActualizacionTaskEventListener extends CoreTaskEventListener {

    public GestionPreventivaCarteraActualizacionTaskEventListener(RuntimeManager runtimeManager) {
