...
public class CorreccionesAportesTaskEventListener extends CoreTaskEventListener {

    public CorreccionesAportesTaskEventListener(RuntimeManager runtimeManager) {
