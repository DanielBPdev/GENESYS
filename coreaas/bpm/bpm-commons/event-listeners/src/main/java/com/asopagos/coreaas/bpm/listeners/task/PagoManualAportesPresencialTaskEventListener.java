...
public class PagoManualAportesPresencialTaskEventListener  extends CoreTaskEventListener {

	public PagoManualAportesPresencialTaskEventListener(RuntimeManager runtimeManager) {
