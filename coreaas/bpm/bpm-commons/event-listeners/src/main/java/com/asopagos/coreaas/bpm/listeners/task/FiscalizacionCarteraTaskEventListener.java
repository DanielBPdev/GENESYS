...
public class FiscalizacionCarteraTaskEventListener extends CoreTaskEventListener {

	public FiscalizacionCarteraTaskEventListener(RuntimeManager runtimeManager) {
