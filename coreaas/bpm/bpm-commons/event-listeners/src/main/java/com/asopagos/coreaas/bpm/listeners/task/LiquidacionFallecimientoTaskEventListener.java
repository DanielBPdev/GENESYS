...
public class LiquidacionFallecimientoTaskEventListener extends CoreTaskEventListener {

	public LiquidacionFallecimientoTaskEventListener(RuntimeManager runtimeManager) {
