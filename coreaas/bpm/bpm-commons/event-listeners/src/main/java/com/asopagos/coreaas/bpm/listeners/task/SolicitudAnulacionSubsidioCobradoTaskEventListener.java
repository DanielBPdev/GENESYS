...
public class SolicitudAnulacionSubsidioCobradoTaskEventListener extends CoreTaskEventListener {

	public SolicitudAnulacionSubsidioCobradoTaskEventListener(RuntimeManager runtimeManager) {
