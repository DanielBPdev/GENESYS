...
public class SubsidioMonetarioMasivoTaskEventListener extends CoreTaskEventListener {

	public SubsidioMonetarioMasivoTaskEventListener(RuntimeManager runtimeManager) {
