 ...
 * proceso de Legalizacion y Desembolso FOVIS.
 * @author flopez
 *
 */
public class LegalizacionDesembolsoFOVISTaskEventListener extends CoreTaskEventListener {

	/**
	 * Constructor por defecto de la clase
	 * @param runtimeManager
	 */
	public LegalizacionDesembolsoFOVISTaskEventListener(RuntimeManager runtimeManager) {
