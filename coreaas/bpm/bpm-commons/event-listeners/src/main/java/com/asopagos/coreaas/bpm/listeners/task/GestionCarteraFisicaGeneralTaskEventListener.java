...
public class GestionCarteraFisicaGeneralTaskEventListener extends CoreTaskEventListener {

	public GestionCarteraFisicaGeneralTaskEventListener(RuntimeManager runtimeManager) {
