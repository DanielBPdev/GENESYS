 ...
 * proceso de Registro Novedades especiales FOVIS
 * @author Jose Arley Correa Salamanca <jocorrea@heinsohn.com.co>
 *
 */
public class NovedadesEspecialesFOVISTaskEventListener extends CoreTaskEventListener {

    /**
     * Constructor por defecto de la clase
     * @param runtimeManager
     */
    public NovedadesEspecialesFOVISTaskEventListener(RuntimeManager runtimeManager) {
        super(runtimeManager);
    }

    /**
     * Adiciona al contexto del proceso el identificador de la solicitud
     * de Registro Novedades especiales FOVIS.
     */
    @Override
