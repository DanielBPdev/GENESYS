 ...
 *
 */
public class NovedadesPersonaWebTaskEventListener extends CoreTaskEventListener {

	/**
	 * Constructor por defecto de la clase
	 * @param runtimeManager
	 */
	public NovedadesPersonaWebTaskEventListener(RuntimeManager runtimeManager) {
