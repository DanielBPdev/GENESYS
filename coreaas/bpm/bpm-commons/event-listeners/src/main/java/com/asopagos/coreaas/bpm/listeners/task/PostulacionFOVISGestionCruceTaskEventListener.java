 ...
 *
 */
public class PostulacionFOVISGestionCruceTaskEventListener extends CoreTaskEventListener {

	/**
	 * Constructor por defecto de la clase
	 * @param runtimeManager
	 */
	public PostulacionFOVISGestionCruceTaskEventListener(RuntimeManager runtimeManager) {
