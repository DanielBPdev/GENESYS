...
public class DesafiliacionAportantesTaskEventListener extends CoreTaskEventListener {

	public DesafiliacionAportantesTaskEventListener(RuntimeManager runtimeManager) {
