 ...
 *
 */
public class NovedadesDependienteWebTaskEventListener extends CoreTaskEventListener {

	/**
	 * Constructor por defecto de la clase
	 * @param runtimeManager
	 */
	public NovedadesDependienteWebTaskEventListener(RuntimeManager runtimeManager) {
