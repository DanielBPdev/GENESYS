 ...
 *
 */
public class NovedadesPersonaPresencialTaskEventListener extends CoreTaskEventListener {

	/**
	 * Constructor por defecto de la clase
	 * @param runtimeManager
	 */
	public NovedadesPersonaPresencialTaskEventListener(RuntimeManager runtimeManager) {
