 ...
 */
@XmlRootElement
public class ResultadoValidacionArchivoTrasladoDTO implements Serializable {
	 ...
	 * 
	 */
	private List<AfiliadosMasivosDTO> listaCandidatosAfiliar;
	

	/**
	 * Lista de afiliaciones cargo
	 * 
	 */
	private List<AfiliadosACargoMasivosDTO> listaCandidatosCargoAfiliar;
	...
	public ResultadoValidacionArchivoTrasladoDTO() {
	...
	/*
	 * */
	 public List<AfiliadosMasivosDTO> getListaCandidatosAfiliar() {
		 return listaCandidatosAfiliar;
		 
	 }
	 

	 public void setListaCandidatosAfiliar(List<AfiliadosMasivosDTO> listaCandidatosAfiliar) {
		this.listaCandidatosAfiliar = listaCandidatosAfiliar;
	}
	/*
	 * */
	 public List<AfiliadosACargoMasivosDTO> getListaCandidatosCargoAfiliar() {
		 return listaCandidatosCargoAfiliar;
		 
	 }
	 

	 public void setListaCandidatosCargoAfiliar(List<AfiliadosACargoMasivosDTO> listaCandidatosCargoAfiliar) {
		this.listaCandidatosCargoAfiliar = listaCandidatosCargoAfiliar;
	}
	...
	public Long getIdCargueCargo() {
		return this.idCargueCargo;
	}

	public void setIdCargueCargo(Long idCargueCargo) {
		this.idCargueCargo = idCargueCargo;
	}
