...
/**
 * <b>Descripción:</b> DTO transportar los datos de creacion multiple de usuarios
 *
 * 
 */
@XmlRootElement
public class ResultadoValidacionArchivoGestionUsuariosDTO implements Serializable {
    ...
    /** 82800
     * Lista de informacion a revisar para la creacion de usuarios masivos
     */
    private List<UsuarioGestionDTO> listCrearUsuarioGestion;
    ...
    public ResultadoValidacionArchivoGestionUsuariosDTO() {
    ...
    /** 82800
     * @return the listCrearUsuarioGestion
     */
    public List<UsuarioGestionDTO> getListCrearUsuarioGestion() {
        return listCrearUsuarioGestion;
    }

    /** 82800
     * @param listCrearUsuarioGestion the listCrearUsuarioGestion to set
     */
    public void setListCrearUsuarioGestion(List<UsuarioGestionDTO> listCrearUsuarioGestion) {
        this.listCrearUsuarioGestion = listCrearUsuarioGestion;
    }
