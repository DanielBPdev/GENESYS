 ...
 *
 */
public class SolicitudNovedadFovisModeloDTO extends SolicitudModeloDTO implements Serializable {
    ...
    public SolicitudNovedadFovisModeloDTO() {
    }

    public SolicitudNovedadFovisModeloDTO(SolicitudNovedadFovis SolicitudNovedadFovis) {
