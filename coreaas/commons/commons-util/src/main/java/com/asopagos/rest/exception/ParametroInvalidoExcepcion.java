 ...
 */
public class ParametroInvalidoExcepcion extends AsopagosException {
    /**
     ...
     */
    public ParametroInvalidoExcepcion(String message, Object... params) {
     ...
     */
    public ParametroInvalidoExcepcion(Throwable cause) {
        super(cause);
    }
     ...
     */
    public ParametroInvalidoExcepcion(String message, Throwable causa, Object... params) {
