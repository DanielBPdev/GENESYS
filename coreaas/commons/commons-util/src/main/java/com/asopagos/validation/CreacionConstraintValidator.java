 ...
 * se anotan con ValidacionCreacion 
 * <b>Historia de Usuario:</b> Transversal
 * 
 * @author Sergio Briñez <sbrinez@heinsohn.com.co>
 */
public class CreacionConstraintValidator implements ConstraintValidator<ValidacionCreacion, Object> {
     ...
     */
    @Override
    public void initialize(ValidacionCreacion params) {
    ...
    private boolean validarObjeto(Object object, ConstraintValidatorContext context) {
        Set<ConstraintViolation<Object>> constraintViolations = validator.validate(object, GrupoCreacion.class);
