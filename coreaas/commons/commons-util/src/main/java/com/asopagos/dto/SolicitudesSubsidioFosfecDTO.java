...
/**
 * Contiene información sobre la solicitudes de subsidio de desempleo que se han
...
public class SolicitudesSubsidioFosfecDTO  implements Serializable {
	 ...
	 */
	public SolicitudesSubsidioFosfecDTO(String tipoVinculacion, String ultimaCcf, String fechaPostulacion,
