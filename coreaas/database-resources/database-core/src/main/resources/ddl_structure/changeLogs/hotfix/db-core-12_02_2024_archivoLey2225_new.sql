IF NOT EXISTS (SELECT 1 FROM Parametro WHERE prmNombre = 'FILE_DEFINITION_ID_LEY_2225') INSERT Parametro (prmNombre,prmValor,prmCargaInicio,prmSubCategoriaParametro,prmDescripcion) VALUES ('FILE_DEFINITION_ID_LEY_2225','1800','0','FILE_DEFINITION','Identificador de definición de archivo de componente FileProcessing para cargue de archivo de ley 2225');

IF NOT EXISTS (SELECT 1 FROM FileDefinitionLoadType WHERE id = 1800) INSERT FileDefinitionLoadType (id,name,description) VALUES (1800,'ley 2225','Identificador de definición de archivo de ley 2225');

IF NOT EXISTS (SELECT 1 FROM [Constante] WHERE [cnsNombre] = N'FILE_DEFINITION_ID_LEY_2225') INSERT [Constante] ([cnsNombre], [cnsValor], [cnsDescripcion]) VALUES (N'FILE_DEFINITION_ID_LEY_2225', N'1800', N'Identificador de definición de archivo de componente FileProcessing para cargue de archivo de ley 2225');

IF NOT EXISTS (SELECT 1 FROM FileDefinitionLoad WHERE id = 1800) INSERT FileDefinitionLoad (id,decimalSeparator,nombre,tenantid,thousandsSeparator,excludeLines,registersRead,sheetNumberXls,useCharacters,fileDefinitionType_id) VALUES (1800,'.','Archivo de ley 2225',NULL,NULL,0,NULL,NULL,0,1800);

IF NOT EXISTS (SELECT 1 FROM LineLoadCatalog WHERE id = 1800) INSERT LineLoadCatalog (id,classname,description,name,tenantId,lineOrder,lineSeparator,targetEntity) VALUES (1800,'com.asopagos.novedades.personas.web.load.Ley2225PersistLine','Estructura del archivo de ley 2225','Estructura de respuesta con los registros encontrados',NULL,1,'|',NULL);

IF NOT EXISTS (SELECT 1 FROM LineDefinitionLoad WHERE id = 1800) INSERT LineDefinitionLoad (id,identifier,numberGroup,required,requiredInGroup,rollbackOrder,fileDefinition_id,lineLoadCatalog_id) VALUES (1800,NULL,NULL,1,NULL,1,1800,1800);

IF NOT EXISTS (SELECT 1 FROM ValidatorCatalog WHERE id = 1800) INSERT ValidatorCatalog (id,className,description,name,scope,tenantId) VALUES (1800,'com.asopagos.novedades.personas.web.load.validator.Ley2225LineValidator','Validador de linea de archivo de ley 2225','Validador de linea de archivo de ley 2225','LINE',NULL);

IF NOT EXISTS (SELECT 1 FROM ValidatorDefinition WHERE id = 1800) INSERT ValidatorDefinition (id,excludeLine,stopProcess,validatorOrder,fieldDefinition_id,fileDefinitionLoad_id,lineDefinition_id,validatorCatalog_id) VALUES (1800,0,0,1,NULL,NULL,1800,1800);


IF NOT EXISTS (SELECT 1 FROM FieldLoadCatalog WHERE id IN (300001000,
300001001,
300001002,
300001003,
300001004,
...
300001015,
300001016,
300001017)) insert into FieldLoadCatalog (id,dataType, description, name, fieldOrder) values
...
300001015,
300001016,
300001017)) insert into FieldDefinitionLoad (id,finalPosition, formatDate, initialPosition, label, identifierLine, removeFormat, required,fieldLoadCatalog_id, lineDefinition_id) values
