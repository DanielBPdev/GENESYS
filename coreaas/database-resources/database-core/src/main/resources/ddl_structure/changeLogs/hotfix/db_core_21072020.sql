...
IF EXISTS ( SELECT * FROM sys.external_tables WHERE object_id = OBJECT_ID('pila.RegistroDetallado') )
    DROP EXTERNAL TABLE pila.RegistroDetallado;
    
CREATE EXTERNAL TABLE [pila].[RegistroDetallado](
