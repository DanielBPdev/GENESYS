...
<p style="text-align: center; ;font-size: 10px;">________________________________________________<br />Firma de solicitante&nbsp; &nbsp; &nbsp;</p>
<p style="text-align: center; ;font-size: 10px;">&nbsp;</p>
<p style="text-align: right; ;font-size: 10px;"><strong>Fecha de impresi&oacute;n: ${fechaSistema}</strong></p>'
WHERE pcoEtiqueta  = 'ACRDS_TRMS_CDNES_PERS_PENS_IDPTE';