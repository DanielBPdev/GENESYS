/****** Object:  StoredProcedure [dbo].[SP_FOVIS_Procesos_archivo_Cruces]    Script Date: 30/10/2023 16:32:39 ******/
-- =============================================
-- Author:      <John Martínez>
-- Create Date: <2023-09-20>
-- Description: <Creación tabla temporal para generación de vista de archivo de cruces>
-- =============================================
CREATE PROCEDURE [dbo].[SP_FOVIS_Procesos_archivo_Cruces]
(
	@idCargue bigint
)
AS
...
where cfcCargueArchivoCruceFovis = @idCargue
  AND pofEstadoHogar in ('POSTULADO','HABIL','HABIL_SEGUNDO_ANIO')
  AND crdid IS NULL AND cfbNitEntidad <> @NitCCF
...
where cfcCargueArchivoCruceFovis = @idCargue
  AND pofEstadoHogar in ('POSTULADO','HABIL','HABIL_SEGUNDO_ANIO')
  AND crdid IS NOT NULL AND cfbNitEntidad <> @NitCCF
