...
-- Description:	Define el cursor para obtener la información del comunicado PRI_AVI_COB_PRS (PRIMER AVISO DE COBRO PERSUASIVO)
-- =======================================================================================================================================
CREATE PROCEDURE [dbo].[USP_UTIL_CURSOR_PRI_AVI_COB_PRS] 
	@idPlantilla bigint, 
...
AS
 ...
 SET @paramCursor = CURSOR FAST_FORWARD FOR
	...
	(
			...
			CONVERT(VARCHAR, '${tabla}') as llave8, 'com.asopagos.comunicados.ejb.ConsultaReporteComunicado125TablaCobroPersuasivo' as valor8,
