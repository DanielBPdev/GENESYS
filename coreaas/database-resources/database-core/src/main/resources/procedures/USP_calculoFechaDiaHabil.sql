...
AS
BEGIN
	DECLARE @fechasMesConFestivo AS TABLE (fecha DATE, dia VARCHAR(9), esFestivo BIT)
	DECLARE @diasHabiles AS TABLE (fecha DATE, diaHabil SMALLINT, esFestivo BIT)
	...
	INSERT INTO @fechasMesConFestivo (fecha, dia, esFestivo)
	SELECT fecha, dia, 
		CASE
	...
	INSERT INTO @diasHabiles (fecha, diaHabil)
