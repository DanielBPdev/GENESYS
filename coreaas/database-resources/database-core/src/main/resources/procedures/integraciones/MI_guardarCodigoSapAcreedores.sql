...
-- =============================================
CREATE OR ALTER PROCEDURE [sap].[MI_guardarCodigoSapAcreedores]
...
BEGIN
	...
	Exec SAP.sp_CambioCodigoSAPAcreedor @e_codigoGenesys,@e_codigoSAP;-- añadido John Sotelo 27052022
