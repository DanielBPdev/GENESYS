...
-- =============================================
CREATE PROCEDURE USP_GET_NovedadesAfiliadosSubsidios
	@dFechaInicial DATE,
	@dFechaFin DATE,
	@bCount BIT
...
SET NOCOUNT ON;
	...
	CREATE TABLE #PersonasModificacionDatosBasicos(perId BIGINT, actualNumeroId VARCHAR(16) COLLATE Latin1_General_CI_AI , actualTipoId VARCHAR(20) COLLATE Latin1_General_CI_AI , anteriorNumeroId VARCHAR(16) COLLATE Latin1_General_CI_AI , anteriorTipoId VARCHAR(20) COLLATE Latin1_General_CI_AI, sl VARCHAR(500) )
