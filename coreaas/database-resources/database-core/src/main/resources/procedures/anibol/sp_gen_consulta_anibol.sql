CREATE OR ALTER PROCEDURE [dbo].[sp_gen_consulta_anibol] 
...
@IdNov INT,
@identTransaccion INT,--0 sin filtro, 1 afiliacion y 2 novedad, 3 activ. benef.,
-- Inicio Filtros GLPI 50959		*********************
@categoriaAB INT,
