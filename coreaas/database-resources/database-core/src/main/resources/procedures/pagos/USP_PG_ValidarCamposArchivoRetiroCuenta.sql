...
AS
	...
	DECLARE @casNombreTerceroPagado varchar(200)
	...
	BEGIN
		...
		BEGIN	
				...
				BEGIN
					...
					VALUES('TIPO_IDENTIFICACION_ADMININISTRADOR_SUBSIDIO',@TipoIdAdminCampo,@TipoIdAdminSubsidioCuenta,'No coincide el tipo de identificación del Administrador del subsidio',@IdRegistroArchivoRetiro)
				...
				BEGIN
					...
					INSERT INTO CampoArchivoRetiroTerceroPagador (carDescripcionCampo,carValorCampoArchivo,carValorCampoCuentaAdminSubsidio,carInconsistencia,carRegistroArchivoRetiroTerceroPagador) 
					VALUES('NUMERO_IDENTIFICACION_ADMININSTRADOR_SUBSIDIO',@NumeroIdAdminCampo,@NumeroIdAdminSubsidioCuenta,'No coincide el número de identificación del Administrador del subsidio',@IdRegistroArchivoRetiro)
				...
				BEGIN
					INSERT INTO CampoArchivoRetiroTerceroPagador (carDescripcionCampo,carValorCampoArchivo,carValorCampoCuentaAdminSubsidio,carInconsistencia,carRegistroArchivoRetiroTerceroPagador) 
					VALUES('VALOR_REAL_TRANSACCION',@ValorRealTransaccionCampo,@ValorRealTransaccionCuenta,'No coincide el valor real de la transacción',@IdRegistroArchivoRetiro)
				...
				BEGIN
					...
					BEGIN
						INSERT INTO CampoArchivoRetiroTerceroPagador (carDescripcionCampo,carValorCampoArchivo,carValorCampoCuentaAdminSubsidio,carInconsistencia,carRegistroArchivoRetiroTerceroPagador) 
						VALUES('FECHA_TRANSACCION',@FechaCampo,@FechaCuenta,'No coincide la fecha de transacción',@IdRegistroArchivoRetiro)
					...
					BEGIN
						INSERT INTO CampoArchivoRetiroTerceroPagador (carDescripcionCampo,carValorCampoArchivo,carValorCampoCuentaAdminSubsidio,carInconsistencia,carRegistroArchivoRetiroTerceroPagador) 
						VALUES('HORA_TRANSACCION',@HoraCampo,@HoraCuenta,'No coincide la hora de transacción',@IdRegistroArchivoRetiro)
				...
				BEGIN
					INSERT INTO CampoArchivoRetiroTerceroPagador (carDescripcionCampo,carValorCampoArchivo,carValorCampoCuentaAdminSubsidio,carInconsistencia,carRegistroArchivoRetiroTerceroPagador) 
					VALUES('DEPARTAMENTO',@CodigoDepartamentoCampo,@CodigoDepartamentoCuenta,'No coincide el Departamento del sitio de cobro',@IdRegistroArchivoRetiro)
				...
				BEGIN
					INSERT INTO CampoArchivoRetiroTerceroPagador (carDescripcionCampo,carValorCampoArchivo,carValorCampoCuentaAdminSubsidio,carInconsistencia,carRegistroArchivoRetiroTerceroPagador) 
					VALUES('MUNICIPIO',@CodigoMunicipioCampo,@CodigoMunicipioCuenta,'No coincide el Municipio del sitio de cobro',@IdRegistroArchivoRetiro)
				...
				--Se compara si el código del municipio no coinciden
				--comentado de acurdo a que registraba como inconcistencia el nombre y funcionalmnete esta bien, ya que cumple con el objetivo
				/*IF @casNombreTerceroPagado IS NOT NULL
				BEGIN
					INSERT INTO CampoArchivoRetiroTerceroPagador (carDescripcionCampo,carValorCampoArchivo,carValorCampoCuentaAdminSubsidio,carInconsistencia,carRegistroArchivoRetiroTerceroPagador) 
					VALUES('MUNICIPIO',@CodigoMunicipioCampo,@CodigoMunicipioCuenta,'Registro previamente conciliado',@IdRegistroArchivoRetiro)						
					SET @RespuestaEstadoArchivo ='PROCESADO_CON_INCONSISTENCIA'				
				END  */
			BREAK;
		END 
