...
-- Description:	SP para registrar la confirmación de Abonos Bancarios Exitosos y No Exitosos
-- =============================================
CREATE PROCEDURE [dbo].[USP_PG_ConfirmarAbonosMedioPagoBancos]
...
BEGIN TRY
	...
	FROM CuentaAdministradorSubsidio
		...
		AND casId NOT IN (SELECT casId from #abonosNoExito)
