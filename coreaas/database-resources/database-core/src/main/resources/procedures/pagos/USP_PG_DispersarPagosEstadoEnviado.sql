...
-- Description:	SP para actualizar el estado de la transaccion de los pagos exitosos
-- =============================================
CREATE PROCEDURE [dbo].[USP_PG_DispersarPagosEstadoEnviado]
...
BEGIN CATCH
	...
	VALUES (dbo.GetLocalDate(),'[USP_PG_DispersarPagosEstadoEnviado]' ,ERROR_MESSAGE());
END CATCH
	print 'Finaliza USP_PG_DispersarPagosEstadoEnviado'
END ;