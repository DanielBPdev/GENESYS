...
--comment: Scripts para el comunicado VariableComunicado Rechazo de solicitud de afiliación de empleador por producto no conforme no subsanable, por mantis 0219178
-- Scripts para el comunicado:
-- Rechazo de solicitud de afiliación de empleador por producto no conforme no subsanable, por mantis 0219178
...
--comment: Actualización roaTipoContrato
UPDATE ROLAFILIADO SET roaTipoContrato='TERMINO_FIJO' WHERE roaTipoContrato='TIPO_1';
UPDATE ROLAFILIADO SET roaTipoContrato='TERMINO_INDEFINIDO' WHERE roaTipoContrato='TIPO_2';

--changeset   lzarate:03
--comment: Datos Parametro HU-123-374
INSERT INTO Parametro (prmNombre,prmValor) VALUES ('BPMS_PROCESS_AFIL_IND_WEB_DEPLOYMENTID','com.asopagos.coreaas.bpm.afiliacion_independientes_web:afiliacion_independientes_web:0.0.2-SNAPSHOT');