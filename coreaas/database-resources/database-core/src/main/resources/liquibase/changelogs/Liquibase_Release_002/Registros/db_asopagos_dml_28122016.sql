...
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('01', 'Banco de Bogota', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('02', 'Banco Popular', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('06', 'Banco Corpbanca', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('07', 'Banco de Colombia', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('09', 'CitiBank', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('13', 'Banco BBVA Colombia', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('19', 'Banco de Colpatria', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('23', 'Banco de Occidente', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('32', 'Banco BCSC', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('51', 'Davivienda', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('61', 'Coomeva Financiera', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('83', 'Compensar', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('84', 'Gestión y Contacto', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('86', 'Asopagos', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('87', 'Fedecajas', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('88', 'Simple', 1);
insert into PilaOperadorInformacion (oinCodigo, oinNombre, oinOperadorActivo) values ('89', 'Enlace Operativo', 1);
