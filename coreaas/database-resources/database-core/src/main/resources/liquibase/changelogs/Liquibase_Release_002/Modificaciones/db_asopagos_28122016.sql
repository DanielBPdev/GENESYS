...
--comment:Desinstalación/Instalación de Pila
...
CREATE TABLE dbo.PilaOperadorInformacionCcf(
...
CREATE TABLE dbo.PilaConexionOperadorInformacion(
...
ALTER TABLE [PilaOperadorInformacionCcf] ADD CONSTRAINT [FK_PilaOperadorInformacionCcf_oicIdOperadorInformacion] FOREIGN KEY([oicIdOperadorInformacion]) REFERENCES [PilaOperadorInformacion] ([oinId]);
ALTER TABLE [PilaOperadorInformacionCcf] ADD CONSTRAINT [FK_PilaOperadorInformacionCcf_oicIdCajaCompensacion] FOREIGN KEY([oicIdCajaCompensacion]) REFERENCES [CajaCompensacion] ([ccfId]);
ALTER TABLE [PilaConexionOperadorInformacion] ADD CONSTRAINT [FK_PilaConexionOperadorInformacion_coiIdOperadorinformacionCcf] FOREIGN KEY([coiIdOperadorinformacionCcf]) REFERENCES [PilaOperadorInformacionCcf] ([oicId]);
