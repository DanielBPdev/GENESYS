...
CREATE TABLE [ValidatorCatalog](
	...
	CONSTRAINT PK_ValidatorCatalog_id PRIMARY KEY (id)
);
...
CREATE TABLE [parameter](
	...
	CONSTRAINT [UK_parameter_name] UNIQUE NONCLUSTERED (name)
);
...
CREATE TABLE [LineLoadCatalog](
	...
	CONSTRAINT PK_LineLoadCatalog_id PRIMARY KEY (id)
);
...
CREATE TABLE [FieldLoadCatalog](
	...
	[tenantId] bigint NULL,
	CONSTRAINT PK_FieldLoadCatalog_id PRIMARY KEY (id)
);
...
CREATE TABLE [FileDefinitionLoadType](
	...
	[description] [varchar](255) NULL,
	[name] [varchar](70) NOT NULL,
	CONSTRAINT PK_FileDefinitionLoadType_id PRIMARY KEY (id)
);
...
CREATE TABLE [FileDefinitionLoad](
	...
	CONSTRAINT PK_FileDefinitionLoad_id PRIMARY KEY (id)
);
...
CREATE TABLE [ParamValue](
	...
	CONSTRAINT PK_ParamValue_id PRIMARY KEY (id)
);
...
CREATE TABLE [ValidatorParameter](
	...
	CONSTRAINT PK_ValidatorParameter_id PRIMARY KEY (id)
);
...
CREATE TABLE [LineDefinitionLoad](
	...
	CONSTRAINT PK_LineDefinitionLoad_id PRIMARY KEY (id)
);
...
CREATE TABLE [FileLoaded](
	...
	CONSTRAINT PK_FileLoaded_id PRIMARY KEY (id)
);
...
CREATE TABLE [FileLoadedLog](
	...
	CONSTRAINT PK_FileLoadedLog_id PRIMARY KEY (id)
);
...
CREATE TABLE [FieldDefinitionLoad](
	...
	CONSTRAINT PK_FieldDefinitionLoad_id PRIMARY KEY (id)
);
...
CREATE TABLE [ValidatorDefinition](
	...
	[validatorprofile] bigint NULL,
	[state] [bit] NULL,
	CONSTRAINT PK_ValidatorDefinition_id PRIMARY KEY (id)
);
...
CREATE TABLE [ValidatorParamValue](
	...
	CONSTRAINT PK_ValidatorParamValue_id PRIMARY KEY (id)
);


ALTER TABLE [ValidatorParamValue]  ADD  CONSTRAINT [FK_ValidatorParamValue_validatorDefinition_id] FOREIGN KEY([validatorDefinition_id])
REFERENCES [ValidatorDefinition] ([id]);

ALTER TABLE [ValidatorParamValue]  ADD  CONSTRAINT [FK_ValidatorParamValue_validatorParameter_id] FOREIGN KEY([validatorParameter_id])
REFERENCES [ValidatorParameter] ([id]);

ALTER TABLE [ValidatorParameter]  ADD  CONSTRAINT [FK_ValidatorParameter_validatorCatalog_id] FOREIGN KEY([validatorCatalog_id])
REFERENCES [ValidatorCatalog] ([id]);

ALTER TABLE [ValidatorDefinition]  ADD  CONSTRAINT [FK_ValidatorDefinition_validatorCatalog_id] FOREIGN KEY([validatorCatalog_id])
REFERENCES [ValidatorCatalog] ([id]);

ALTER TABLE [ValidatorDefinition]  ADD  CONSTRAINT [FK_ValidatorDefinition_fieldDefinition_id] FOREIGN KEY([fieldDefinition_id])
REFERENCES [FieldDefinitionLoad] ([id]);

ALTER TABLE [ValidatorDefinition]  ADD  CONSTRAINT [FK_ValidatorDefinition_fileDefinitionLoad_id] FOREIGN KEY([fileDefinitionLoad_id])
REFERENCES [FileDefinitionLoad] ([id]);

ALTER TABLE [ValidatorDefinition]  ADD  CONSTRAINT [FK_ValidatorDefinition_lineDefinition_id] FOREIGN KEY([lineDefinition_id])
REFERENCES [LineDefinitionLoad] ([id]);

ALTER TABLE [ParamValue]  ADD  CONSTRAINT [FK_ParamValue_parameter_id] FOREIGN KEY([parameter_id])
REFERENCES [parameter] ([id]);

ALTER TABLE [LineDefinitionLoad]  ADD  CONSTRAINT [FK_LineDefinitionLoad_lineLoadCatalog_id] FOREIGN KEY([lineLoadCatalog_id])
REFERENCES [LineLoadCatalog] ([id]);

ALTER TABLE [LineDefinitionLoad]  ADD  CONSTRAINT [FK_LineDefinitionLoad_fileDefinition_id] FOREIGN KEY([fileDefinition_id])
REFERENCES [FileDefinitionLoad] ([id]);

ALTER TABLE [FileLoadedLog]  ADD  CONSTRAINT [FK_FileLoadedLog_fileLoaded_id] FOREIGN KEY([fileLoaded_id])
REFERENCES [FileLoaded] ([id]);

ALTER TABLE [FileLoaded]  ADD  CONSTRAINT [FK_FileLoaded_fileDefinition_id] FOREIGN KEY([fileDefinition_id])
REFERENCES [FileDefinitionLoad] ([id]);

ALTER TABLE [FileDefinitionLoad]  ADD  CONSTRAINT [FK_FileDefinitionLoad_fileDefinitionType_id] FOREIGN KEY([fileDefinitionType_id])
REFERENCES [FileDefinitionLoadType] ([id]);

ALTER TABLE [FieldDefinitionLoad]  ADD  CONSTRAINT [FK_FieldDefinitionLoad_lineDefinition_id] FOREIGN KEY([lineDefinition_id])
REFERENCES [LineDefinitionLoad] ([id]);

ALTER TABLE [FieldDefinitionLoad]  ADD  CONSTRAINT [FK_FieldDefinitionLoad_fieldLoadCatalog_id] FOREIGN KEY([fieldLoadCatalog_id])
REFERENCES [FieldLoadCatalog] ([id]);

--changeset  abaquero:02
--comment: Archivo Pila parametrica
...
create table dbo.PilaArchivoIRegistro3(
	...
	pi3ValorTotalIBC bigint NOT NULL,
	pi3ValorTotalAporteObligatorio bigint NOT NULL,
	pi3DiasMora smallint NOT NULL,
	pi3ValorMora bigint NOT NULL,
	pi3ValorTotalAportes bigint NOT NULL,
...
--changeset  ogiral:04
--comment: Creación campo codigo
ALTER TABLE AFP ADD afpCodigo VARCHAR(10);