...
ALTER TABLE RolContactoEmpleador ADD rceUbicacion bigint ;
GO
UPDATE RolContactoEmpleador SET rceUbicacion= (SELECT max(ubiId) from Ubicacion);
ALTER TABLE RolContactoEmpleador ALTER COLUMN rceUbicacion bigint NOT NULL;
GO
ALTER TABLE RolContactoEmpleador ADD CONSTRAINT FK_RolContactoEmpleador_rceUbicacion FOREIGN KEY (rceUbicacion) REFERENCES Ubicacion;

--changeset mgiraldo:07
EXEC sp_RENAME 'DatoTemporalSolicitud.dtsjsonPayload' , 'dtsJsonPayload', 'COLUMN';
