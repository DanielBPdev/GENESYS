...
drop table dbo.OperadorInformacionCcf;
...
create table PilaNormatividadFechaVencimiento(
	...
	pfvClasificacionAportante bigint,
...
CREATE TABLE dbo.OperadorInformacionCcf(
	...
	oicOperadorInformacion bigint,
	oicCajaCompensacion int,
	oicEstado bit,
...
CREATE TABLE dbo.ConexionOperadorInformacion(
	...
	coiOperadorInformacionCcf bigint,
...
ALTER TABLE [PilaEstadoBloque] ADD CONSTRAINT [FK_PilaEstadoBloque_pebIndicePlanilla] FOREIGN KEY([pebIndicePlanilla]) REFERENCES [PilaIndicePlanilla] ([pipId]);
ALTER TABLE [PilaEstadoBloqueOF] ADD CONSTRAINT [FK_PilaEstadoBloqueOF_peoIndicePlanillaOF] FOREIGN KEY([peoIndicePlanillaOF]) REFERENCES [PilaIndicePlanillaOF] ([pioId]);
ALTER TABLE [PilaNormatividadFechaVencimiento] ADD CONSTRAINT [FK_PilaNormatividadFechaVencimiento_pfvClasificacionAportante] FOREIGN KEY([pfvClasificacionAportante]) REFERENCES [PilaClasificacionAportante] ([pcaId]);
ALTER TABLE [PilaIndiceCorreccionPlanilla] ADD CONSTRAINT [FK_PilaIndiceCorreccionPlanilla_picIndicePlanillaAfectada] FOREIGN KEY([picIndicePlanillaAfectada]) REFERENCES [PilaIndicePlanilla] ([pipId]);
ALTER TABLE [PilaIndiceCorreccionPlanilla] ADD CONSTRAINT [FK_PilaIndiceCorreccionPlanilla_picIndicePlanillaCargado] FOREIGN KEY([picIndicePlanillaCargado]) REFERENCES [PilaIndicePlanilla] ([pipId]);
ALTER TABLE [OperadorInformacionCcf] ADD CONSTRAINT [FK_OperadorInformacionCcf_oicOperadorInformacion] FOREIGN KEY([oicOperadorInformacion]) REFERENCES [OperadorInformacion] ([oinId]);
ALTER TABLE [OperadorInformacionCcf] ADD CONSTRAINT [FK_OperadorInformacionCcf_oicCajaCompensacion] FOREIGN KEY([oicCajaCompensacion]) REFERENCES [CajaCompensacion] ([ccfId]);
ALTER TABLE [ConexionOperadorInformacion] ADD CONSTRAINT [FK_ConexionOperadorInformacion_coiOperadorInformacionCcf] FOREIGN KEY([coiOperadorInformacionCcf]) REFERENCES [OperadorInformacionCcf] ([oicId]);
ALTER TABLE [PilaEjecucionProgramada] ADD CONSTRAINT [FK_PilaEjecucionProgramada_pepCajaCompensacion] FOREIGN KEY([pepCajaCompensacion]) REFERENCES [CajaCompensacion] ([ccfId]);
...
ALTER TABLE [PilaArchivoAPRegistro1] ADD CONSTRAINT [FK_PilaArchivoAPRegistro1_ap1IndicePlanilla] FOREIGN KEY([ap1IndicePlanilla]) REFERENCES [PilaIndicePlanilla] ([pipId]);
ALTER TABLE [PilaArchivoARegistro1] ADD CONSTRAINT [FK_PilaArchivoARegistro1_pa1IndicePlanilla] FOREIGN KEY([pa1IndicePlanilla]) REFERENCES [PilaIndicePlanilla] ([pipId]);
ALTER TABLE [PilaArchivoFRegistro1] ADD CONSTRAINT [FK_PilaArchivoFRegistro1_pf1IndicePlanillaOF] FOREIGN KEY([pf1IndicePlanillaOF]) REFERENCES [PilaIndicePlanillaOF] ([pioId]);
ALTER TABLE [PilaArchivoFRegistro5] ADD CONSTRAINT [FK_PilaArchivoFRegistro5_pf5IndicePlanillaOF] FOREIGN KEY([pf5IndicePlanillaOF]) REFERENCES [PilaIndicePlanillaOF] ([pioId]);
ALTER TABLE [PilaArchivoFRegistro6] ADD CONSTRAINT [FK_PilaArchivoFRegistro6_pf6IndicePlanillaOF] FOREIGN KEY([pf6IndicePlanillaOF]) REFERENCES [PilaIndicePlanillaOF] ([pioId]);
ALTER TABLE [PilaArchivoFRegistro8] ADD CONSTRAINT [FK_PilaArchivoFRegistro8_pf8IndicePlanillaOF] FOREIGN KEY([pf8IndicePlanillaOF]) REFERENCES [PilaIndicePlanillaOF] ([pioId]);
ALTER TABLE [PilaArchivoFRegistro9] ADD CONSTRAINT [FK_PilaArchivoFRegistro9_pf9IndicePlanillaOF] FOREIGN KEY([pf9IndicePlanillaOF]) REFERENCES [PilaIndicePlanillaOF] ([pioId]);
ALTER TABLE [PilaArchivoIPRegistro1] ADD CONSTRAINT [FK_PilaArchivoIPRegistro1_ip1IndicePlanilla] FOREIGN KEY([ip1IndicePlanilla]) REFERENCES [PilaIndicePlanilla] ([pipId]);
ALTER TABLE [PilaArchivoIPRegistro2] ADD CONSTRAINT [FK_PilaArchivoIPRegistro2_ip2IndicePlanilla] FOREIGN KEY([ip2IndicePlanilla]) REFERENCES [PilaIndicePlanilla] ([pipId]);
ALTER TABLE [PilaArchivoIPRegistro3] ADD CONSTRAINT [FK_PilaArchivoIPRegistro3_ip3IndicePlanilla] FOREIGN KEY([ip3IndicePlanilla]) REFERENCES [PilaIndicePlanilla] ([pipId]);
ALTER TABLE [PilaArchivoIRegistro1] ADD CONSTRAINT [FK_PilaArchivoIRegistro1_pi1IndicePlanilla] FOREIGN KEY([pi1IndicePlanilla]) REFERENCES [PilaIndicePlanilla] ([pipId]);
ALTER TABLE [PilaArchivoIRegistro2] ADD CONSTRAINT [FK_PilaArchivoIRegistro2_pi2IndicePlanilla] FOREIGN KEY([pi2IndicePlanilla]) REFERENCES [PilaIndicePlanilla] ([pipId]);
ALTER TABLE [PilaArchivoIRegistro3] ADD CONSTRAINT [FK_PilaArchivoIRegistro3_pi3IndicePlanilla] FOREIGN KEY([pi3IndicePlanilla]) REFERENCES [PilaIndicePlanilla] ([pipId]);

--changeset flopez:03
--comment: creacion tabla ParametrizacionEjecucionProgramada y ResultadoEjecucionProgramada
CREATE TABLE ParametrizacionEjecucionProgramada (
pepId int NOT NULL IDENTITY PRIMARY KEY, 
...
repId int NOT NULL IDENTITY PRIMARY KEY, 
...
--changeset flopez:04
--comment: Cambio de tipo de datos en Beneficio
ALTER TABLE Beneficio ALTER COLUMN befFechaBeneficioInicio date;
ALTER TABLE Beneficio ALTER COLUMN befFechaBeneficioFin date;

--changeset atoro:05
--comment: Creacion de campo de motivoDesafiliacionAfiliado en la tabla rolAfiliado y motivoDesafiliacionBeneficiario en Beneficiario
ALTER TABLE rolAfiliado ADD roaMotivoDesafiliacion varchar(50);
ALTER TABLE rolAfiliado ADD roaSustitucionPatronal bit;
ALTER TABLE Beneficiario ADD benMotivoDesafiliacion varchar(70);

--changeset halzate:06
--comment: Eliminacion de secuencia
DROP SEQUENCE SEC_consecutivoGestionPersonaEntidadPagadora;