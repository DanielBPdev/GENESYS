...
$resourceGroup = "FUN3_ASOPAGOS_HBT_RG"
...
$DFName = "confaHuilaHBTDF"



Set-AzureRmDataFactoryV2 -Name $DFName -Location "East US " -ResourceGroupName $resourceGroup -Force

# logs ejecuciones pipelines
$fechaIni = Get-Date "01/01/2020 05:00 AM"
$fechaFin = Get-Date "16/01/2020 05:00 AM"
Get-AzureRmDataFactoryV2PipelineRun -ResourceGroupName "FUN3_ASOPAGOS_HBT_RG" -DataFactoryName "confaHuilaHBTDF" -LastUpdatedAfter $fechaIni -LastUpdatedBefore $fechaFin | Out-File D:/process.txt

# logs ejecuciones pipelines
$fechaIni = Get-Date "01/10/2019 05:00 AM"
$fechaFin = Get-Date "23/01/2020 11:00 AM"
Get-AzureRmDataFactoryV2PipelineRun -ResourceGroupName "FUN3_ASOPAGOS_HBT_RG" -DataFactoryName "confaHuilaHBTDF" -LastUpdatedAfter $fechaIni -LastUpdatedBefore $fechaFin | Out-File D:/process.txt



Get-AzureRmDataFactoryV2PipelineRun -ResourceGroupName "FUN3_ASOPAGOS_HBT_RG" -DataFactoryName "confaHuilaHBTDF" -LastUpdatedAfter Get-Date -LastUpdatedBefore Get-Date
...
# DataSets Pila
Set-AzureRmDataFactoryV2Dataset -Name "DSPilaSink"  -DataFactoryName $DFName -ResourceGroupName $resourceGroup -File ($path + "Datasets\DSPilaSink.json") -Force
Set-AzureRmDataFactoryV2Dataset -Name "DSWatermark"  -DataFactoryName $DFName -ResourceGroupName $resourceGroup -File ($path + "Datasets\DSWatermark.json") -Force
...
Set-AzureRmDataFactoryV2Pipeline -Name "CargaIncrementalPila" -DataFactoryName $DFName -ResourceGroupName $resourceGroup -File ($path + "\Pipelines\IntegracionReportes\CargaIncrementalPila.json") -Force
Set-AzureRmDataFactoryV2Pipeline -Name "MigracionReportes" -DataFactoryName $DFName -ResourceGroupName $resourceGroup -File ($path + "\Pipelines\IntegracionReportes\MigracionReportes.json") -Force
...
Stop-AzureRmDataFactoryV2Trigger -Name "TRGActualizarStaging" -DataFactoryName $DFName -ResourceGroupName $resourceGroup -Force
Set-AzureRmDataFactoryV2Trigger -Name "TRGActualizarStaging" -DataFactoryName $DFName -ResourceGroupName $resourceGroup -File ($path + "\Triggers\IntegracionSubsidio\TRGActualizarStaging.json") -Force
Start-AzureRmDataFactoryV2Trigger -Name "TRGActualizarStaging" -DataFactoryName $DFName -ResourceGroupName $resourceGroup -Force

Stop-AzureRmDataFactoryV2Trigger -Name "TRGCargarReportesNormativos" -DataFactoryName $DFName -ResourceGroupName $resourceGroup -Force
