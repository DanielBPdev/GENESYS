...
-- =============================================
CREATE or ALTER  PROCEDURE [masivos].[ASP_ExecutePILA2Fase2RegistrarRelacionarAportes]
...
BEGIN TRY
	...
	BEGIN
		...
		EXEC [masivos].[ASP_ExecuteRegistrarRelacionarAportesRegistro] @regId, @EsSimulado, @EsProcesoManual
		FETCH NEXT FROM @AportesTransaccionCursor INTO	@regId
	END
