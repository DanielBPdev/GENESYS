...
-- Description:	Procedimiento almacenado encargado de calcular el estado V1 para el archivo Pila IP,
-- para pensionados.
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[USP_ValidateHU396V1Pensionados]
...
SET NOCOUNT ON;
	...
	SET
		...
		THEN 'OK' ELSE 'NO_OK_APROBADO' END
	FROM staging.RegistroDetallado red WITH (NOLOCK)
	WHERE redOUTMarcaValRegistroAporte = 'VALIDAR_COMO_PENSIONADO'
