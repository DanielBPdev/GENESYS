...
VALUES
('USP_GET_BeneficiariosSubsidioFechasAfiliacion'),
('USP_GET_BeneficiariosSubsidioFechasRetiro'),
('USP_GET_BeneficiariosSubsidioUltimoEstado'),
('USP_GET_TrabajadorSubsidioFechasAfiliacion'),
('USP_GET_TrabajadorSubsidioFechasRetiro'),
('USP_GET_TrabajadorSubsidioUltimoEstado')
