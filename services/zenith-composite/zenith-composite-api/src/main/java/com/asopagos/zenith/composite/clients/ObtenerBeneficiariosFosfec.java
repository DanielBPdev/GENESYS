 ...
 * /rest/externalAPI/ClienteZenithBusiness/obtenerBeneficiariosFosfec
 */
public class ObtenerBeneficiariosFosfec extends ServiceClient { 
 	...
 	public ObtenerBeneficiariosFosfec (ConsultaSubsidioFosfecDTO consultaSubsidioFosfecDTO){
 		super();
