 ...
 * /rest/externalAPI/ClienteZenithBusiness/obtenerSolicitudesFosfec
 */
public class ObtenerSolicitudesFosfec extends ServiceClient { 
    	private ConsultaSubsidioFosfecDTO consultaSubsidioFosfecDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private List<SolicitudSubsidioFosfecDTO> result;
  
 	public ObtenerSolicitudesFosfec (ConsultaSubsidioFosfecDTO consultaSubsidioFosfecDTO){
 		super();
