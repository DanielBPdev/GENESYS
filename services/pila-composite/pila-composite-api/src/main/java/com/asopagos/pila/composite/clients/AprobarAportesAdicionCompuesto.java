 ...
 * /rest/PilaComposite/aprobarAportesAdicionCompuesto
 */
public class AprobarAportesAdicionCompuesto extends ServiceClient { 
 	...
 	public AprobarAportesAdicionCompuesto (RegistrarCorreccionAdicionDTO criteriosSimulacion){
 		super();
