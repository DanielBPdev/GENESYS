 ...
 * /rest/PilaComposite/anularRegistroFinanciero
 */
public class AnularRegistroFinanciero extends ServiceClient { 
    	private InconsistenciaDTO inconsistencia;
  
  
 	public AnularRegistroFinanciero (InconsistenciaDTO inconsistencia){
 		super();
