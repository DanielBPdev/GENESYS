 ...
 * /rest/PilaComposite/reprocesarPlanillasMundoUno
 */
public class ReprocesarPlanillasMundoUno extends ServiceClient { 
    	private List<PlanillaGestionManualDTO> indicesPlanilla;
  
  
 	public ReprocesarPlanillasMundoUno (List<PlanillaGestionManualDTO> indicesPlanilla){
 		super();
