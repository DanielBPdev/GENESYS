 ...
 * /rest/PilaComposite/aprobarProcesoNovedadesAdicionCorreccionCompuesto
 */
public class AprobarProcesoNovedadesAdicionCorreccionCompuesto extends ServiceClient { 
 	...
 	public AprobarProcesoNovedadesAdicionCorreccionCompuesto (RegistrarCorreccionAdicionDTO criteriosSimulacion){
 		super();
