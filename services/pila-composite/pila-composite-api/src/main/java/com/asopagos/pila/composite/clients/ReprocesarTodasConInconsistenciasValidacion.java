 ...
 * /rest/PilaComposite/reprocesarTodasConInconsistenciasValidacion
 */
public class ReprocesarTodasConInconsistenciasValidacion extends ServiceClient {
 	...
 	public ReprocesarTodasConInconsistenciasValidacion (String numeroIdentificacionAportante,TipoIdentificacionEnum tipoIdentificacionAportante,Long fechaFin,Short digitoVerificacionAportante,Long fechaInicio){
 		super();
