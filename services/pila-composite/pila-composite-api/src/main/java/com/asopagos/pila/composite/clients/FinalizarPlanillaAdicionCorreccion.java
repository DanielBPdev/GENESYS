 ...
 * /rest/PilaComposite/finalizarPlanillaAdicionCorreccion
 */
public class FinalizarPlanillaAdicionCorreccion extends ServiceClient {
 	...
 	public FinalizarPlanillaAdicionCorreccion (Long idRegistroGeneral){
 		super();
