 ...
 * /rest/parametrosSubsidioCaja/replicarCambioEstadoListaEspecialRevision
 */
public class ReplicarCambioEstadoListaEspecialRevision extends ServiceClient { 
    	private ListaEspecialRevision listaEspecialRevision;
  
  
 	public ReplicarCambioEstadoListaEspecialRevision (ListaEspecialRevision listaEspecialRevision){
 		super();
