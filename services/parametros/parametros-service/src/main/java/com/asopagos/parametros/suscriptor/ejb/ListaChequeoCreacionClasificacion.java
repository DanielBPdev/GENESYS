...
@MessageDriven(name = "ListaChequeoCreacionClasificacion", activationConfig = {
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Topic"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "ListaChequeoCreacionClasificacion"),
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge"),
        @ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable"),
        @ActivationConfigProperty(propertyName = "clientId", propertyValue = "${ccf.clientId}_listaChequeoCreacion"),
        @ActivationConfigProperty(propertyName = "maxSessions" , propertyValue="1"),
        @ActivationConfigProperty(propertyName = "subscriptionName", propertyValue = "${ccf.clientId}_listaChequeoCreacion") })

public class ListaChequeoCreacionClasificacion extends AbstractGeneradorUsuario implements MessageListener {

    private static final String FORMATO_FECHA = "EEE, dd MMM yyyy HH:mm:ss zzz";
    /**
     * Referencia al logger
     */
    private static final ILogger logger = LogManager.getLogger(ListaChequeoCreacionClasificacion.class);
    
    
    @Override
    public void onMessage(Message rcvMessage) {
        logger.info("Recibí un mensaje :) " + rcvMessage);
