...
@MessageDriven(name = "ReplicacionValoresAnualesTopic", activationConfig = {
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Topic"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "ReplicacionValoresAnualesTopic"),
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge"),
        @ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable"),
        @ActivationConfigProperty(propertyName = "clientId", propertyValue = "${ccf.clientId}_valoresAnuales"),
        @ActivationConfigProperty(propertyName = "maxSessions" , propertyValue="1"),
        @ActivationConfigProperty(propertyName = "subscriptionName", propertyValue = "${ccf.clientId}_valoresAnuales") })

public class ReplicacionValoresAnuales  implements MessageListener {

    private static final String FORMATO_FECHA = "EEE, dd MMM yyyy HH:mm:ss zzz";
    /**
     * Referencia al logger
     */
    private static final ILogger logger = LogManager.getLogger(ReplicacionValoresAnuales.class);
    ...
    public void onMessage(Message rcvMessage) {
        ...
        try {
            if (rcvMessage instanceof TextMessage) {
                ...
                List<ParametrizacionLiquidacionSubsidioModeloDTO> parametrizacionesLiq = gson.fromJson(obj, List.class);
