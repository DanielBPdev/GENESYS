 ...
 * /rest/personas/consultarJefeHogar
 */
public class ConsultarJefeHogar extends ServiceClient {
 	...
 	public ConsultarJefeHogar (String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
