 ...
 * /rest/notificaciones/enviarNotificacionSeven
 */
public class EnviarNotificacionSeven extends ServiceClient { 
    	private NotificacionParametrizadaDTO notificacion;
  
  
 	public EnviarNotificacionSeven (NotificacionParametrizadaDTO notificacion){
 		super();
