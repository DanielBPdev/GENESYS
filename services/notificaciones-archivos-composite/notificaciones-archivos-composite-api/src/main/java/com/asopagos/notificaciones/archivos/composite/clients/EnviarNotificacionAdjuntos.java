 ...
 * /rest/notificaciones/enviarNotificacionAdjuntos
 */
public class EnviarNotificacionAdjuntos extends ServiceClient { 
    	private NotificacionDTO notificacion;
  
  
 	public EnviarNotificacionAdjuntos (NotificacionDTO notificacion){
 		super();
