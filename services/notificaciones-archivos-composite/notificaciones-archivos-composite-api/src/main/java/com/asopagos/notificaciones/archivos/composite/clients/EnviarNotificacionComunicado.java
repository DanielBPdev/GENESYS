 ...
 * /rest/notificaciones/enviarNotificacionComunicado
 */
public class EnviarNotificacionComunicado extends ServiceClient { 
    	private NotificacionParametrizadaDTO notificacion;
  
  
 	public EnviarNotificacionComunicado (NotificacionParametrizadaDTO notificacion){
 		super();
