 ...
 * /rest/notificaciones/buscarTransaccionEnviarNotificacionComunicado
 */
public class BuscarTransaccionEnviarNotificacionComunicado extends ServiceClient { 
    	private NotificacionParametrizadaDTO notificacion;
  
  
 	public BuscarTransaccionEnviarNotificacionComunicado (NotificacionParametrizadaDTO notificacion){
 		super();
