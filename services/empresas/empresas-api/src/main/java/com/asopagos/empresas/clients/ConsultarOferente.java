 ...
 * /rest/empresas/consultarOferente
 */
public class ConsultarOferente extends ServiceClient {
 	...
 	public ConsultarOferente (String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
