 ...
 * relacionados a la asignación de solicitudes de la acción de cobro 2G <br/>
 * <b>Módulo:</b> Asopagos - HU 189<br/>
 *
 * @author <a href="mailto:borozco@heinsohn.com.co"> borozco</a>
 */
public class AsignacionSolicitudGestionCobro2G extends AsignacionSolicitudGestionCobro {

	/**
	 * Logger
	 */
	private final ILogger logger = LogManager.getLogger(AsignacionSolicitudGestionCobro2G.class);
	 ...
	 */
	public AsignacionSolicitudGestionCobro2G(UserDTO userDTO) {
		super(userDTO);
		this.setAccionCobro(TipoAccionCobroEnum.G2);
		this.setTipoParametrizacion(TipoParametrizacionGestionCobroEnum.ACCION_COBRO_2G);
		this.setTipoTransaccionElectronica(TipoTransaccionEnum.ACCION_COBRO_2G_ELECTRONICO);
		this.setTipoTransaccionFisica(TipoTransaccionEnum.ACCION_COBRO_2G_FISICO);
	}
	...
	public void asignarComunicados() {
		...
		this.getPlantillasComunicado().add(EtiquetaPlantillaComunicadoEnum.SEG_AVI_COB_PRS);
