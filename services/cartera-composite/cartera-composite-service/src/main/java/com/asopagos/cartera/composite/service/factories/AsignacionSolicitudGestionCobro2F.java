 ...
 * relacionados a la asignación de solicitudes de la acción de cobro 2F <br/>
 * <b>Módulo:</b> Asopagos - HU 188<br/>
 *
 * @author <a href="mailto:borozco@heinsohn.com.co"> borozco</a>
 */
public class AsignacionSolicitudGestionCobro2F extends AsignacionSolicitudGestionCobro {

	/**
	 * Logger
	 */
	private final ILogger logger = LogManager.getLogger(AsignacionSolicitudGestionCobro2F.class);
	 ...
	 */
	public AsignacionSolicitudGestionCobro2F(UserDTO userDTO) {
		super(userDTO);
		this.setAccionCobro(TipoAccionCobroEnum.F2);
		this.setTipoParametrizacion(TipoParametrizacionGestionCobroEnum.ACCION_COBRO_2F);
		this.setTipoTransaccionElectronica(TipoTransaccionEnum.ACCION_COBRO_2F_ELECTRONICO);
		this.setTipoTransaccionFisica(TipoTransaccionEnum.ACCION_COBRO_2F_FISICO);
	}
	...
	public void asignarComunicados() {
		...
		this.getPlantillasComunicado().add(EtiquetaPlantillaComunicadoEnum.PRI_AVI_COB_PRS);
