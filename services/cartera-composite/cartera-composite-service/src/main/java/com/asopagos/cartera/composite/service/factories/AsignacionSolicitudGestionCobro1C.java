 ...
 * 1C. Ver <code>AsignacionSolicitudGestionCobroFactory</code> <br/>
 * <b>Historia de Usuario: </b> HU-164
 * 
 * @author <a href="mailto:fvasquez@heinsohn.com.co">Ferney Alonso Vásquez
 *         Benavides</a>
 */
public class AsignacionSolicitudGestionCobro1C extends AsignacionSolicitudGestionCobro {

	/**
	 * Logger
	 */
	private final ILogger logger = LogManager.getLogger(AsignacionSolicitudGestionCobro1C.class);
	 ...
	 */
	public AsignacionSolicitudGestionCobro1C(UserDTO userDTO) {
		super(userDTO);
		this.setAccionCobro(TipoAccionCobroEnum.C1);
		this.setTipoParametrizacion(TipoParametrizacionGestionCobroEnum.ACCION_COBRO_1C);
		this.setTipoTransaccionElectronica(TipoTransaccionEnum.ACCION_COBRO_1C_ELECTRONICO);
		this.setTipoTransaccionFisica(TipoTransaccionEnum.ACCION_COBRO_1C_FISICO);
	}
	...
	public void asignarComunicados() {
		...
		this.getPlantillasComunicado().add(EtiquetaPlantillaComunicadoEnum.LIQ_APO_MOR);
