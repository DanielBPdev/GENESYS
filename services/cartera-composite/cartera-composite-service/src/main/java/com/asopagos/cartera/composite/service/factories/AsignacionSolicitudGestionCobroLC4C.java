 ...
 * LC4C. Ver <code>AsignacionSolicitudGestionCobroFactory</code> <br/>
 * <b>Historia de Usuario: </b> HU-164
 * 
 * @author <a href="mailto:fvasquez@heinsohn.com.co">Ferney Alonso Vásquez
 *         Benavides</a>
 */
public class AsignacionSolicitudGestionCobroLC4C extends AsignacionSolicitudGestionCobro {

	/**
	 * Logger
	 */
	private final ILogger logger = LogManager.getLogger(AsignacionSolicitudGestionCobroLC4C.class);
	 ...
	 */
	public AsignacionSolicitudGestionCobroLC4C(UserDTO userDTO) {
		super(userDTO);
		this.setAccionCobro(TipoAccionCobroEnum.LC4C);
		this.setTipoParametrizacion(TipoParametrizacionGestionCobroEnum.LINEA_COBRO);
		this.setTipoTransaccionElectronica(TipoTransaccionEnum.ACCION_COBRO_LC4C_ELECTRONICO);
		this.setTipoTransaccionFisica(TipoTransaccionEnum.ACCION_COBRO_LC4C_FISICO);
	}
	...
	public void consultarParametrizacion(List<Object> lista) {
		...
		ParametrizacionDesafiliacionModeloDTO parametrizacionDTO = consultarParametrizacionDesafiliacion(TipoLineaCobroEnum.LC4);
