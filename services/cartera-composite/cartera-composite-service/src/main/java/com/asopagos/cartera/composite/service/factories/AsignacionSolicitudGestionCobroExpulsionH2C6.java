...
public class AsignacionSolicitudGestionCobroExpulsionH2C6 extends AsignacionSolicitudGestionCobro{
     ...
     */
    public AsignacionSolicitudGestionCobroExpulsionH2C6(UserDTO userDTO, List<Long> idPersonasAProcesar) {
        super(userDTO);
        this.setAccionCobro(TipoAccionCobroEnum.H2_C6_EX);
