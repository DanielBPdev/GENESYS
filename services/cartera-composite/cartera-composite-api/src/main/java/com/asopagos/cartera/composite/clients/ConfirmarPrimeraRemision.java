 ...
 * /rest/carteraComposite/confirmarPrimeraRemision
 */
public class ConfirmarPrimeraRemision extends ServiceClient { 
    	private RegistroRemisionAportantesDTO registroRemision;
  
  
 	public ConfirmarPrimeraRemision (RegistroRemisionAportantesDTO registroRemision){
 		super();
