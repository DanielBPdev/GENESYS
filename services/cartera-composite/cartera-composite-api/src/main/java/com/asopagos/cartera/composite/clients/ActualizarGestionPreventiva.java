 ...
 * /rest/carteraComposite/{numeroRadicacion}/actualizarGestionPreventiva
 */
public class ActualizarGestionPreventiva extends ServiceClient { 
  	private String numeroRadicacion;
   	private Long idTarea;
  	private Boolean actualizacionEfectiva;
   
  
 	public ActualizarGestionPreventiva (String numeroRadicacion,Long idTarea,Boolean actualizacionEfectiva){
 		super();
