 ...
 * /rest/carteraComposite/consultarAportantesDeudaAntigua
 */
public class ConsultarAportantesDeudaAntigua extends ServiceClient { 
    	private FiltrosGestionCobroManualDTO filtros;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private List<AportanteGestionManualDTO> result;
  
 	public ConsultarAportantesDeudaAntigua (FiltrosGestionCobroManualDTO filtros){
 		super();
