 ...
 * /rest/carteraAsincronoComposite/confirmarPrimeraRemision
 */
public class ConfirmarPrimeraRemisionAsync extends ServiceClient { 
    	private RegistroRemisionAportantesDTO registroRemision;
  
  
 	public ConfirmarPrimeraRemisionAsync (RegistroRemisionAportantesDTO registroRemision){
 		super();
