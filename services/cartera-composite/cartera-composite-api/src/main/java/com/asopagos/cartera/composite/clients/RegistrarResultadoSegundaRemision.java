 ...
 * /rest/carteraComposite/registrarResultadoSegundaRemision
 */
public class RegistrarResultadoSegundaRemision extends ServiceClient { 
    	private RegistroRemisionAportantesDTO registroRemision;
  
  
 	public RegistrarResultadoSegundaRemision (RegistroRemisionAportantesDTO registroRemision){
 		super();
