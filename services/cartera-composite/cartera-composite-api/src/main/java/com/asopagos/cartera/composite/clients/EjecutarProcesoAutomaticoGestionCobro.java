 ...
 * /rest/carteraComposite/ejecutarProcesoAutomaticoGestionCobro
 */
public class EjecutarProcesoAutomaticoGestionCobro extends ServiceClient {
 
  
  	private TipoAccionCobroEnum accionCobro;
  
  
 	public EjecutarProcesoAutomaticoGestionCobro (TipoAccionCobroEnum accionCobro){
 		super();
