 ...
 * /rest/carteraComposite/buscarDetalleCicloAportante/{numeroRadicado}
 */
public class BuscarDetalleCicloAportante extends ServiceClient {
 	...
 	public BuscarDetalleCicloAportante (String numeroRadicado){
 		super();
