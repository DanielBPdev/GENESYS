 ...
 * /rest/carteraComposite/{numeroRadicacion}/{idTarea}/registrarResultadosPrimeraRemision
 */
public class RegistrarResultadosPrimeraRemision extends ServiceClient { 
 	...
 	public RegistrarResultadosPrimeraRemision (Long idTarea,String numeroRadicacion,TipoAccionCobroEnum accionCobro,List<AportanteRemisionComunicadoDTO> aportanteRemisionDTO){
 		super();
