 ...
 * /rest/pilaBandeja/consultarPlanillasPorGestionarConInconsistenciasValidacion
 */
public class ConsultarPlanillasPorGestionarConInconsistenciasValidacion extends ServiceClient {
 	...
 	public ConsultarPlanillasPorGestionarConInconsistenciasValidacion (String numeroIdentificacionAportante,TipoIdentificacionEnum tipoIdentificacionAportante,Long fechaFin,Short digitoVerificacionAportante,Long fechaInicio){
 		super();
