 ...
 * /rest/pilaBandeja/actualizarEstadoEnProcesoAportes
 */
public class ActualizarEstadoEnProcesoAportes extends ServiceClient { 
   	private Long indicePlanilla;
   
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Boolean result;
  
 	public ActualizarEstadoEnProcesoAportes (Long indicePlanilla){
 		super();
