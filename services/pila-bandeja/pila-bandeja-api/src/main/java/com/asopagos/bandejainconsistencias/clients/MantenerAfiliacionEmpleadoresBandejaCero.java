 ...
 * /rest/pilaBandeja/mantenerAfiliacionEmpleadoresBandejaCero
 */
public class MantenerAfiliacionEmpleadoresBandejaCero extends ServiceClient { 
    	private List<Long> idEmpleadores;
  
  
 	public MantenerAfiliacionEmpleadoresBandejaCero (List<Long> idEmpleadores){
 		super();
