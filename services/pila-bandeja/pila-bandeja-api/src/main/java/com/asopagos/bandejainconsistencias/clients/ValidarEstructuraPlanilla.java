 ...
 * /rest/pilaBandeja/validarEstructuraPlanilla
 */
public class ValidarEstructuraPlanilla extends ServiceClient { 
    	private InconsistenciaDTO inconsistencia;
  
  
 	public ValidarEstructuraPlanilla (InconsistenciaDTO inconsistencia){
 		super();
