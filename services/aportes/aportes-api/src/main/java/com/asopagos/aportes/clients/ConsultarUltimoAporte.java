 ...
 * /rest/externalAPI/aportes/consultarUltimoAporteAportante
 */
public class ConsultarUltimoAporte extends ServiceClient {
 	...
 	public ConsultarUltimoAporte (String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion,String numeroIdentificacionCotizante){
 		super();
