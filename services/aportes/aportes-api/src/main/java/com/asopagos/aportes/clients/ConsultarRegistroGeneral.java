 ...
 * /rest/aportes/{idSolicitud}/consultarRegistroGeneral
 */
public class ConsultarRegistroGeneral extends ServiceClient {
 	...
 	public ConsultarRegistroGeneral (Long idSolicitud){
 		super();
