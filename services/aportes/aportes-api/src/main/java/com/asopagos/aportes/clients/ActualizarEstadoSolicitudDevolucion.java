 ...
 * /rest/aportes/actualizarEstadoSolicitudDevolucion/{idSolicitudGlobal}
 */
public class ActualizarEstadoSolicitudDevolucion extends ServiceClient { 
  	private Long idSolicitudGlobal;
   	private EstadoSolicitudAporteEnum estadoSolicitud;
   
  
 	public ActualizarEstadoSolicitudDevolucion (Long idSolicitudGlobal,EstadoSolicitudAporteEnum estadoSolicitud){
 		super();
