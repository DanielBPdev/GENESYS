 ...
 */
public class ConsultarSolicitanteCorreccion extends ServiceClient {
 	...
 	public ConsultarSolicitanteCorreccion (String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
