 ...
 * /rest/aportes/buscarNotificacionPlanillasN/{idPlanilla}
 */

public class BuscarNotificacionPlanillasN extends ServiceClient {
 	...
 	public BuscarNotificacionPlanillasN (Long idRegistroGeneral){
 		super();
