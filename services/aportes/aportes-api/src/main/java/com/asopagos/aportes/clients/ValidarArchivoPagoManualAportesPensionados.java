 ...
 * /rest/aportes/validarArchivoPagoManualAportesPensionado
 */
public class ValidarArchivoPagoManualAportesPensionados extends ServiceClient { 
    	private InformacionArchivoDTO archivoDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private ResultadoArchivoAporteDTO result;
  
 	public ValidarArchivoPagoManualAportesPensionados (InformacionArchivoDTO archivoDTO){
 		super();
