 ...
 * /rest/aportes/{idTransaccion}/registrar
 */
public class RegistrarRelacionarAportesNovedades extends ServiceClient { 
  	private Long idTransaccion;
   	private Boolean esProcesoManual;
  	private Boolean esSimulado;
   
  
 	public RegistrarRelacionarAportesNovedades (Long idTransaccion,Boolean esProcesoManual,Boolean esSimulado){
 		super();
