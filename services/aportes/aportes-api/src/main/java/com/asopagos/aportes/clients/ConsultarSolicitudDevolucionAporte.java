 ...
 * /rest/aportes/consultarSolicitudDevolucionAporte/{idSolicitudGlobal}
 */
public class ConsultarSolicitudDevolucionAporte extends ServiceClient {
 	...
 	public ConsultarSolicitudDevolucionAporte (Long idSolicitudGlobal){
 		super();
