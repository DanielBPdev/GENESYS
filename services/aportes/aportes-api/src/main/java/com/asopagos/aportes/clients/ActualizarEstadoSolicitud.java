 ...
 * /rest/aportes/{idSolicitudGlobal}/estadoSolicitud
 */
public class ActualizarEstadoSolicitud extends ServiceClient { 
  	private Long idSolicitudGlobal;
   	private EstadoSolicitudAporteEnum estadoSolicitud;
   
  
 	public ActualizarEstadoSolicitud (Long idSolicitudGlobal,EstadoSolicitudAporteEnum estadoSolicitud){
 		super();
