 ...
 * /rest/aportes/eliminarTemporalesNovedad
 */
public class EliminarTemporalesNovedad extends ServiceClient { 
    	private List<Long> idsDetalle;
  
  
 	public EliminarTemporalesNovedad (List<Long> idsDetalle){
 		super();
