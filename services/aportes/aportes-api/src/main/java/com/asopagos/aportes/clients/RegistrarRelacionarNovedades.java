 ...
 * /rest/aportes/{idTransaccion}/registrarRelacionarNovedades
 */
public class RegistrarRelacionarNovedades extends ServiceClient { 
  	private Long idTransaccion;
   	private Boolean esProcesoManual;
  	private Boolean esSimulado;
   
  
 	public RegistrarRelacionarNovedades (Long idTransaccion,Boolean esProcesoManual,Boolean esSimulado){
 		super();
