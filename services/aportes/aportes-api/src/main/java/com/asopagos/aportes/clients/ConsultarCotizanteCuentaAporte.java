 ...
 * /rest/aportes/consultarCotizanteCuentaAporte
 */
public class ConsultarCotizanteCuentaAporte extends ServiceClient { 
    	private ConsultarCotizanteDTO consultarCotizante;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private List<CotizanteDTO> result;
  
 	public ConsultarCotizanteCuentaAporte (ConsultarCotizanteDTO consultarCotizante){
 		super();
