 ...
 * /rest/aportes/eliminarTemAporteProcesado
 */
public class EliminarTemAporteProcesado extends ServiceClient { 
    	private List<Long> idsDetalle;
  
  
 	public EliminarTemAporteProcesado (List<Long> idsDetalle){
 		super();
