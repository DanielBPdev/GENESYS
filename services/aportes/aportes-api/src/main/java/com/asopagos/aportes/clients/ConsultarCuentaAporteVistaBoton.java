 ...
 */
public class ConsultarCuentaAporteVistaBoton extends ServiceClient { 
 	...
 	public ConsultarCuentaAporteVistaBoton (Long idPersonaCotizante,List<AnalisisDevolucionDTO> analisisDevolucionDTO){
 		super();
