 ...
 * /rest/afiliados/registrarDatosPersonaBeneficiarioAfiAbreviada
 */
public class RegistrarDatosPersonaBeneficiarioAfiAbreviada extends ServiceClient { 
 	...
 	public RegistrarDatosPersonaBeneficiarioAfiAbreviada (Long idAfiliado,BeneficiarioDTO beneficiarioDTO){
 		super();
