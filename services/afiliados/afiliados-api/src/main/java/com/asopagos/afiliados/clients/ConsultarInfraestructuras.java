 ...
 * /rest/afiliados/consultarInfraestructuras
 */
public class ConsultarInfraestructuras extends ServiceClient { 
 	...
 	public ConsultarInfraestructuras (CriteriosConsultaModeloInfraestructuraDTO criterios){
 		super();
	...
	protected Response invoke(WebTarget webTarget, String path) {
		Response response = webTarget.path(path)
			...
			.post(criterios == null ? null : Entity.json(criterios));
		return response;
	}
