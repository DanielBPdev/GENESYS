 ...
 * /rest/afiliados/actualizarBeneficiarioSimple
 */
public class ActualizarBeneficiarioSimple extends ServiceClient { 
    	private BeneficiarioDTO beneficiario;
  
  
 	public ActualizarBeneficiarioSimple (BeneficiarioDTO beneficiario){
 		super();
