 ...
 * /rest/afiliados/{idAfiliado}/beneficiariosMismaFecha
 */
public class ConsultarBeneficiariosMismaFecha extends ServiceClient {
 	...
 	public ConsultarBeneficiariosMismaFecha (Long idAfiliado,Boolean sinDesafiliacion){
 		super();
