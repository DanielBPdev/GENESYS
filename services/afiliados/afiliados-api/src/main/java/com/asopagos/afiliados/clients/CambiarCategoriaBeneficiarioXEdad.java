 ...
 * /rest/afiliados/cambiarCategoriaBeneficiarioXEdad
 */
public class CambiarCategoriaBeneficiarioXEdad extends ServiceClient { 
    	private List<Long> idsBeneficiario;
  
  
 	public CambiarCategoriaBeneficiarioXEdad (List<Long> idsBeneficiario){
 		super();
