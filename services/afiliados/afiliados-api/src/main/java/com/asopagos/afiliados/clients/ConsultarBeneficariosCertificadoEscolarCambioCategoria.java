 ...
 */
public class ConsultarBeneficariosCertificadoEscolarCambioCategoria extends ServiceClient {
	...
	private String sinCertificado;
  
 	public ConsultarBeneficariosCertificadoEscolarCambioCategoria (String sinCertificado){
 		super();
		this.sinCertificado = sinCertificado;
 	}
 
 	@Override
	protected Response invoke(WebTarget webTarget, String path) {
		Response response = webTarget.path(path)
									.queryParam("sinCertificado", sinCertificado)
