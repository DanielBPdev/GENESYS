 ...
 * /rest/afiliados/retirarBeneficiarioXEdad
 */
public class RetirarBeneficiarioXEdad extends ServiceClient { 
    	private List<Long> idsBeneficiario;
  
  
 	public RetirarBeneficiarioXEdad (List<Long> idsBeneficiario){
 		super();
