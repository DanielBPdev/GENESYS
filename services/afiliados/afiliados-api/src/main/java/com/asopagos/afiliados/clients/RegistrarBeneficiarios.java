 ...
 * /rest/afiliados/{idAfiliado}/beneficiariosMultiple
 */
public class RegistrarBeneficiarios extends ServiceClient { 
 	...
 	public RegistrarBeneficiarios (Long idAfiliado,List<BeneficiarioDTO> beneficiariosDTO){
 		super();
