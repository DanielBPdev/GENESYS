 ...
 * /rest/PagosSubsidioMonetarioComposite/anularSubsidiosMonetariosSinReemplazo
 */
public class AnularSubsidiosMonetariosSinReemplazo extends ServiceClient { 
    	private AbonoAnuladoDetalleAnuladoDTO abonoAnuladoDetalleAnuladoDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private List<Long> result;
  
 	public AnularSubsidiosMonetariosSinReemplazo (AbonoAnuladoDetalleAnuladoDTO abonoAnuladoDetalleAnuladoDTO){
 		super();
