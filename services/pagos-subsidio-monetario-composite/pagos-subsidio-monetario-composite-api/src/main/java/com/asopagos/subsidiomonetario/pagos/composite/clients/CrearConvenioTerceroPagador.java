 ...
 * /rest/PagosSubsidioMonetarioComposite/crearConvenioTerceroPagador
 */
public class CrearConvenioTerceroPagador extends ServiceClient { 
    	private ConvenioTercerPagadorDTO convenio;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Long result;
  
 	public CrearConvenioTerceroPagador (ConvenioTercerPagadorDTO convenio){
 		super();
