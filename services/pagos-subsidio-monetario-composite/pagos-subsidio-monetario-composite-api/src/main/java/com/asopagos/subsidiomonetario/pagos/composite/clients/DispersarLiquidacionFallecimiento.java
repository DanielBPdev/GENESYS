 ...
 * /rest/PagosSubsidioMonetarioComposite/dispersarLiquidacionFallecimiento
 */
public class DispersarLiquidacionFallecimiento extends ServiceClient { 
 	...
 	public DispersarLiquidacionFallecimiento (String numeroRadicado,List<Long> lstIdsCondicionesBeneficiarios){
 		super();
