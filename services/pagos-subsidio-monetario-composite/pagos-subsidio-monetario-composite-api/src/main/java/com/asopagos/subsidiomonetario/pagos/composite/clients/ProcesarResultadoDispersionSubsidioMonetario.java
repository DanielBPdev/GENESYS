 ...
 * /rest/PagosSubsidioMonetarioComposite/ProcesarResultadoDispersionSubsidioMonetario
 */
public class ProcesarResultadoDispersionSubsidioMonetario extends ServiceClient {
    	private ResultadoDispersionAnibolDTO respuestaAnibol;
  
  
 	public ProcesarResultadoDispersionSubsidioMonetario (ResultadoDispersionAnibolDTO respuestaAnibol){
 		super();
