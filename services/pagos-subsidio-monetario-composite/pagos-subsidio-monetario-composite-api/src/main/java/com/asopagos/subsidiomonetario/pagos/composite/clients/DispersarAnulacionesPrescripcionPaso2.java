 ...
 * /rest/PagosSubsidioMonetarioComposite/dispersarAnulacionesPrescripcionPaso2
 */
public class DispersarAnulacionesPrescripcionPaso2 extends ServiceClient { 
    	private ResultadoDispersionAnibolDTO respuestaAnibol;
  
  
 	public DispersarAnulacionesPrescripcionPaso2 (ResultadoDispersionAnibolDTO respuestaAnibol){
 		super();
