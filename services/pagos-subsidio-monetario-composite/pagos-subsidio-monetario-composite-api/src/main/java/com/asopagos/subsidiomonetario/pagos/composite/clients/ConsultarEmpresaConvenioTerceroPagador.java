 ...
 */
public class ConsultarEmpresaConvenioTerceroPagador extends ServiceClient {
 	...
 	public ConsultarEmpresaConvenioTerceroPagador (String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
