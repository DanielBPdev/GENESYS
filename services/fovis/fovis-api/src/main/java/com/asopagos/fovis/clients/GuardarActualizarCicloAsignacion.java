 ...
 * /rest/fovis/guardarActualizarCicloAsignacion
 */
public class GuardarActualizarCicloAsignacion extends ServiceClient { 
    	private CicloAsignacionModeloDTO cicloAsignacionModelDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private CicloAsignacionModeloDTO result;
  
 	public GuardarActualizarCicloAsignacion (CicloAsignacionModeloDTO cicloAsignacionModelDTO){
 		super();
