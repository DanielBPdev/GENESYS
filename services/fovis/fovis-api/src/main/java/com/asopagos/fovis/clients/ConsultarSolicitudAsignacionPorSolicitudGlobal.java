 ...
 * /rest/fovis/consultarSolicitudAsignacionPorSolicitudGlobal
 */
public class ConsultarSolicitudAsignacionPorSolicitudGlobal extends ServiceClient {
 	...
 	public ConsultarSolicitudAsignacionPorSolicitudGlobal (Long idSolicitudGlobal){
 		super();
