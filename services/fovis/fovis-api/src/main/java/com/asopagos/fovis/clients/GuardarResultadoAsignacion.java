 ...
 * /rest/fovis/guardarResultadoAsignacion
 */
public class GuardarResultadoAsignacion extends ServiceClient { 
 	...
 	public GuardarResultadoAsignacion (SolicitudAsignacionFOVISModeloDTO solicitudAsignacion){
 		super();
