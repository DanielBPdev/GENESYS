 ...
 * /rest/fovis/guardarSolicitudAsignacion
 */
public class GuardarSolicitudAsignacion extends ServiceClient { 
 	...
 	public GuardarSolicitudAsignacion (SolicitudAsignacionFOVISModeloDTO solicitudAsignacion){
 		super();
