 ...
 * /rest/fovis/consultarSolicitudesPostulacionEnProceso
 */
public class ConsultarSolicitudesPostulacionEnProceso extends ServiceClient {
 	...
 	public ConsultarSolicitudesPostulacionEnProceso (String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
