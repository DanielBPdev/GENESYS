 ...
 * /rest/fovis/guardarSolicitudGlobal
 */
public class GuardarSolicitudGlobal extends ServiceClient { 
    	private SolicitudModeloDTO solicitudDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Long result;
  
 	public GuardarSolicitudGlobal (SolicitudModeloDTO solicitudDTO){
 		super();
