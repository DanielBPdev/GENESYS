 ...
 * /rest/fovis/crearActualizarListaPostulacionFOVIS
 */
public class CrearActualizarListaPostulacionFOVIS extends ServiceClient { 
    	private List<PostulacionFOVISModeloDTO> listaPostulaciones;
  
  
 	public CrearActualizarListaPostulacionFOVIS (List<PostulacionFOVISModeloDTO> listaPostulaciones){
 		super();
