 ...
 * /rest/fovis/consultarSolicitudGlobalPostulacion/{idPostulacion}
 */
public class ConsultarSolicitudGlobalPostulacion extends ServiceClient {
 	...
 	public ConsultarSolicitudGlobalPostulacion (Long idPostulacion){
 		super();
