 ...
 * /rest/fovis/consultarPostulacionesEnCicloAsignacion
 */
public class ConsultarPostulacionesEnCicloAsignacion extends ServiceClient { 
 	...
 	public ConsultarPostulacionesEnCicloAsignacion (Long idCicloAsignacion,List<EstadoHogarEnum> estadosHogar){
 		super();
