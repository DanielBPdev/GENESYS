 ...
 * /rest/fovisCargue/verificarEstructuraArchivoCruce
 */
public class VerificarEstructuraArchivoCruce extends ServiceClient { 
    	private InformacionArchivoDTO archivo;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private ResultadoValidacionArchivoDTO result;
  
 	public VerificarEstructuraArchivoCruce (InformacionArchivoDTO archivo){
 		super();
