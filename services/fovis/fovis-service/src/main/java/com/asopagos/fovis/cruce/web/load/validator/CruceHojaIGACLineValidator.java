...
public class CruceHojaIGACLineValidator extends LineValidator {
     ...
     */
    public CruceHojaIGACLineValidator() {
    }
    ...
    public void validate(LineArgumentDTO arguments) throws FileProcessingException {
        ...
        try {
            ...
            if (lineNumber > NumerosEnterosConstants.UNO) {
                ...
                FieldValidatorUtil.validate(lstHallazgos, line, lineNumber, FileFieldConstants.DIRECCION, FileFieldConstants.MSG_DIRECCION_SIN_TILDE,
                ...
                FieldValidatorUtil.validate(lstHallazgos, line, lineNumber, FileFieldConstants.MUNICIPIO, FileFieldConstants.MSG_MPIO_SIN_PUNTO, null,
                        null, false, false);
            }
                ...
                // Se valida el campo No 6 - DIRECCIÓN
                FieldValidatorUtil.validateHeader(lstHallazgos, line, lineNumber, FileFieldConstants.DIRECCION,
                        FileFieldConstants.MSG_DIRECCION, FileFieldConstants.MSG_DIRECCION_SIN_TILDE);
                // Se valida el campo No 7 - MATRICULA INMOBILIARIA
                ...
                FieldValidatorUtil.validateHeader(lstHallazgos, line, lineNumber, FileFieldConstants.MUNICIPIO, FileFieldConstants.MSG_MPIO,
                        FileFieldConstants.MSG_MPIO_SIN_PUNTO);
            }
