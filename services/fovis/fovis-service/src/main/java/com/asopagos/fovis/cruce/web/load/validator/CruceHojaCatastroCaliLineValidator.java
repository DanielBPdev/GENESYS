...
public class CruceHojaCatastroCaliLineValidator extends LineValidator {
     ...
     */
    public CruceHojaCatastroCaliLineValidator() {
    }
        ...
        try {
            ...
            if (lineNumber > NumerosEnterosConstants.UNO) {
                ...
                FieldValidatorUtil.validate(lstHallazgos, line, lineNumber, FileFieldConstants.IDENTIFICACION,
                        FileFieldConstants.MSG_IDENTIFICACION_SIN_TILDE, null, ExpresionesRegularesConstants.UNO_O_MAS_DIGITOS, false, false);
                ...
                FieldValidatorUtil.validateHeader(lstHallazgos, line, lineNumber, FileFieldConstants.IDENTIFICACION,
                        FileFieldConstants.MSG_IDENTIFICACION, FileFieldConstants.MSG_IDENTIFICACION_SIN_TILDE);
                // Se valida el campo No 4 - APELLIDOS Y NOMBRES
                ...
                FieldValidatorUtil.validateHeader(lstHallazgos, line, lineNumber, FileFieldConstants.DEPARTAMENTO, FileFieldConstants.MSG_DPTO,
                        FileFieldConstants.MSG_DPTO);
                // Se valida el campo No 7 - MPIO.
