 ...
 */
public class CruceHojaUnidosPersistLine implements IPersistLine {
        ...
        for (int i = 1; i < lines.size(); i++) {
            ...
            if (hallazgos.isEmpty()) {
                try {
                    ...
                    if (esCampoValido(line, FileFieldConstants.FOLIO)) {
                        String puntaje = getValorCampo(line, FileFieldConstants.FOLIO);
