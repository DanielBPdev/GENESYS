 ...
 */
public class CruceHojaCatastroMedellinPersistLine implements IPersistLine {
        ...
        for (int i = 1; i < lines.size(); i++) {
            ...
            if (hallazgos.isEmpty()) {
                try {
                    ...
                    // Se valida el campo No 1 - NOMBRE ENTIDAD
                    ...
                    // Se valida el campo No 2 - IDENTIFICACIÓN
                    ...
                    // Se valida el campo No 4 - DIRECCIÓN
                    if (esCampoValido(line, FileFieldConstants.DIRECCION)) {
                        String direccion = getValorCampo(line, FileFieldConstants.DIRECCION);
                    ...
                    } // Se valida el campo No 8 - CEDULA CATASTRAL
