...
public class CruceHojaCatastroMedellinLineValidator extends LineValidator {
     ...
     */
    public CruceHojaCatastroMedellinLineValidator() {
    }
        ...
        try {
            ...
            if (lineNumber > NumerosEnterosConstants.UNO) {
                ...
                FieldValidatorUtil.validate(lstHallazgos, line, lineNumber, FileFieldConstants.NOMBRE_ENTIDAD,
                        FileFieldConstants.MSG_NOMBRE_ENTIDAD, null, ExpresionesRegularesConstants.UNO_O_MAS_DIGITOS, false, false);
                ...
                FieldValidatorUtil.validateHeader(lstHallazgos, line, lineNumber, FileFieldConstants.DIRECCION,
                        FileFieldConstants.MSG_DIRECCION, FileFieldConstants.MSG_DIRECCION);
                // Se valida el campo No 5 - DEPARTAMENTO
