...
public class CruceHojaCatastroAntioquiaLineValidator extends LineValidator {
     ...
     */
    public CruceHojaCatastroAntioquiaLineValidator() {
    }
        ...
        try {
            ...
            if (lineNumber > NumerosEnterosConstants.UNO) {
                ...
                FieldValidatorUtil.validate(lstHallazgos, line, lineNumber, FileFieldConstants.NOMBRES, FileFieldConstants.MSG_NOMBRES,
                        null, null, false, false);
                // Se valida el campo No 6 - CEDULA CATASTRAL
                ...
                // Se valida el campo No 7 - DIRECCIÓN INMUEBLE
                FieldValidatorUtil.validate(lstHallazgos, line, lineNumber, FileFieldConstants.DIRECCION_INMUEBLE,
                        FileFieldConstants.MSG_DIRECCION_INMUEBLE, null, null, false, false);
                // Se valida el campo No 8 - MATRICULA INMOBILIARIA
                ...
                // Se valida el campo No 9 - DPTO.
                FieldValidatorUtil.validate(lstHallazgos, line, lineNumber, FileFieldConstants.DEPARTAMENTO, FileFieldConstants.MSG_DPTO,
                        null, null, false, false);
                // Se valida el campo No 10 - MPIO.
                ...
                // Se valida el campo No 7 - DIRECCIÓN INMUEBLE
                FieldValidatorUtil.validateHeader(lstHallazgos, line, lineNumber, FileFieldConstants.DIRECCION_INMUEBLE,
                        FileFieldConstants.MSG_DIRECCION_INMUEBLE, FileFieldConstants.MSG_DIRECCION_INMUEBLE);
                // Se valida el campo No 8 - MATRICULA INMOBILIARIA
                ...
                // Se valida el campo No 9 - DEPTO.
                FieldValidatorUtil.validateHeader(lstHallazgos, line, lineNumber, FileFieldConstants.DEPARTAMENTO,
                        FileFieldConstants.MSG_DPTO, FileFieldConstants.MSG_DPTO);
                // Se valida el campo No 10 - MPIO.
                FieldValidatorUtil.validateHeader(lstHallazgos, line, lineNumber, FileFieldConstants.MUNICIPIO, FileFieldConstants.MSG_MPIO,
                        FileFieldConstants.MSG_MPIO);
            }
