...
public class CruceHojaSisbenLineValidator extends LineValidator {
     ...
     */
    public CruceHojaSisbenLineValidator() {
    }
    ...
    public void validate(LineArgumentDTO arguments) throws FileProcessingException {
        ...
        try {
            ...
            if (lineNumber > NumerosEnterosConstants.UNO) {
                ...
                FieldValidatorUtil.validate(lstHallazgos, line, lineNumber, FileFieldConstants.PUNTAJE, FileFieldConstants.MSG_PUNTAJE,
                ...
                FieldValidatorUtil.validate(lstHallazgos, line, lineNumber, FileFieldConstants.ZONA, FileFieldConstants.MSG_ZONA, null,
                        null, false, false);
                ...
                // Se valida el campo No 3 - PUNTAJE
                FieldValidatorUtil.validateHeader(lstHallazgos, line, lineNumber, FileFieldConstants.PUNTAJE, FileFieldConstants.MSG_PUNTAJE,
                        FileFieldConstants.MSG_PUNTAJE);
                // Se valida el campo No 4 - SEXO
                ...
                // Se valida el campo No 5 - ZONA
                FieldValidatorUtil.validateHeader(lstHallazgos, line, lineNumber, FileFieldConstants.ZONA, FileFieldConstants.MSG_ZONA,
                        FileFieldConstants.MSG_ZONA);
                // Se valida el campo No 6 - PARENTESCO
