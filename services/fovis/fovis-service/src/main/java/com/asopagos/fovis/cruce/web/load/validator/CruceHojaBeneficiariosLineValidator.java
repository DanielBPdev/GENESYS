...
public class CruceHojaBeneficiariosLineValidator extends LineValidator {
     ...
     */
    public CruceHojaBeneficiariosLineValidator() {
    }
    ...
    public void validate(LineArgumentDTO arguments) throws FileProcessingException {
        ...
        try {
            ...
            if (lineNumber > NumerosEnterosConstants.UNO) {
                ...
                // Se valida el encabezado No 1 - NIT ENTIDAD
                ...
                // Se valida el encabezado No 2 - NOMBRE ENTIDAD
                ...
                // Se valida el encabezado No 3 - IDENTIFICACIÓN
                ...
                // Se valida el encabezado No 4 - APELLIDOS
                ...
                // Se valida el encabezado No 5 - NOMBRES
