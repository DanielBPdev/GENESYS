...
public class RandomGenerator {
     ...
     * @param max
     * @param escala
     *        Numero de decimales del numero requerido
     ...
     * @param lista:
     *        conjunto del cual se va a extraer un elemento
     ...
     * @param clazz
     *        Enumeracion de la cual se desea obtener el elemento
     ...
     * @param tamano
     *        Tamaño de la cadena que se quiere generar
    ...
    /**
     * Método para generar una fecha aleatoria en un rango
     * @param fechaInicial
     *        fecha inicial
     * @param fechaFinal
     *        fecha final
     ...
     */
    public static Date randomDateFromRange(Date fechaInicial, Date fechaFinal) {
        return new Date(ThreadLocalRandom.current().nextLong(fechaInicial.getTime(), fechaFinal.getTime()));
    }
     ...
     * @return fecha generada
     */
    public static Long randomDateFromRange(Long fechaInicial, Long fechaFinal) {
        return generarBigDecimalAletorioRango(new BigDecimal(fechaInicial), new BigDecimal(fechaFinal), 0).longValue();
    }
