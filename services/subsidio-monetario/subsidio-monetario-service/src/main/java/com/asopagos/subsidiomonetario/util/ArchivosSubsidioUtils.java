 ...
 */
public class ArchivosSubsidioUtils {
    ...
    public static String generarNombreArchivoConsultaDesbloquear() {
        
        String nombreReporte = "Beneficiarios_bloqueados";
    ...
    public static String generarNombreArchivoInconsistentes(String nombreArchivo) {
        
        String[] nombreSplit = nombreArchivo.split(".txt");
        String nombreSinExtension = nombreSplit[0];
        String extension = "_RECH.txt";
