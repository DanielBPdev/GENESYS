 ...
 * /rest/subsidioMonetario/consultar/proyeccionCuotasFallecimiento/medioDePago/{numeroRadicacion}/{identificadorCondicion}
 */
public class ConsultarDispersionMontoLiquidadoFallecimientoProyeccionCuotas extends ServiceClient {
 	...
 	public ConsultarDispersionMontoLiquidadoFallecimientoProyeccionCuotas (String numeroRadicacion,Long identificadorCondicion){
 		super();
