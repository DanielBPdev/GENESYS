 ...
 * /rest/subsidioMonetario/consultarResultadoLiquidacionFallecimiento/{numeroSolicitud}
 */
public class ConsultarResultadoLiquidacionFallecimiento extends ServiceClient {
 	...
 	public ConsultarResultadoLiquidacionFallecimiento (String numeroSolicitud){
 		super();
