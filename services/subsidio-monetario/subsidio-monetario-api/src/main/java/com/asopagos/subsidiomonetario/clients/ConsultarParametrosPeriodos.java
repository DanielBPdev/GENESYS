 ...
 * /rest/subsidioMonetario/consultarParametrosPeriodos
 */
public class ConsultarParametrosPeriodos extends ServiceClient { 
    	private List<Long> periodos;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private List<ValorPeriodoDTO> result;
  
 	public ConsultarParametrosPeriodos (List<Long> periodos){
 		super();
