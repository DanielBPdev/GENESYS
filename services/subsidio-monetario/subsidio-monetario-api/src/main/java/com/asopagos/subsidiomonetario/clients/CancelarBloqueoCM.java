 ...
 * /rest/subsidioMonetario/cancelar/bloqueoCM/{idCargueBloqueoCuotaMonetaria}
 */
public class CancelarBloqueoCM extends ServiceClient { 
  	private Long idCargueBloqueoCuotaMonetaria;
    
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private int result;
  
 	public CancelarBloqueoCM (Long idCargueBloqueoCuotaMonetaria){
 		super();
