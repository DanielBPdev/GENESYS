 ...
 * /rest/subsidioMonetario/trabajadores/subsidiosLiquidados/{numeroSolicitud}
 */
public class SubsidiosLiquidadosPorTrabajadores extends ServiceClient {
 	...
 	public SubsidiosLiquidadosPorTrabajadores (String numeroSolicitud){
 		super();
