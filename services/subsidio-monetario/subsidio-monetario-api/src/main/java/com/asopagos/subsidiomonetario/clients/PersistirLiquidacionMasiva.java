 ...
 * /rest/subsidioMonetario/persistirLiquidacionMasiva
 */
public class PersistirLiquidacionMasiva extends ServiceClient { 
 	...
 	public PersistirLiquidacionMasiva (Long periodo,SolicitudLiquidacionSubsidioModeloDTO liquidacion){
 		super();
