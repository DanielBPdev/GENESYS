 ...
 * /rest/subsidioMonetario/ejecutarLiquidacionEspecifica
 */
public class EjecutarLiquidacionEspecifica extends ServiceClient { 
    	private LiquidacionEspecificaDTO liquidacionEspecifica;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private RespuestaGenericaDTO result;
  
 	public EjecutarLiquidacionEspecifica (LiquidacionEspecificaDTO liquidacionEspecifica){
 		super();
