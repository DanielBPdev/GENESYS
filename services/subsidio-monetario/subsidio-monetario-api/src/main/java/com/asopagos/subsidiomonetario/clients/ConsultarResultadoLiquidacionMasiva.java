 ...
 * /rest/subsidioMonetario/consultarResultadoLiquidacionMasiva/{numeroSolicitud}
 */
public class ConsultarResultadoLiquidacionMasiva extends ServiceClient {
 	...
 	public ConsultarResultadoLiquidacionMasiva (String numeroSolicitud){
 		super();
