 ...
 * /rest/subsidioMonetario/consultarValorCuotaPeriodos
 */
public class ConsultarValorCuotaPeriodos extends ServiceClient { 
    	private List<Long> periodos;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private List<ValorPeriodoDTO> result;
  
 	public ConsultarValorCuotaPeriodos (List<Long> periodos){
 		super();
