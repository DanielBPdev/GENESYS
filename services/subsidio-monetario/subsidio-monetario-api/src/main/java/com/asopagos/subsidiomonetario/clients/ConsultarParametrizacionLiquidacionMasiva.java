 ...
 * /rest/subsidioMonetario/consultarParametrizacion/liquidacionMasiva/{numeroRadicacion}
 */
public class ConsultarParametrizacionLiquidacionMasiva extends ServiceClient {
 	...
 	public ConsultarParametrizacionLiquidacionMasiva (String numeroRadicacion){
 		super();
