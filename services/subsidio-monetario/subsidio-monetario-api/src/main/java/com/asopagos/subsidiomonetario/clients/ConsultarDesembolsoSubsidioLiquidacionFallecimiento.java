 ...
 * /rest/subsidioMonetario/liquidacionFallecimiento/consultar/desembolsoSubsidio/{numeroRadicacion}
 */
public class ConsultarDesembolsoSubsidioLiquidacionFallecimiento extends ServiceClient {
 	...
 	public ConsultarDesembolsoSubsidioLiquidacionFallecimiento (String numeroRadicacion){
 		super();
