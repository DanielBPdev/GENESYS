 ...
 * /rest/subsidioMonetario/consultarValorCuotaAgrariaPeriodos
 */
public class ConsultarValorCuotaAgrariaPeriodos extends ServiceClient { 
    	private List<Long> periodos;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private List<ValorPeriodoDTO> result;
  
 	public ConsultarValorCuotaAgrariaPeriodos (List<Long> periodos){
 		super();
