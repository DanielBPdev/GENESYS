 ...
 * /rest/subsidioMonetario/trabajadores/montoSubsidiosLiquidados/{numeroSolicitud}
 */
public class MontoSubsidiosLiquidadosPorTrabajadores extends ServiceClient {
 	...
 	public MontoSubsidiosLiquidadosPorTrabajadores (String numeroSolicitud){
 		super();
