 ...
 * /rest/subsidioMonetario/trabajadores/subsidiosInvalidez/{numeroSolicitud}
 */
public class SubsidiosInvalidezPorTrabajadores extends ServiceClient {
 	...
 	public SubsidiosInvalidezPorTrabajadores (String numeroSolicitud){
 		super();
