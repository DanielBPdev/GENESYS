 ...
 * /rest/subsidioMonetario/trabajadores/descuentos/{numeroSolicitud}
 */
public class TrabajadoresDescuentos extends ServiceClient {
 	...
 	public TrabajadoresDescuentos (String numeroSolicitud){
 		super();
