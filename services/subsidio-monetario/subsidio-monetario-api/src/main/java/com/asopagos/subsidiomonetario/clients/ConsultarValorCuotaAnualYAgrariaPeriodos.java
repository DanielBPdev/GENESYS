 ...
 * /rest/subsidioMonetario/consultarValorCuotaAnualYAgrariaPeriodos
 */
public class ConsultarValorCuotaAnualYAgrariaPeriodos extends ServiceClient { 
    	private List<Long> periodos;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private List<ValorPeriodoDTO> result;
  
 	public ConsultarValorCuotaAnualYAgrariaPeriodos (List<Long> periodos){
 		super();
