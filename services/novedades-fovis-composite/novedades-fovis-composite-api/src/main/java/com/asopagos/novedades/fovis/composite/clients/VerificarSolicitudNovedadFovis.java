 ...
 * /rest/novedadesFovisComposite/verificarSolicitudNovedadFovis
 */
public class VerificarSolicitudNovedadFovis extends ServiceClient { 
    	private VerificacionNovedadFovisDTO verificacionNovedadFovis;
  
  
 	public VerificarSolicitudNovedadFovis (VerificacionNovedadFovisDTO verificacionNovedadFovis){
 		super();
