 ...
 * /rest/novedadesFovisComposite/consultarSolicitudAnalisisNovedadAfectaFOVIS
 */
public class ConsultarSolicitudAnalisisNovedadAfectaFOVIS extends ServiceClient {
 	...
 	public ConsultarSolicitudAnalisisNovedadAfectaFOVIS (Long idSolicitud){
 		super();
