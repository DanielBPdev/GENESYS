...
public class ConstantesValidaciones {
    ...
    public static final String IS_INGRESO_RETIRO = "isIngresoRetiro";

    public static final String KEY_BENEFICIARIO_COYUGE_EXISTENTE = "novedades.persona.beneficiarioCoyugeExistente";
}
