 ...
 */
public class ValidadorExisteRegistroSubsanacionAfiliado extends ValidadorAbstract {
    /*
     * (non-Javadoc)
     * 
    ...
    public ValidacionDTO execute(Map<String, String> datosValidacion) {
        ...
        try {
            ...
            if (noExisteSubsanacion(listRolAfiliado, listExpulsionSubsanada)) {
                ...
                // Validación exitosa
                return crearMensajeExitoso(ValidacionCoreEnum.VALIDACION_EXISTE_REGISTRO_SUBSANACION_AFILIADO);
            }
            else {
                ...
                return crearValidacion(myResources.getString(ConstantesValidaciones.KEY_PERSONA_NO_EXISTE_REGISTRO_SUBSANACION),
                        ResultadoValidacionEnum.NO_APROBADA, ValidacionCoreEnum.VALIDACION_EXISTE_REGISTRO_SUBSANACION_AFILIADO,
                        TipoExcepcionFuncionalEnum.EXCEPCION_FUNCIONAL_TIPO_2);
            }
        } catch (Exception e) {
            logger.error("No evaluado - Ocurrió alguna excepción", e);
            return crearMensajeNoEvaluado(ConstantesValidaciones.KEY_MENSAJE_NO_EV,
                    ValidacionCoreEnum.VALIDACION_EXISTE_REGISTRO_SUBSANACION_AFILIADO, TipoExcepcionFuncionalEnum.EXCEPCION_TECNICA);
        }
    }
