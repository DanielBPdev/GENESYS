 ...
 */
public class ValidadorAfiliadoPrincipalBeneficiarioPadre extends ValidadorAbstract {
    /*
     * (non-Javadoc)
     * 
    ...
    private boolean validarBeneficiario(TipoIdentificacionEnum tipoIdentificacionAfiliado, String numeroIdentificacionAfiliado,
        ...
        List<Beneficiario> personasConTipoYNumero = entityManager
                ...
                .setParameter(ConstantesValidaciones.ESTADO_BENEFICIARIO, ValidacionPersonaUtils.obtenerEstadosAfiliado()).getResultList();
