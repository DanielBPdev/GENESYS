...
/**
 * CLASE QUE VALIDA:
 * Si el campo "Fecha vencimiento certificado escolar" tiene una fecha 
 * anterior a la fecha del sistema en el momento de la ejecución de 
 * identificación de solicitudes de novedades automáticas 
 * 
 * @author Steven Quintero González <squintero@heinsohn.com.co>
 */
public class ValidadorFechaVencimientoCertificadoEscolar extends ValidadorAbstract {
	/*
	 * (non-Javadoc)
	 * 
