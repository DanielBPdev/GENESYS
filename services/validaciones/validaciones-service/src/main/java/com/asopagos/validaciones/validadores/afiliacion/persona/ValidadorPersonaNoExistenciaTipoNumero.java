 ...
 */
public class ValidadorPersonaNoExistenciaTipoNumero extends ValidadorAbstract {
	/*
	 * (non-Javadoc)
	 * 
	...
	public ValidacionDTO execute(Map<String, String> datosValidacion) {
		logger.debug("Inicio de método ValidadorExistenciaPersona.execute");
		try {
					...
					if ((tipoIdentificacion != null && !tipoIdentificacion.equals(""))
						...
						if (!existePersonaPorTipoNumeroDocumento(tipoIdentificacion, numeroIdentificacion)) {
							...
							if (existePersonaPorNumeroDocumento(numeroIdentificacion)) {
								existeConOtroId = true;
							} else if (fechaNacimiento != null && primerNombre != null && primerApellido != null) {
						...
						if (existeConOtroId) {
							logger.debug("No aprobada- Persona existe con numero de documento o nombres");
							return crearValidacion(
									myResources.getString(ConstantesValidaciones.KEY_PERSONA_REGISTRADA_OTRO_ID),
									ResultadoValidacionEnum.NO_APROBADA,
									ValidacionCoreEnum.VALIDACION_PERSONA_NO_EXISTENCIA_TIPO_NUMERO, null);
						}
					}
			...
			return crearMensajeExitoso(ValidacionCoreEnum.VALIDACION_PERSONA_NO_EXISTENCIA_TIPO_NUMERO);
	...
	private ValidacionDTO crearMensajeNoEvaluado() {
		return crearValidacion(
				myResources.getString(ConstantesValidaciones.KEY_MENSAJE_NO_EV) + SEPARADOR
						+ myResources.getString(ConstantesValidaciones.KEY_PERSONA_REGISTRADA_OTRO_ID),
				ResultadoValidacionEnum.NO_EVALUADA, ValidacionCoreEnum.VALIDACION_PERSONA_NO_EXISTENCIA_TIPO_NUMERO,
	...
	private boolean existePersonaPorTipoNumeroDocumento(String tipoIdentificacion, String numeroIdentificacion) {
		try {
			...
			entityManager.createNamedQuery(NamedQueriesConstants.BUSCAR_PERSONA_POR_TIPO_NUMERO)
