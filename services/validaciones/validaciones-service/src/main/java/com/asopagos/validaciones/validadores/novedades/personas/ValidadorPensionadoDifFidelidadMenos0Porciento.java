...
/**
 * CLASE QUE VALIDA:
 * El afiliado principal debe tener estado "Activo" como Pensionado 
 * diferente de  las clasificaciones "Fidelidad 25 años" y "Pensionado menos de 1,5 SM y 0%"
 *  
 * 
 * @author Steven Quintero González <squintero@heinsohn.com.co>
 */
public class ValidadorPensionadoDifFidelidadMenos0Porciento extends ValidadorAbstract {
	/*
	 * (non-Javadoc)
	 * 
	...
	public ValidacionDTO execute(Map<String, String> datosValidacion) {
		logger.debug("Inicio de método ValidadorPensionadoDifFidelidadMenos0Porciento.execute");
		try{
		    if (datosValidacion == null || datosValidacion.isEmpty() || datosValidacion.get(ConstantesValidaciones.TIPO_ID_PARAM) == null
                ...
                crearMensajeNoEvaluado(ConstantesValidaciones.KEY_MENSAJE_NO_PARAMS,
                        ValidacionCoreEnum.VALIDACION_PENSIONADO_DIF_FIDELIDAD_MENOS_O_PORCIENTO, TipoExcepcionFuncionalEnum.EXCEPCION_TECNICA);
            }
			...
			estadosValidos.add(ClasificacionEnum.MENOS_1_5_SM_0_6_POR_CIENTO);
			estadosValidos.add(ClasificacionEnum.MENOS_1_5_SM_2_POR_CIENTO);
			estadosValidos.add(ClasificacionEnum.MAS_1_5_SM_0_6_POR_CIENTO);
			estadosValidos.add(ClasificacionEnum.MAS_1_5_SM_2_POR_CIENTO);
			//estadosValidos.add(ClasificacionEnum.PENSION_FAMILIAR);
			...
			{
				//validación exitosa
				logger.debug("HABILITADA- Fin de método ValidadorPensionadoDifFidelidadMenos0Porciento.execute");
				return crearMensajeExitoso(ValidacionCoreEnum.VALIDACION_PENSIONADO_DIF_FIDELIDAD_MENOS_O_PORCIENTO);	
			}else{
				//validación fallida
				logger.debug("NO HABILITADA- Fin de método ValidadorPensionadoDifFidelidadMenos0Porciento.execute");
				return crearValidacion(myResources.getString(ConstantesValidaciones.KEY_PENSIONADO_DIF_FIDELIDAD_MENOS_O_PORCIENTO),ResultadoValidacionEnum.NO_APROBADA,
						ValidacionCoreEnum.VALIDACION_PENSIONADO_DIF_FIDELIDAD_MENOS_O_PORCIENTO,
