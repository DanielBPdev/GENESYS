 ...
 */
@Stateless
public class ValidacionesPersistenceBusiness implements ValidacionesPersistenceService {

    /**
     * Instancia del gestor de registro de eventos
     */
    private static final ILogger logger = LogManager.getLogger(ValidacionesPersistenceBusiness.class);
