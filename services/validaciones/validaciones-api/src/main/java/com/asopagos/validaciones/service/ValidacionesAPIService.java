 ...
 *         </a>
 */
@Path("validacionesAPI")
@Consumes("application/json; charset=UTF-8")
@Produces("application/json; charset=UTF-8")
public interface ValidacionesAPIService {
	/**
	...
	public List<ValidacionDTO> validarPersonas(@QueryParam("proceso") ProcesoEnum proceso,
	...
	public List<ParametrizacionNovedadDTO> validadorNovedadesHabilitadas(@QueryParam("proceso")ProcesoEnum proceso,@NotNull @QueryParam("objetoValidacion") List<String> objetoValidacion,@QueryParam("tipoNovedad")TipoNovedadEnum tipoNovedad,Map<String, String> datosValidacion);
