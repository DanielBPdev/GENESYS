 ...
 */
public class ValidadorNovedadesHabilitadas extends ServiceClient { 
 	...
 	public ValidadorNovedadesHabilitadas (List<String> objetoValidacion,ProcesoEnum proceso,TipoNovedadEnum tipoNovedad,Map<String,String> datosValidacion){
 		super();
