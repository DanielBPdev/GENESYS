 ...
 */
public class ValidarCargaMultipleNovedades extends ServiceClient { 
 	...
 	public ValidarCargaMultipleNovedades (String bloque,ProcesoEnum proceso,String objetoValidacion,List<TrabajadorCandidatoNovedadDTO> candidatosDTO){
 		super();
		this.bloque=bloque;
