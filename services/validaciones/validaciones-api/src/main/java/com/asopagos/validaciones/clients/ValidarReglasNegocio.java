 ...
 */
public class ValidarReglasNegocio extends ServiceClient { 
 	...
 	public ValidarReglasNegocio (String bloque,ProcesoEnum proceso,String objetoValidacion,Map<String,String> datosValidacion){
 		super();
		this.bloque=bloque;
