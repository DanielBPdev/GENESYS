 ...
 */
public class ValidarCargaMultipleAfiliacionesStoredProcedure extends ServiceClient { 
 	...
 	public ValidarCargaMultipleAfiliacionesStoredProcedure (String bloque,ProcesoEnum proceso,String objetoValidacion,List<AfiliarTrabajadorCandidatoDTO> candidatosDTO){
 		super();
		this.bloque=bloque;
