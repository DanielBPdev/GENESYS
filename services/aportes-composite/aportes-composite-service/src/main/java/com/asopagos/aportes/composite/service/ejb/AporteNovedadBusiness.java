...
public class AporteNovedadBusiness implements IAporteNovedadLocal {
    
    private final String CANAL_PILA = "PILA";
    
    private final String CANAL_PRESENCIAL = "PRESENCIAL";

    private ILogger logger = LogManager.getLogger(AporteNovedadBusiness.class);
    ...
    private Boolean procesarNovedadIngresoCartera(TipoAfiliadoEnum tipoCotizante, TipoIdentificacionEnum tipoIdAportante,
        ...
        String firmaMetodo = "AporteNovedadBussines.procesarNovedadIngresoCartera(TipoAfiliadoEnum, TipoIdentificacionEnum, "
                + "String, TipoIdentificacionEnum, String, Boolean, Long)";
        logger.info(ConstantesComunes.INICIO_LOGGER + firmaMetodo);

        if (esReintegrable != null ) {
    ...
    private Boolean procesarIntentoNovedad(
          TipoAfiliadoEnum tipoCotizante, 
           TipoIdentificacionEnum tipoIdAportante,
            String numeroIdAportante,
             TipoIdentificacionEnum tipoIdCotizante, 
            String numeroIdCotizante,
            CanalRecepcionEnum canalRecepcion,
             Long idRegistroDetallado, 
             Long tenNovedadId) {
        try {
            ...
            logger.info("Ocurrió un error radicando la solicitud de novedad para " + tipoIdCotizante + "-"+ numeroIdCotizante, e);
    ...
    public Boolean procesarNovedadIngresoAporte(ProcesoNovedadIngresoDTO datosProcesoIng, UserDTO userDTO) {
        String firmaMetodo = "AporteNovedadBussines.procesarNovedadIngresoAporte(ProcesoNovedadIngresoDTO)";
        logger.info(ConstantesComunes.INICIO_LOGGER + firmaMetodo);
    ...
    public void reintegrarGrupoFamiliar(TipoIdentificacionEnum tipoIdCotizante, String numeroIdCotizante,
        ...
        String firmaMetodo = "AporteNovedadBussines.reintegrarGrupoFamiliar(TipoIdentificacionEnum, String)";
        logger.info(ConstantesComunes.INICIO_LOGGER + firmaMetodo);
    ...
    private void activarCuentaPersona(TipoIdentificacionEnum tipoId, String numId) {
        String firmaMetodo = "AporteNovedadBussines.activarCuentaPersona(TipoIdentificacionEnum, String)";
        logger.info(ConstantesComunes.INICIO_LOGGER + firmaMetodo);
    ...
    private Boolean ejecutarMayaValidacionBeneficiario(BeneficiarioDTO beneficiario,
        ...
        String firmaMetodo = "AporteNovedadBussines.ejecutarMayaValidacionBeneficiario(BeneficiarioDTO, TipoIdentificacionEnum, String)";
        logger.info(ConstantesComunes.INICIO_LOGGER + firmaMetodo);
    ...
    private UsuarioCCF buscarUsuario(TipoIdentificacionEnum tipoId, String numId) {
        String firmaMetodo = "AporteNovedadBussines.buscarUsuario(TipoIdentificacionEnum, String)";
        logger.info(ConstantesComunes.INICIO_LOGGER + firmaMetodo);
