 ...
 * /rest/aporteManual/gestionarCotizanteV360/{modalidadRecaudo}
 */
public class GestionarCotizanteV360 extends ServiceClient { 
 	...
 	public GestionarCotizanteV360 (ModalidadRecaudoAporteEnum modalidadRecaudo,Long idPlanilla,CotizanteDTO cotizanteDTO){
 		super();
