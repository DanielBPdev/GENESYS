 ...
 * /rest/aporteManual/finalizarCorreccionAsync
 */
public class FinalizarCorreccionAsync extends ServiceClient { 
    	private InformacionSolicitudDTO infoSolicitud;
  
  
 	public FinalizarCorreccionAsync (InformacionSolicitudDTO infoSolicitud){
 		super();
