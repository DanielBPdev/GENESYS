 ...
 * /rest/externalAPI/aporte/obtenerUltimoAporteAportante
 */
public class ObtenerUltimoAporte extends ServiceClient {
 	...
 	public ObtenerUltimoAporte (String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion,String numeroIdentificacionCotizante){
 		super();
