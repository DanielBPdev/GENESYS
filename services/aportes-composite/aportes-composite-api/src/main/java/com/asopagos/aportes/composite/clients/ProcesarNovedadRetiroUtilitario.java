 ...
 * /rest/AportesComposite/procesarNovedadRetiroUtilitario
 */
public class ProcesarNovedadRetiroUtilitario extends ServiceClient { 
    	private ProcesoIngresoUtilitarioDTO datosProcesoIng;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Boolean result;
  
 	public ProcesarNovedadRetiroUtilitario (ProcesoIngresoUtilitarioDTO datosProcesoIng){
 		super();
