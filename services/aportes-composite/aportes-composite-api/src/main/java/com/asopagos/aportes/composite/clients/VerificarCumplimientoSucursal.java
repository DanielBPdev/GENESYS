 ...
 * /rest/aporteManual/verificarCumplimientoSucursal
 */
public class VerificarCumplimientoSucursal extends ServiceClient { 
   	private Long idRegistroGeneral;
   
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Boolean result;
  
 	public VerificarCumplimientoSucursal (Long idRegistroGeneral){
 		super();
