 ...
 * /rest/cierre/emitirResultadoAnalistaContable
 */
public class EmitirResultadoAnalistaContable extends ServiceClient { 
    	private ResultadoCierreDTO resultadoCierre;
  
  
 	public EmitirResultadoAnalistaContable (ResultadoCierreDTO resultadoCierre){
 		super();
