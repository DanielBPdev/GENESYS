 ...
 * /rest/aporteManual/verificarArchivoPagoManualAportesPensionados
 */
public class VerificarArchivoPagoManualAportesPensionados extends ServiceClient { 
   	private String identificadorDocumento;
   
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private ResultadoArchivoAporteDTO result;
  
 	public VerificarArchivoPagoManualAportesPensionados (String identificadorDocumento){
 		super();
