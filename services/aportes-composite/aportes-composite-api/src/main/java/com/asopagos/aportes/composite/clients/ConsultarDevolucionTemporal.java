 ...
 */
public class ConsultarDevolucionTemporal extends ServiceClient {
 	...
 	public ConsultarDevolucionTemporal (Long idSolicitud){
 		super();
	...
	protected void getResultData(Response response) {
		this.result = (DevolucionDTO) response.readEntity(DevolucionDTO.class);
	}
