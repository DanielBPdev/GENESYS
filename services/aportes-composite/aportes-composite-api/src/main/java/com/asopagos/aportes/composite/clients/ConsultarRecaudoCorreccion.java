 ...
 * /rest/aporteManual/consultarRecaudoCorreccion
 */
public class ConsultarRecaudoCorreccion extends ServiceClient { 
 	...
 	public ConsultarRecaudoCorreccion (Boolean vista360,TipoMovimientoRecaudoAporteEnum tipoMovimientoRecaudoAporte,Boolean hayParametros,ConsultarRecaudoDTO consultaRecaudo){
 		super();
