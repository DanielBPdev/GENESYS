 ...
 * /rest/novedadesCargueMultiple/verificarEstructuraArchivoEmpleador
 */
public class VerificarEstructuraArchivoEmpleador extends ServiceClient { 
    ...
    private InformacionArchivoDTO archivo;
 	...
 	public VerificarEstructuraArchivoEmpleador (InformacionArchivoDTO archivo){
 		super();
