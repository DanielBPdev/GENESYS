 ...
 * /rest/novedadesCargueMultiple/verificarEstructuraArchivoPersona
 */
public class VerificarEstructuraArchivoPersona extends ServiceClient { 
    ...
    private InformacionArchivoDTO archivo;
 	...
 	public VerificarEstructuraArchivoPersona (InformacionArchivoDTO archivo){
 		super();
