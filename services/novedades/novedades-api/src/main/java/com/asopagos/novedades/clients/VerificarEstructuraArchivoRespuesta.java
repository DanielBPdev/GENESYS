 ...
 * /rest/novedadesCargueMultiple/verificarEstructuraArchivoRespuesta/{tipoArchivoRespuesta}
 */
public class VerificarEstructuraArchivoRespuesta extends ServiceClient { 
 	...
 	public VerificarEstructuraArchivoRespuesta (TipoArchivoRespuestaEnum tipoArchivoRespuesta,InformacionArchivoDTO archivo){
 		super();
