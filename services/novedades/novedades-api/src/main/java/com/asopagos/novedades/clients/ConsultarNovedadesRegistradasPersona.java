 ...
 * /rest/novedades/consultarNovedadesRegistradasPersona
 */
public class ConsultarNovedadesRegistradasPersona extends ServiceClient {
 	...
 	public ConsultarNovedadesRegistradasPersona (String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
