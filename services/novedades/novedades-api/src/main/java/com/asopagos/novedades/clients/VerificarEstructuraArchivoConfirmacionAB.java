 ...
 * /rest/novedadesCargueMultiple/verificarEstructuraArchivoConfirmacionAB/{tipoArchivoRespuesta}
 */
public class VerificarEstructuraArchivoConfirmacionAB extends ServiceClient { 
 	...
 	public VerificarEstructuraArchivoConfirmacionAB (TipoArchivoRespuestaEnum tipoArchivoRespuesta,InformacionArchivoDTO archivo){
 		super();
