 ...
 * /rest/novedades/consultarNovedadesEmpleadorVista360
 */
public class ConsultarNovedadesEmpVista360 extends ServiceClient { 
    	private FiltrosDatosNovedadDTO filtrosDatosNovedad;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private DatosNovedadEmpleadorPaginadoDTO result;
  
 	public ConsultarNovedadesEmpVista360 (FiltrosDatosNovedadDTO filtrosDatosNovedad){
 		super();
