 ...
 * /rest/novedades/{idSolicitudGlobal}/estadoSolicitud
 */
public class ActualizarEstadoSolicitudNovedad extends ServiceClient { 
  	private Long idSolicitudGlobal;
   	private EstadoSolicitudNovedadEnum estadoSolicitud;
   
  
 	public ActualizarEstadoSolicitudNovedad (Long idSolicitudGlobal,EstadoSolicitudNovedadEnum estadoSolicitud){
 		super();
