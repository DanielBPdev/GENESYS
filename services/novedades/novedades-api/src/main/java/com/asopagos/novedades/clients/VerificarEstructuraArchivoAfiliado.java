 ...
 * /rest/novedadesCargueMultiple/verificarEstructuraArchivoAfiliado
 */
public class VerificarEstructuraArchivoAfiliado extends ServiceClient { 
    	private InformacionArchivoDTO archivo;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private ResultadoValidacionArchivoDTO result;
  
 	public VerificarEstructuraArchivoAfiliado (InformacionArchivoDTO archivo){
 		super();
