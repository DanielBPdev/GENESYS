 ...
 * /rest/novedadesCargueMultiple/verificarEstructuraArchivoPensionado
 */
public class VerificarEstructuraArchivoPensionado extends ServiceClient { 
    	private InformacionArchivoDTO archivo;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private ResultadoValidacionArchivoDTO result;
  
 	public VerificarEstructuraArchivoPensionado (InformacionArchivoDTO archivo){
 		super();
