...
public class VerificarEstructuraArchvoNovedadMasivaTransferencia extends ServiceClient{
    private TipoArchivoRespuestaEnum tipoArchivoRespuesta;
 	...
 	public VerificarEstructuraArchvoNovedadMasivaTransferencia (TipoArchivoRespuestaEnum tipoArchivoRespuesta,InformacionArchivoDTO archivo){
 		super();
