 ...
 * /rest/novedadesCargueMultiple/verificarEstructuraArchivoActualizacionSucursal/{tipoArchivoRespuesta}
 */
public class VerificarEstructuraArchivoActualizacionSucursal extends ServiceClient { 
 	...
 	public VerificarEstructuraArchivoActualizacionSucursal (TipoArchivoRespuestaEnum tipoArchivoRespuesta,InformacionArchivoDTO archivo){
 		super();
