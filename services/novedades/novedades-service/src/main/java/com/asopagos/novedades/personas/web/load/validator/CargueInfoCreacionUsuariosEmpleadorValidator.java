...
/**
 * <b>Descripcion:</b> Clase que valida la estructura del archivo de creacion de usuarios empleador masivo<br/>
 * 
 *
 */

public class CargueInfoCreacionUsuariosEmpleadorValidator extends LineValidator {
     ...
     */
    public CargueInfoCreacionUsuariosEmpleadorValidator() {
        super();
    }
    ...
    public void validate(LineArgumentDTO arguments) throws FileProcessingException {
        ...
        try {
            ...
            FieldValidatorUtil.validateTipoIdentificacion(lstHallazgos, line, lineNumber, CamposGestionArchivosUsuariosConstants.TIPO_IDENTIFICACION_EMPLEADOR,
                    CamposGestionArchivosUsuariosConstants.TIPO_IDENTIFICACION_EMPLEADOR, ArchivoMultipleCampoConstants.LONGITUD_2_CARACTERES, true,
                    true, false);

            // Se valida el campo No 2 - Número de identificación del beneficiario
            FieldValidatorUtil.validate(lstHallazgos, line, lineNumber, CamposGestionArchivosUsuariosConstants.NUMERO_IDENTIFICACION_EMPLEADOR,
                    CamposGestionArchivosUsuariosConstants.NUMERO_IDENTIFICACION_EMPLEADOR, ArchivoMultipleCampoConstants.LONGITUD_17_CARACTERES,
