...
public class CargueNovedadMasivaCambioNumeroTipoIdentificacionBeneficiarioValidator extends LineValidator {
     ...
     */
    public CargueNovedadMasivaCambioNumeroTipoIdentificacionBeneficiarioValidator() {
        super();
    }
    ...
    public void validate(LineArgumentDTO arguments) throws FileProcessingException {
        ...
        try {
            ...
            // Se valida el campo No 1 - Tipo de identificación actual del beneficiario
            FieldValidatorUtil.validateTipoIdentificacion(lstHallazgos, line, lineNumber, ArchivoCampoNovedadCambioTipoNumeroMasivoConstante.TIPO_IDENTIFICACION_ACTUAL_BENEFICIARIO,
                    ArchivoCampoNovedadConstante.TIPO_IDENTIFICACION_BENEFI_MSG, ArchivoMultipleCampoConstants.LONGITUD_2_CARACTERES, true,
                    false, true);

            // Se valida el campo No 2 - Número de identificación actual del beneficiario
            FieldValidatorUtil.validate(lstHallazgos, line, lineNumber, ArchivoCampoNovedadCambioTipoNumeroMasivoConstante.NUMERO_IDENTIFICACION_ACTUAL_BENEFICIARIO,
                    ArchivoCampoNovedadConstante.NUMERO_IDENTIFICACION_BENEFI_MSG, ArchivoMultipleCampoConstants.LONGITUD_17_CARACTERES,
                    null, null, true, false);

            // Se valida el campo No 3 - Tipo de identificación nuevo del beneficiario 
            FieldValidatorUtil.validateTipoIdentificacion(lstHallazgos, line, lineNumber, ArchivoCampoNovedadCambioTipoNumeroMasivoConstante.TIPO_IDENTIFICACION_NUEVO_BENEFICIARIO,
                    ArchivoCampoNovedadConstante.TIPO_IDENTIFICACION_BENEFI_MSG, ArchivoMultipleCampoConstants.LONGITUD_2_CARACTERES, true,
                    false, true);

            // Se valida el campo No 3 - Número de identificación nuevo del beneficiario
            FieldValidatorUtil.validate(lstHallazgos, line, lineNumber, ArchivoCampoNovedadCambioTipoNumeroMasivoConstante.NUMERO_IDENTIFICACION_NUEVO_BENEFICIARIO,
                    ArchivoCampoNovedadConstante.NUMERO_IDENTIFICACION_BENEFI_MSG, ArchivoMultipleCampoConstants.LONGITUD_17_CARACTERES,
                    null, null, true, false);
        } finally {
