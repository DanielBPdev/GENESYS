 ...
 * @author 
 */
public class CargueInfoCreacionUsuariosPersona implements IPersistLine {
        ...
        for (LineArgumentDTO lineArgumentDTO : lines) {
            List<ResultadoHallazgosValidacionArchivoDTO> hallazgos = ((List<ResultadoHallazgosValidacionArchivoDTO>) 
                ...
                try {
                    ...
                    if (esCampoValido(line, CamposGestionArchivosUsuariosConstants.TIPO_IDENTIFICACION_PERSONA)) {
                        String tipoIdentificacion = getValorCampo(line, CamposGestionArchivosUsuariosConstants.TIPO_IDENTIFICACION_PERSONA).toUpperCase();
                    ...
                    if (esCampoValido(line, CamposGestionArchivosUsuariosConstants.NUMERO_IDENTIFICACION_PERSONA)) {
                        String numeroIdentificacion = getValorCampo(line, CamposGestionArchivosUsuariosConstants.NUMERO_IDENTIFICACION_PERSONA);
                        ...
                        if (!usuarioExiste) {
                            ...
                            hallazgo.setNombreCampo(CamposGestionArchivosUsuariosConstants.NUMERO_IDENTIFICACION_PERSONA);
                            hallazgo.setError("El Trabajador No Existe en la Base de Datos");
