...
/**
 * <b>Descripcion:</b> Clase que valida la estructura del archivo de creacion de usuarios ccf masivo<br/>
 * 
 *
 */

public class CargueInfoCreacionUsuariosCcfValidator extends LineValidator {
     ...
     */
    public CargueInfoCreacionUsuariosCcfValidator() {
        super();
    }
    ...
    public void validate(LineArgumentDTO arguments) throws FileProcessingException {
        ...
        try {
            ...
            FieldValidatorUtil.validateTipoIdentificacion(lstHallazgos, line, lineNumber, CamposGestionArchivosUsuariosConstants.TIPO_IDENTIFICACION_CCF,
                    CamposGestionArchivosUsuariosConstants.TIPO_IDENTIFICACION_CCF, ArchivoMultipleCampoConstants.LONGITUD_2_CARACTERES, true,
                    false, true);

            // Se valida el campo No 2 - Número de identificación del beneficiario
            FieldValidatorUtil.validate(lstHallazgos, line, lineNumber, CamposGestionArchivosUsuariosConstants.NUMERO_IDENTIFICACION_CCF,
                    CamposGestionArchivosUsuariosConstants.NUMERO_IDENTIFICACION_CCF, ArchivoMultipleCampoConstants.LONGITUD_17_CARACTERES,
