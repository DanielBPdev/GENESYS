...
public class BuscarTarjeta extends ServiceClient {
    ...
    private TipoIdentificacionEnum tipoDcto;
 	...
 	public BuscarTarjeta (TipoIdentificacionEnum tipoDcto,String documento){
 		super();
	...
	protected Response invoke(WebTarget webTarget, String path) {
		...
		BuscarTarjetaInDTO input = new BuscarTarjetaInDTO(tipoDcto, documento);
