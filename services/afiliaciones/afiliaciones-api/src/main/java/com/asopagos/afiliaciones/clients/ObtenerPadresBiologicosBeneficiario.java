 ...
 * /rest/externalAPI/afiliacion/obtenerPadresBiologicosBeneficiario
 */
public class ObtenerPadresBiologicosBeneficiario extends ServiceClient {
 	...
 	public ObtenerPadresBiologicosBeneficiario (TipoIdentificacionEnum tipoID,String identificacion){
 		super();
		this.tipoID=tipoID;
