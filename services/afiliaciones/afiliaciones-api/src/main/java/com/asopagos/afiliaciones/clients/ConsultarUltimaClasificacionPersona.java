 ...
 */
public class ConsultarUltimaClasificacionPersona extends ServiceClient {
 	...
 	public ConsultarUltimaClasificacionPersona (String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
