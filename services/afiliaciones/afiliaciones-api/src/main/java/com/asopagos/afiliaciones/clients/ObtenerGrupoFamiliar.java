 ...
 * /rest/externalAPI/afiliacion/obtenerGrupoFamiliar
 */
public class ObtenerGrupoFamiliar extends ServiceClient {
 	...
 	private List<GrupoFamiliarOutDTO> result;
  
 	public ObtenerGrupoFamiliar (String identificacionAfiliado,TipoIdentificacionEnum tipoID,String identificacionBeneficiario){
 		super();
	...
	protected void getResultData(Response response) {
		this.result = (List<GrupoFamiliarOutDTO>) response.readEntity(new GenericType<List<GrupoFamiliarOutDTO>>(){});
	}
	
	/**
	 * Retorna el resultado del llamado al servicio
	 */
	 public List<GrupoFamiliarOutDTO> getResult() {
		return result;
	}
