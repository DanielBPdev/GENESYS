 ...
 * /rest/afiliaciones/consultarHistoricoAfiliacionDependiente
 */
public class ConsultarHistoricoAfiliacionDependiente extends ServiceClient {
 	...
 	private List<HistoricoAfiliacion360DTO> result;
  
 	public ConsultarHistoricoAfiliacionDependiente (Long idEmpleador,TipoIdentificacionEnum tipoIdAfiliado,String numeroIdAfiliado){
 		super();
	...
	protected void getResultData(Response response) {
		this.result = (List<HistoricoAfiliacion360DTO>) response.readEntity(new GenericType<List<HistoricoAfiliacion360DTO>>(){});
	}
	
	/**
	 * Retorna el resultado del llamado al servicio
	 */
	 public List<HistoricoAfiliacion360DTO> getResult() {
		return result;
	}
