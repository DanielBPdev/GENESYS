...
public class ArchivoCrucesFileValidator extends FileNameValidator {

    /**
     * Referencia al logger
     */
    private ILogger logger = LogManager.getLogger(ArchivoCrucesFileValidator.class);
    ...
    public void validate(FileArgumentDTO arg0) throws FileProcessingException {
        logger.info("Inicia la validación del nombre del archivo de descuentos");
        ...
        logger.info("Finaliza  la validación del nombre del archivo de descuentos");
    }
