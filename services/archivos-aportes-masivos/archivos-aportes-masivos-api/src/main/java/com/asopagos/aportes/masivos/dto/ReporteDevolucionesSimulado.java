...
public class ReporteDevolucionesSimulado {
    

    private Long numeroRegistro;
    private Date fechaHoraDeCarga;
    ...
    public ReporteDevolucionesSimulado(
        Long numeroRegistro,
        Date fechaHoraDeCarga,
        ...
        this.fechaHoraDeCarga = fechaHoraDeCarga;
        ...
        if (tipoCotizante != null && !tipoCotizante.equals("")) this.tipoCotizante = TipoAfiliadoEnum.valueOf(tipoCotizante);
    ...
    private void limpiarNulos() {
        ...
        if (fechaHoraDeCarga == null) fechaHoraDeCarga = new Date();
        ...
        if (tipoCotizante == null) tipoCotizante = tipoCotizante = tipoCotizante = TipoAfiliadoEnum.TRABAJADOR_DEPENDIENTE;
    ...
    public String[] toFormatString() {
        ...
        String fechaString = formato.format(fechaHoraDeCarga);
        return new String[] {
