 ...
 * /rest/empleadores/solicitudAfiliacion/{idSolicitudGlobal}
 */
public class ActualizarSolicitudAfiliacion extends ServiceClient { 
  	private Long idSolicitudGlobal;
    	private SolicitudDTO solicitudDTO;
  
  
 	public ActualizarSolicitudAfiliacion (Long idSolicitudGlobal,SolicitudDTO solicitudDTO){
 		super();
