 ...
 * /rest/empleadores/consultarEmpleadorTipoNumero/{tipoIdentificacion}/{numeroIdentificacion}
 */
public class ConsultarEmpleadorTipoNumero extends ServiceClient {
 	...
 	public ConsultarEmpleadorTipoNumero (String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
