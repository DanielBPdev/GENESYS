 ...
 * /rest/empleadores/consultarEmailEmpleadores
 */
public class ConsultarEmailEmpleadores extends ServiceClient { 
    	private List<Long> idEmpleadores;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private List<String> result;
  
 	public ConsultarEmailEmpleadores (List<Long> idEmpleadores){
 		super();
