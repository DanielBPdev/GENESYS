 ...
 * /rest/afiliacionesPersonasWeb/verificarResultadosAfiliacionIndependienteWeb
 */
public class VerificarResultadosAfiliacionIndependienteWeb extends ServiceClient { 
    	private VerificarResultadoSolicitudAfiliacionPersonaDTO inDTO;
  
  
 	public VerificarResultadosAfiliacionIndependienteWeb (VerificarResultadoSolicitudAfiliacionPersonaDTO inDTO){
 		super();
		this.inDTO=inDTO;
 	}
