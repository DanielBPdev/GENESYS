 ...
 * /rest/afiliacionesPersonasWeb/validarEstructuraContenidoArchivoMultiple/{idEmpleador}
 */
public class ValidarEstructuraContenidoArchivoMultiple extends ServiceClient { 
 	...
 	public ValidarEstructuraContenidoArchivoMultiple (Long idEmpleador,CargueMultipleDTO cargue){
 		super();
