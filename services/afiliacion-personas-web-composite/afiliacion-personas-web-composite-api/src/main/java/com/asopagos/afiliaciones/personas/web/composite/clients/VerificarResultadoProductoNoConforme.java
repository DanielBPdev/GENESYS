 ...
 * /rest/afiliacionesPersonasWeb/verificarResultadoProductoNoConforme/{idEmpleador}
 */
public class VerificarResultadoProductoNoConforme extends ServiceClient { 
  	private Long idEmpleador;
    	private VerificarSolicitudAfiliacionPersonaDTO inDTO;
  
  
 	public VerificarResultadoProductoNoConforme (Long idEmpleador,VerificarSolicitudAfiliacionPersonaDTO inDTO){
 		super();
