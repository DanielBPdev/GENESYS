 ...
 * /rest/legalizacionFovisComposite/escalarSolicitudLegalizacionYDesembolso
 */
public class EscalarSolicitudLegalizacionYDesembolso extends ServiceClient { 
 	...
 	public EscalarSolicitudLegalizacionYDesembolso (SolicitudLegalizacionDesembolsoDTO solicitudLegalizacionDesembolsoDTO){
 		super();
