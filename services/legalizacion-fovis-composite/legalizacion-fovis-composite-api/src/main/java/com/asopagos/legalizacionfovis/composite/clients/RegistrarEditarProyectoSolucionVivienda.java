 ...
 * /rest/legalizacionFovisComposite/registrarEditarProyectoSolucionVivienda
 */
public class RegistrarEditarProyectoSolucionVivienda extends ServiceClient { 
    	private ProyectoSolucionViviendaModeloDTO proyectoDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private ProyectoSolucionViviendaModeloDTO result;
  
 	public RegistrarEditarProyectoSolucionVivienda (ProyectoSolucionViviendaModeloDTO proyectoDTO){
 		super();
