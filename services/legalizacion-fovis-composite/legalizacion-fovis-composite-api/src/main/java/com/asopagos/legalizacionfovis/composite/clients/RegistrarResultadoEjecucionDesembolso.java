 ...
 * /rest/legalizacionFovisComposite/registrarResultadoEjecucionDesembolso
 */
public class RegistrarResultadoEjecucionDesembolso extends ServiceClient { 
 	...
 	public RegistrarResultadoEjecucionDesembolso (SolicitudLegalizacionDesembolsoDTO solicitudLegalizacionDesembolso){
 		super();
