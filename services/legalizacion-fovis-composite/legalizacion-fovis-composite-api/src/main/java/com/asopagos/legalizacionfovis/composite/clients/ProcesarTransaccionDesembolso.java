 ...
 * /rest/legalizacionFovisComposite/procesarTransaccionDesembolso
 */
public class ProcesarTransaccionDesembolso extends ServiceClient { 
 	...
 	public ProcesarTransaccionDesembolso (SolicitudLegalizacionDesembolsoDTO solicitudLegalizacionDesembolso){
 		super();
