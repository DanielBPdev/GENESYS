 ...
 * /rest/legalizacionFovisComposite/autorizarDesembolso
 */
public class AutorizarDesembolso extends ServiceClient { 
 	...
 	public AutorizarDesembolso (SolicitudLegalizacionDesembolsoDTO solicitudLegalizacionDesembolso){
 		super();
