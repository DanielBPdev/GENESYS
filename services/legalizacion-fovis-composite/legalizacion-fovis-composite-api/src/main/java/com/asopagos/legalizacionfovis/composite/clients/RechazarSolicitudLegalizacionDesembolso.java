 ...
 * /rest/legalizacionFovisComposite/rechazarSolicitudLegalizacionDesembolso
 */
public class RechazarSolicitudLegalizacionDesembolso extends ServiceClient { 
    	private SolicitudLegalizacionDesembolsoDTO solicitudLegalizacionDesembolso;
  
  
 	public RechazarSolicitudLegalizacionDesembolso (SolicitudLegalizacionDesembolsoDTO solicitudLegalizacionDesembolso){
 		super();
