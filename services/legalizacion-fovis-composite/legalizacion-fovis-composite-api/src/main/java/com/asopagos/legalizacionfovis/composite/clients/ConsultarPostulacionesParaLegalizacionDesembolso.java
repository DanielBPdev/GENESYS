 ...
 * /rest/legalizacionFovisComposite/consultarPostulacionesParaLegalizacionDesembolso
 */
public class ConsultarPostulacionesParaLegalizacionDesembolso extends ServiceClient {
 	...
 	public ConsultarPostulacionesParaLegalizacionDesembolso (String numeroRadicadoSolicitud,String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
