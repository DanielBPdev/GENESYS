 ...
 * /rest/legalizacionFovisComposite/verificarSolicitudLegalizacionDesembolso
 */
public class VerificarSolicitudLegalizacionDesembolso extends ServiceClient { 
    	private VerificacionGestionPNCLegalizacionDesembolsoDTO datosVerificacion;
  
  
 	public VerificarSolicitudLegalizacionDesembolso (VerificacionGestionPNCLegalizacionDesembolsoDTO datosVerificacion){
 		super();
