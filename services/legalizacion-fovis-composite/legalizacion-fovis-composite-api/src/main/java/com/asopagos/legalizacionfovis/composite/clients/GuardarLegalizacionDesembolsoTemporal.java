 ...
 * /rest/legalizacionFovisComposite/guardarLegalizacionDesembolsoTemporal
 */
public class GuardarLegalizacionDesembolsoTemporal extends ServiceClient { 
 	...
 	public GuardarLegalizacionDesembolsoTemporal (SolicitudLegalizacionDesembolsoDTO solicitudLegalizacionDesembolso){
 		super();
