 ...
 * /rest/parametros/replicarActualizacionListaChequeoClasificacionPorCaja
 */
public class ReplicarActualizacionListaChequeoClasificacionPorCaja extends ServiceClient { 
    	private List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion;
  
  
 	public ReplicarActualizacionListaChequeoClasificacionPorCaja (List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion){
 		super();
