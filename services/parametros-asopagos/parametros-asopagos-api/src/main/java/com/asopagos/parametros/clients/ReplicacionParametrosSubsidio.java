 ...
 * /rest/parametros/parametrosSubsidio
 */
public class ReplicacionParametrosSubsidio extends ServiceClient { 
    	private ParametrizacionCondicionesSubsidioCajaDTO parametrizacionCondicionesSubsidioCaja;
  
  
 	public ReplicacionParametrosSubsidio (ParametrizacionCondicionesSubsidioCajaDTO parametrizacionCondicionesSubsidioCaja){
 		super();
