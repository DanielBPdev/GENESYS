 ...
 * /rest/parametros/replicarCreacionListaChequeoClasificacionPorCaja
 */
public class ReplicarCreacionListaChequeoClasificacionPorCaja extends ServiceClient { 
    	private List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion;
  
  
 	public ReplicarCreacionListaChequeoClasificacionPorCaja (List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion){
 		super();
