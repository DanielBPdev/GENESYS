 ...
 * /rest/parametros/replicarActualizacionListaChequeoClasificacion
 */
public class ReplicarActualizacionListaChequeoClasificacion extends ServiceClient { 
    	private List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion;
  
  
 	public ReplicarActualizacionListaChequeoClasificacion (List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion){
 		super();
