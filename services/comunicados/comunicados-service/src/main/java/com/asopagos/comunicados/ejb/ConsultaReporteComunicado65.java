 ...
 * 65_Notificacion de dispersion de pagos al admin <b>Módulo:</b> Asopagos
 * - HU-311-438 <br/>
 *
 * @author <a href="mailto:jocampo@heinsohn.com.co">Juan Diego Ocampo Q.</a>
 */

public class ConsultaReporteComunicado65 extends ConsultaReporteComunicadosAbs {
	...
	public String getReporte(EntityManager em) {
		...
		Query query = em
				.createNamedQuery(NamedQueriesConstants.CONSULTAR_BENEFICIARIOS_NOTIFICACION_DISPERSION_PAGOS_ADMIN);
