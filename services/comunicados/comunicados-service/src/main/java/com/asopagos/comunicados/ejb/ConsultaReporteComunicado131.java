...
public class ConsultaReporteComunicado131 extends ConsultaReporteComunicadosAbs {
    ...
    public String getReporte(EntityManager em) {
        Query query =  em.createNamedQuery(NamedQueriesConstants.CONSULTA_COMUNICADO_NTF_INT_NO_CBR);
        query.setParameter(ConstantesComunicado.KEY_MAP_ID_SOLICITUD, params.get(ConstantesComunicado.KEY_MAP_ID_SOLICITUD));

        List<Object[]> result = query.getResultList();
        String htmlContent = "<style>table{border-collapse:collapse;width:100%;}table,th,td{border:1px solid black;}</style><table><tr><th>Número</th><th>Tipo de identificación</th><th>Número de identificación</th><th>Razón social / Nombre</th><th>Observaciones</th><th>Periodo deuda</th><th>Valor deuda presunta</th><th>Consecutivo liquidación</th></tr>";
