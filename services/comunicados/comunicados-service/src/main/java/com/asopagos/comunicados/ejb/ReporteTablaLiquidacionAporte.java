...
public class ReporteTablaLiquidacionAporte extends ConsultaReporteComunicadosAbs {

	/**
	 * Referencia al logger
	 */
	private final ILogger logger = LogManager.getLogger(ReporteTablaLiquidacionAporte.class);
