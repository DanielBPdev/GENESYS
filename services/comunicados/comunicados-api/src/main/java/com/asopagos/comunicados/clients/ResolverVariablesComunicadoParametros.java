 ...
 * /rest/plantillas/{EtiquetaPlantillaComunicadoEnum}/resolverVariablesParametros
 */
public class ResolverVariablesComunicadoParametros extends ServiceClient { 
  	private EtiquetaPlantillaComunicadoEnum EtiquetaPlantillaComunicadoEnum;
   	private Long idSolicitud;
   	private ParametrosComunicadoDTO parametrosComunicadoDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Map<String,Object> result;
  
 	public ResolverVariablesComunicadoParametros (EtiquetaPlantillaComunicadoEnum EtiquetaPlantillaComunicadoEnum,Long idSolicitud,ParametrosComunicadoDTO parametrosComunicadoDTO){
 		super();
		this.EtiquetaPlantillaComunicadoEnum=EtiquetaPlantillaComunicadoEnum;
		this.idSolicitud=idSolicitud;
		this.parametrosComunicadoDTO=parametrosComunicadoDTO;
 	}
	...
	protected Response invoke(WebTarget webTarget, String path) {
		Response response = webTarget.path(path)
			...
			.post(parametrosComunicadoDTO == null ? null : Entity.json(parametrosComunicadoDTO));
		return response;
	}
	...
	public Map<String,Object> getResult() {
 	...
 	public Long getIdSolicitud (){
  	...
  	public void setParametrosComunicadoDTO (ParametrosComunicadoDTO parametrosComunicadoDTO){
 		this.parametrosComunicadoDTO=parametrosComunicadoDTO;
 	}
 	
 	public ParametrosComunicadoDTO getParametrosComunicadoDTO (){
