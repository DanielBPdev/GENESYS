 ...
 * /rest/comunicados/guardarObtenerComunicadoECM
 */
public class GuardarObtenerComunicadoECM extends ServiceClient { 
 	...
 	public GuardarObtenerComunicadoECM (TipoTransaccionEnum tipoTransaccion,EtiquetaPlantillaComunicadoEnum plantilla,ParametrosComunicadoDTO parametroComunicadoDTO){
 		super();
