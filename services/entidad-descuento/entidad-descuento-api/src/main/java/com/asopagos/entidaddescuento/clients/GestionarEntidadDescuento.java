 ...
 * /rest/entidadDescuento/gestionarEntidadDescuento
 */
public class GestionarEntidadDescuento extends ServiceClient { 
    	private EntidadDescuentoModeloDTO entidadDescuentoModeloDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private String result;
  
 	public GestionarEntidadDescuento (EntidadDescuentoModeloDTO entidadDescuentoModeloDTO){
 		super();
