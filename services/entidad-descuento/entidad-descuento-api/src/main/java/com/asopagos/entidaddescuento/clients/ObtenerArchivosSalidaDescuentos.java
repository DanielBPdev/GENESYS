 ...
 * /rest/entidadDescuento/archivoDescuentos/obtenerArchivosSalidaDescuentos
 */
public class ObtenerArchivosSalidaDescuentos extends ServiceClient {
 	...
 	public ObtenerArchivosSalidaDescuentos (String numeroRadicacion,Long idEntidadDescuento){
 		super();
