 ...
 * /rest/afiliaciones/solicitudAfiliacionPersonaMasivas/{idSolicitudGlobal}
 */
public class ActualizarSolicitudAfiliacionPersonaMasivas extends ServiceClient {
  	private Long idSolicitudGlobal;
    	private SolicitudDTO solicitudDTO;
  
  
 	public ActualizarSolicitudAfiliacionPersonaMasivas (Long idSolicitudGlobal,SolicitudDTO solicitudDTO){
 		super();
