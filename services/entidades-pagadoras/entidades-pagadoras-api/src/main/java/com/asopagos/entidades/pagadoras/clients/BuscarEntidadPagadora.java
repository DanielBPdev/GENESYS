 ...
 * /rest/entidadesPagadoras/buscar
 */
public class BuscarEntidadPagadora extends ServiceClient {
 	...
 	public BuscarEntidadPagadora (String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion,String razonSocial){
 		super();
