...
public class GestionActivarInactivarEmpleador extends ServiceClient {

	private String nombreUsuario;
	private Boolean isInmediate;
	private Boolean activar; 

	public GestionActivarInactivarEmpleador(String nombreUsuario, Boolean isInmediate, Boolean activar) {
		super();
