 ...
 * /rest/usuarios/gestionRestablecerContrasenaEmpleador
 */
public class GestionRestablecerContrasenaEmpleador extends ServiceClient { 

    private CambiarContrasenaDTO dto;
    private ResultadoDTO result;

    public GestionRestablecerContrasenaEmpleador(CambiarContrasenaDTO dto) {
        super();
        this.dto = dto;
    }
