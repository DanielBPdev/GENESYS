...
public class GestionActivarInactivarPersona extends ServiceClient {

	private String nombreUsuario;
	private Boolean isInmediate;
	private Boolean activar; 

	public GestionActivarInactivarPersona(String nombreUsuario, Boolean isInmediate, Boolean activar) {
		super();
