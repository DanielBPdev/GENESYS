 ...
 */
public class GestionConsultarCcf extends ServiceClient {
 	...
 	public GestionConsultarCcf (String nombreUsuario,String primerApellido,String primerNombre,Boolean roles){
 		super();
