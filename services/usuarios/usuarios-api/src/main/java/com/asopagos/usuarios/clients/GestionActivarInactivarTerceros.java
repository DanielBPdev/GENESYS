...
public class GestionActivarInactivarTerceros extends ServiceClient {

	private String nombreUsuario;
	private Boolean isInmediate;
	private Boolean activar; 

	public GestionActivarInactivarTerceros(String nombreUsuario, Boolean isInmediate, Boolean activar) {
		super();
