 ...
 * /rest/usuarios/gestionRestablecerContrasenaPersona
 */
public class GestionRestablecerContrasenaPersona extends ServiceClient { 

    private CambiarContrasenaDTO dto;
    private ResultadoDTO result;

    public GestionRestablecerContrasenaPersona(CambiarContrasenaDTO dto) {
        super();
        this.dto = dto;
    }
