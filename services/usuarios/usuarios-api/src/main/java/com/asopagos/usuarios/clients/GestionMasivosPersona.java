 ...
 * /rest/usuarios/persona/gestionMasivosPersona
 */
public class GestionMasivosPersona extends ServiceClient {
    ...
    public GestionMasivosPersona(List<UsuarioCCF> usuarios) {
        super();
