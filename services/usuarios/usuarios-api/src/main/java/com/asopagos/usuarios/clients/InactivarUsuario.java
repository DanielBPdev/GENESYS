 ...
 * /rest/usuarios/inactivar/{nombreUsuario}
 */
public class InactivarUsuario extends ServiceClient { 
  	private String nombreUsuario;
   	private Boolean isInmediate;
   
  
 	public InactivarUsuario (String nombreUsuario,Boolean isInmediate){
 		super();
