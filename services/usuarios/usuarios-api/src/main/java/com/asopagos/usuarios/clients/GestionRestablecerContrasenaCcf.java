 ...
 * /rest/ccf/gestionRestablecerContrasenaCcf
 */
public class GestionRestablecerContrasenaCcf extends ServiceClient { 

    private CambiarContrasenaDTO dto;
    private ResultadoDTO result;

    public GestionRestablecerContrasenaCcf(CambiarContrasenaDTO dto) {
        super();
        this.dto = dto;
    }
