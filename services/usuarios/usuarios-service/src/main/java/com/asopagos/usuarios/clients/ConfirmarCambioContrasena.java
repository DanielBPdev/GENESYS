 ...
 * /rest/usuarios/confirmarCambioContrasena
 */
public class ConfirmarCambioContrasena extends ServiceClient { 

    private CambiarContrasenaDTO dto;
    private ResultadoDTO result;

    public ConfirmarCambioContrasena(CambiarContrasenaDTO dto) {
        super();
        this.dto = dto;
    }
