 ...
 * /rest/sat/consultarEstadoPAAportes
 */
public class ConsultarEstadoPAAportes extends ServiceClient {
 	...
 	public ConsultarEstadoPAAportes (String estado,Long fechaFin,String numeroDocumentoEmpleador,Long fechaInicio){
 		super();
		this.estado=estado;
