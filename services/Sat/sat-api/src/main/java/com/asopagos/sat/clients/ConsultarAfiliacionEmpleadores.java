 ...
 * /rest/sat/consultarAfiliacionEmpleadores
 */
public class ConsultarAfiliacionEmpleadores extends ServiceClient {
 	...
 	public ConsultarAfiliacionEmpleadores (String estado,Long fechaFin,String numeroDocumentoEmpleador,Long fechaInicio){
 		super();
		this.estado=estado;
