 ...
 * /rest/sat/consultarDesafiliacion
 */
public class ConsultarDesafiliacion extends ServiceClient {
 	...
 	public ConsultarDesafiliacion (String estado,Long fechaFin,String numeroDocumentoEmpleador,Long fechaInicio){
 		super();
		this.estado=estado;
