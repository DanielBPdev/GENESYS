 ...
 */
@Local
public interface IEstadoPagoAportesEmpleadores {
    
    public List<EstadoPAAportesDTO> consultarEstadoPagoAportes(
            BusquedaSAT busquedaSAT);
    
    public List<EstadoPAAportesDTO> consultarEstadoPagoAportesAuditoria(
            Long id);
