 ...
 */
@Local
public interface IInicioRelacionLaboral {
    
    public List<InicioRelacionLaboralDTO> consultarInicioRelacionLaboral(
            BusquedaSAT busquedaSAT);
    
    public List<InicioRelacionLaboralDTO> consultarInicioRelacionLaboralAuditoria(
            Long id);
