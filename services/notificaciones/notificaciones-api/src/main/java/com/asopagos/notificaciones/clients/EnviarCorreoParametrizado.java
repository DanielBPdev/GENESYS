 ...
 * /rest/enviarCorreo/enviarCorreoParametrizado
 */
public class EnviarCorreoParametrizado extends ServiceClient { 
    	private NotificacionParametrizadaDTO notificacion;
  
  
 	public EnviarCorreoParametrizado (NotificacionParametrizadaDTO notificacion){
 		super();
