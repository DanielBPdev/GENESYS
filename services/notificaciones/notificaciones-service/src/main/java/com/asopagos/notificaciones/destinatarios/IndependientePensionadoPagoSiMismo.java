...
public class IndependientePensionadoPagoSiMismo extends DestinatarioNotificacion{

    /**
     * Referencia al logger
     */
    private final ILogger logger = LogManager.getLogger(IndependientePensionadoPagoSiMismo.class);
