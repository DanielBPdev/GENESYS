...
public class EnvioCorrespondencia extends DestinatarioNotificacion {

    /**
     * Referencia al logger
     */
    private final ILogger logger = LogManager.getLogger(EnvioCorrespondencia.class);
    ...
    public List<CorreoPrioridadPersonaDTO> obtenerCorreoDestinatario(TipoTransaccionEnum tipoTx, Map<String, Object> parametros, EntityManager em) {
        ...
        if (!parametros.containsKey(ID_SOLICITUD)) {
            ...
            if (TipoSolicitudEnum.EMPLEADOR.equals(solicitante)) {
                try {
                    autorizaEnvio = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_AUTORIZACION_CORRESPONDENCIA_EMPLEADOR,Boolean.class)
                            .setParameter("idSolicitud", parametros.get(ID_SOLICITUD))
                            .getSingleResult();
                            
                    correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_AFILIACION_UBICACION_EMPRESA_ID_ENVIO_CORRESPONDENCIA,
                ...
                try {
                    autorizaEnvio = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_AUTORIZACION_NOVEDAD_EMPLEADOR, Boolean.class)
                            .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getSingleResult();
                    correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_NOVEDAD_UBICACION_EMPRESA_ID_ENVIO_CORRESPONDENCIA,
                            Object[].class).setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getResultList();
                        idEmpleador = (correo.get(0)[2]!= null ? Long.valueOf(correo.get(0)[2].toString()) : null);
                } catch (Exception e){
                    logger.debug("Finaliza obtenerCorreoDestinatario(TipoTransaccionEnum tipoTx, Map<String, Long> parametros, EntityManager em) :Error técnico inesperado:"+e);
                ...
                try {
                    autorizaEnvio = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_AFILIACION_PERSONA_AUTORIZACION_EMPRESA, Boolean.class)
                            .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getSingleResult();
                    correo = em
                            .createNamedQuery(NamedQueriesConstants.CONSULTAR_AFILIACION_PERSONA_UBICACION_EMPRESA_ID_ENVIO_CORRESPONDENCIA,
                                    Object[].class)
                ...
                try {
                    ...
                    if(esEmpresa.equals(true)){
                        autorizaEnvio = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_APORTANTE_AUTORIZACION_CORRESPONDENCIA_EMPLEADOR,Boolean.class)
                                .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getSingleResult();
                        
                        correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_APORTANTE_ENVIO_CORRESPONDENCIA_EMPLEADOR, Object[].class)
                                .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getResultList();
                    } else {
                        autorizaEnvio = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_APORTANTE_AUTORIZACION_CORRESPONDENCIA_INDP_PENS,Boolean.class)
                                .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getSingleResult();
                        
                        correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_APORTANTE_ENVIO_CORRESPONDENCIA_INDP_PENS, Object[].class)
                                .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getResultList();
                    }
                } catch (Exception e){
                    logger.debug("Finaliza obtenerCorreoDestinatario(TipoTransaccionEnum tipoTx, Map<String, Long> parametros, EntityManager em) :Error técnico inesperado:"+e);
                ...
                try {
                    ...
                    correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_GESTION_PREVENTIVA_ENVIO_CORRESPONDENCIA, Object[].class)
                            .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getResultList();
                    idEmpresa = correo.get(0)[2] != null ? (Long)correo.get(0)[2] : null;
                } catch (Exception e){
                    logger.debug("Finaliza obtenerCorreoDestinatario(TipoTransaccionEnum tipoTx, Map<String, Long> parametros, EntityManager em) :Error técnico inesperado:"+e);
                    return null;
                }
                ...
                try {
                    ...
                    correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_AUTORIZACION_CARTERA_CORRESPONDENCIA, Object[].class)
                ...
                try {
                    ...
                    if (TipoTipoSolicitanteEnum.EMPLEADOR.equals(parametrosComunicadoDTO.getTipoSolicitante())){
                        correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_PILA_UBICACION_EMPLEADOR, Object[].class)
                                ...
                                .setParameter("tipoUbicacion", TipoUbicacionEnum.ENVIO_CORRESPONDENCIA).getResultList();
                    ...
                    logger.warn("Empresa " + idEmpresa + " autoriza : " + autorizaEnvio);
                } catch (Exception e) {
                    logger.warn("Finaliza obtenerCorreoDestinatario(TipoTransaccionEnum tipoTx, Map<String, Long> parametros, EntityManager em) :Error técnico inesperado:",e);
                    return null;
                }
            }else {
