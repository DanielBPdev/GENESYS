...
public class ResponsableAportes extends DestinatarioNotificacion{

    /**
     * Referencia al logger
     */
    private final ILogger logger = LogManager.getLogger(ResponsableAportes.class);
    /**
    ...
    public List<CorreoPrioridadPersonaDTO> obtenerCorreoDestinatario(TipoTransaccionEnum tipoTx, Map<String, Object> parametros, EntityManager em) {
        if (!parametros.containsKey(ID_SOLICITUD)) {
            ...
            if(TipoSolicitudEnum.NOVEDAD_PERSONA.equals(solicitante)){//no aplica
                try{
                    correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_RESPONSABLE_APORTES_PERSONA, Object[].class)
                ...
                try {
                    ...
                    if(autorizacion.equals(true)){
                        correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_RESPONSABLE_APORTES_EMPLEADOR, Object[].class)
                                .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getResultList();
                ...
                try {
                    ...
                    if(esEmpresa.equals(true)){
                        correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_APORTANTE_RESPONSABLE_APORTES_EMPLEADOR, Object[].class)
                                .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getResultList();
                        autorizaEnvio = (correo.get(0)[3] != null ? (Boolean)correo.get(0)[3] : Boolean.FALSE);
                    } else {
                        correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_APORTANTE_RESPONSABLE_APORTES_INDP_PENS, Object[].class)//No aplica
                                .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getResultList();
                    }
                } catch (Exception e){
                    logger.debug("Finaliza obtenerCorreoDestinatario(TipoTransaccionEnum tipoTx, Map<String, Long> parametros, EntityManager em) :Error técnico inesperado:"+e);
                ...
                try {     
                    ...
                    if(esEmpresa.equals(true)){
                        correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_APORTANTE_CORRECCION_RESPONSABLE_APORTES_EMPLEADOR, Object[].class)
                                .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getResultList();
                        autorizaEnvio = (correo.get(0)[3] != null ? (Boolean)correo.get(0)[3] : Boolean.FALSE);
                    } else {
                        correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_APORTANTE_CORRECCION_RESPONSABLE_APORTES_INDP_PENS, Object[].class)//No aplica
                                .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getResultList();
                    }
                } catch (Exception e){
                    logger.debug("Finaliza obtenerCorreoDestinatario(TipoTransaccionEnum tipoTx, Map<String, Long> parametros, EntityManager em) :Error técnico inesperado:"+e);
                ...
                try {
                    ...
                    if(esEmpresa.equals(true)){
                        correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_APORTANTE_DEVOLUCION_RESPONSABLE_APORTES_EMPLEADOR, Object[].class)
                                .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getResultList();
                        autorizaEnvio = (correo.get(0)[3] != null ? (Boolean)correo.get(0)[3] : Boolean.FALSE);
                    } else {
                        correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_APORTANTE_DEVOLUCION_RESPONSABLE_APORTES_INDP_PENS, Object[].class)//No aplica
                                .setParameter("idSolicitud", parametros.get(ID_SOLICITUD)).getResultList();
                    }
                } catch (Exception e){
                    logger.debug("Finaliza obtenerCorreoDestinatario(TipoTransaccionEnum tipoTx, Map<String, Long> parametros, EntityManager em) :Error técnico inesperado:"+e);
                ...
                try {
                    correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_GESTION_PREVENTIVA_RESPONSABLE_APORTES_EMPLEADOR,
                ...
                try {
                    ...
                    correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_AUTORIZACION_CARTERA_APORTES, Object[].class)
                ...
                try {
                    ...
                    if (TipoTipoSolicitanteEnum.EMPLEADOR.equals(parametrosComunicadoDTO.getTipoSolicitante())){
                        correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_PILA_RESPONSABLE_EMPLEADOR, Object[].class)
                                ...
                                .setParameter("tipoResponsabe", TipoRolContactoEnum.ROL_RESPONSABLE_APORTES).getResultList();
                ...
                try {
                    ...
                    correo = em.createNamedQuery(NamedQueriesConstants.CONSULTAR_GESTION_COBRO_MANUAL_ROL_EMPLEADOR, Object[].class)
                            .setParameter("tipoIdentificacion", parametrosComunicadoDTO.getTipoIdentificacion())
                            .setParameter("numeroIdentificacion", parametrosComunicadoDTO.getNumeroIdentificacion())
                            .setParameter("rol", TipoRolContactoEnum.ROL_RESPONSABLE_APORTES).getResultList();
                    if (correo == null || correo.isEmpty()){
                        return null;
                    }
                    idEmpleador = (correo.get(0)[2] != null ? Long.valueOf(correo.get(0)[2].toString()) : null);
