...
/**
 * Clase que representa al coordinador del proceso responsable de aportes. <br/>
 *
 * @author Steven Quintero González <squintero@heinsohn.com.co>
 */
public class SupervisorAportes extends DestinatarioNotificacion{

    /**
     * Referencia al logger
     */
    private final ILogger logger = LogManager.getLogger(SupervisorAportes.class);
    ...
    public List<CorreoPrioridadPersonaDTO> obtenerCorreoDestinatario(TipoTransaccionEnum tipoTx, Map<String, Object> parametros, EntityManager em) {
        ...
        ObtenerMiembrosGrupo obtenerMiembrosGrupo = new ObtenerMiembrosGrupo(GrupoEnum.SUPERVISOR_APORTES.getNombre(),null,EstadoUsuarioEnum.ACTIVO);
