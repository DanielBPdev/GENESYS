 ...
 * preventiva cuando el envío del comunicado es fallido.
 * @author Angélica Toro Murillo <atoro@heinsohn.com.co>
 */
public class EnvioComunicadoFallidoGestionPreventiva implements EnvioComunicado {
     ...
     */
    private static ILogger logger = LogManager.getLogger(EnvioComunicadoFallidoGestionPreventiva.class);
    ...
    public void procesar(NotificacionDTO notificacion) {
        logger.debug("Inicio de método EnvioComunicadoFallidoGestionPreventiva.procesar(NotificacionDTO notificacion)");
        ...
        if (intento != null) {
            ...
            if (intento.equals(PRIMERO)) {
                ...
                resultadoGestion.setContactoEfectivo(Boolean.FALSE);
                ...
                actualizarEstadoSolicitudPreventiva(numeroRadicado, EstadoSolicitudPreventivaEnum.NO_EXITOSA);
