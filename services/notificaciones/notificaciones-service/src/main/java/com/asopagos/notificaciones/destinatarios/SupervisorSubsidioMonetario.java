...
/**
 * Clase que representa al coordinador del proceso responsable de subsidio monetario. <br/>
 *
 * @author Steven Quintero González <squintero@heinsohn.com.co>
 */
public class SupervisorSubsidioMonetario extends DestinatarioNotificacion{

    /**
     * Referencia al logger
     */
    private final ILogger logger = LogManager.getLogger(SupervisorSubsidioMonetario.class);
    ...
    public List<CorreoPrioridadPersonaDTO> obtenerCorreoDestinatario(TipoTransaccionEnum tipoTx, Map<String, Object> parametros, EntityManager em) {
        ...
        ObtenerMiembrosGrupo obtenerMiembrosGrupo = new ObtenerMiembrosGrupo(GrupoEnum.SUPERVISOR_SUBSIDIO_MONETARIO.getNombre(),null,EstadoUsuarioEnum.ACTIVO);
