...
/**
 * Clase que representa al coordinador del proceso responsable de las afiliaciones de empleador. <br/>
 *
 * @author Steven Quintero González <squintero@heinsohn.com.co>
 */
public class SupervisorAfiliacionEmpleador extends DestinatarioNotificacion{

    /**
     * Referencia al logger
     */
    private final ILogger logger = LogManager.getLogger(SupervisorAfiliacionEmpleador.class);
    ...
    public List<CorreoPrioridadPersonaDTO> obtenerCorreoDestinatario(TipoTransaccionEnum tipoTx, Map<String, Object> parametros, EntityManager em) {
        ...
        ObtenerMiembrosGrupo obtenerMiembrosGrupo = new ObtenerMiembrosGrupo(GrupoEnum.SUPERVISOR_AFILIACION_EMPLEADOR.getNombre(),null,EstadoUsuarioEnum.ACTIVO);
