...
/**
 * Clase que representa al coordinador del proceso responsable de novedades de empleador. <br/>
 *
 * @author Steven Quintero González <squintero@heinsohn.com.co>
 */
public class SupervisorNovedadesEmpleador extends DestinatarioNotificacion{

    /**
     * Referencia al logger
     */
    private final ILogger logger = LogManager.getLogger(SupervisorNovedadesEmpleador.class);
    ...
    public List<CorreoPrioridadPersonaDTO> obtenerCorreoDestinatario(TipoTransaccionEnum tipoTx, Map<String, Object> parametros,
        ...
        ObtenerMiembrosGrupo obtenerMiembrosGrupo = new ObtenerMiembrosGrupo(GrupoEnum.SUPERVISOR_NOVEDADES_EMPLEADOR.getNombre(),null,EstadoUsuarioEnum.ACTIVO);
