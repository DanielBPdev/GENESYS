 ...
 * /rest/pila/marcarPlanillaAsistidaNotificada
 */
public class MarcarPlanillaAsistidaNotificada extends ServiceClient {
 
  
  	private Long idRegistroGeneral;
  
  
 	public MarcarPlanillaAsistidaNotificada (Long idRegistroGeneral){
 		super();
