 ...
 * /rest/pila/aprobarAportesAdicion
 */
public class AprobarAportesAdicion extends ServiceClient { 
 	...
 	public AprobarAportesAdicion (RegistrarCorreccionAdicionDTO criteriosSimulacion){
 		super();
