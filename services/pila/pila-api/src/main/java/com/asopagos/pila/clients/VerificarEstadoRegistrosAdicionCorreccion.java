 ...
 * /rest/pila/verificarEstadoRegistrosAdicionCorreccion
 */
public class VerificarEstadoRegistrosAdicionCorreccion extends ServiceClient {
 	...
 	public VerificarEstadoRegistrosAdicionCorreccion (Boolean actualizarEstado,Long idRegistroGeneral,FasePila2Enum FasePila2Enum){
 		super();
	...
	protected Response invoke(WebTarget webTarget, String path) {
		Response response = webTarget.path(path)
									.queryParam("actualizarEstado", actualizarEstado)
	 ...
	 */
	 public Map<String,String> getResult() {
  	...
  	public void setActualizarEstado (Boolean actualizarEstado){
 		this.actualizarEstado=actualizarEstado;
 	}
 	
 	public Boolean getActualizarEstado (){
