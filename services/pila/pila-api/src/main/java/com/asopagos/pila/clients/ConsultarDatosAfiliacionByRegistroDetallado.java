 ...
 * /rest/pila/consultarDatosAfiliacionByRegistroDetallado
 */
public class ConsultarDatosAfiliacionByRegistroDetallado extends ServiceClient {
 	...
 	public ConsultarDatosAfiliacionByRegistroDetallado(Long idRegDetallado){
 		super();
