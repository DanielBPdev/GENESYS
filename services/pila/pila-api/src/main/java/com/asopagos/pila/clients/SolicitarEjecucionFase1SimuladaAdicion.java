 ...
 * /rest/pila/solicitarEjecucionFase1SimuladaAdicion
 */
public class SolicitarEjecucionFase1SimuladaAdicion extends ServiceClient {
 	...
 	public SolicitarEjecucionFase1SimuladaAdicion (Long idIndicePlanilla){
 		super();
