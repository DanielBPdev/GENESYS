 ...
 * /rest/pila/aprobarProcesoNovedadesAdicionCorreccion
 */
public class AprobarProcesoNovedadesAdicionCorreccion extends ServiceClient { 
 	...
 	public AprobarProcesoNovedadesAdicionCorreccion (RegistrarCorreccionAdicionDTO criteriosSimulacion){
 		super();
