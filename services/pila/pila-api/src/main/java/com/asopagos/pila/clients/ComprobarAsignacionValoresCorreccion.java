 ...
 * /rest/pila/comprobarAsignacionValoresCorreccion
 */
public class ComprobarAsignacionValoresCorreccion extends ServiceClient { 
   	private Long idPlanillaCorrecion;
   
  
 	public ComprobarAsignacionValoresCorreccion (Long idPlanillaCorrecion){
 		super();
