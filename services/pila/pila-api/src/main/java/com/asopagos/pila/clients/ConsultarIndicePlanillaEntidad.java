 ...
 * /rest/pila/consultarIndicePlanillaEntidad
 */
public class ConsultarIndicePlanillaEntidad extends ServiceClient {
 	...
 	public ConsultarIndicePlanillaEntidad (Long idIndicePlanilla){
 		super();
	...
	protected void getResultData(Response response) {
		this.result = (IndicePlanilla) response.readEntity(IndicePlanilla.class);
	}
