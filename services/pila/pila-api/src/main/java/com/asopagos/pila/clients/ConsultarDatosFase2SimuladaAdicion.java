 ...
 * /rest/pila/consultarDatosFase2SimuladaAdicion
 */
public class ConsultarDatosFase2SimuladaAdicion extends ServiceClient { 
 	...
 	public ConsultarDatosFase2SimuladaAdicion (RegistrarCorreccionAdicionDTO criteriosSimulacion){
 		super();
