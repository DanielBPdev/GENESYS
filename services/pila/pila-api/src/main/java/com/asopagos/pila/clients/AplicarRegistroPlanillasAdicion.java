 ...
 * /rest/pila/aplicarRegistroPlanillasAdicion
 */
public class AplicarRegistroPlanillasAdicion extends ServiceClient { 
    	private DetalleTablaAportanteDTO registroPlanillaAdicion;
  
  
 	public AplicarRegistroPlanillasAdicion (DetalleTablaAportanteDTO registroPlanillaAdicion){
 		super();
