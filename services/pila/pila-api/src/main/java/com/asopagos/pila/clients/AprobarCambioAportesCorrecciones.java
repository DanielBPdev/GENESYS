 ...
 * /rest/pila/aprobarCambioAportesCorrecciones
 */
public class AprobarCambioAportesCorrecciones extends ServiceClient { 
 	...
 	public AprobarCambioAportesCorrecciones (RegistrarCorreccionAdicionDTO criteriosSimulacion){
 		super();
