 ...
 * /rest/cartera/consultarDetalleCiclo/{idCiclo}
 */
public class ConsultarDetalleCiclo extends ServiceClient {
 	...
 	public ConsultarDetalleCiclo (Long idCiclo,boolean gestionManual,boolean esSupervisor){
 		super();
