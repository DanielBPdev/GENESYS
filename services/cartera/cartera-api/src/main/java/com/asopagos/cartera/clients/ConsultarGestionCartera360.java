 ...
 * /rest/cartera/consultarGestionCartera360
 */
public class ConsultarGestionCartera360 extends ServiceClient { 
    	private GestionCarteraDTO gestionCarteraDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private GestionCarteraDTO result;
  
 	public ConsultarGestionCartera360 (GestionCarteraDTO gestionCarteraDTO){
 		super();
