 ...
 * /rest/cartera/consultarConveniosComunicado
 */
public class ConsultarConveniosComunicado extends ServiceClient { 
    	private List<Date> diasFestivos;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private List<ConvenioPagoModeloDTO> result;
  
 	public ConsultarConveniosComunicado (List<Date> diasFestivos){
 		super();
