 ...
 * /rest/cartera/consultarHistoricoConvenioPago
 */
public class ConsultarHistoricoConvenioPago extends ServiceClient {
 	...
 	public ConsultarHistoricoConvenioPago (TipoSolicitanteMovimientoAporteEnum tipoSolicitante,String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
	...
	protected void getResultData(Response response) {
		this.result = (List<ConvenioPagoModeloDTO>) response.readEntity(new GenericType<List<ConvenioPagoModeloDTO>>(){});
	}
