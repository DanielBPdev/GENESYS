 ...
 * /rest/cartera/{lineaCobro}/consultarTotalDetalleAportantes
 */
public class ConsultarTotalDetalleAportantes extends ServiceClient {
 	...
 	public ConsultarTotalDetalleAportantes (TipoLineaCobroEnum lineaCobro,TipoAccionCobroEnum accionCobro,String usuarioAnalista){
 		super();
