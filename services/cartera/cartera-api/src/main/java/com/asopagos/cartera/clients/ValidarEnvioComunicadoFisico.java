 ...
 * /rest/cartera/{numeroRadicacion}/validarEnvioComunicadoFisico
 */
public class ValidarEnvioComunicadoFisico extends ServiceClient {
 	...
 	public ValidarEnvioComunicadoFisico (String numeroRadicacion,TipoAccionCobroEnum tipoAccionCobro,Long idCartera){
 		super();
