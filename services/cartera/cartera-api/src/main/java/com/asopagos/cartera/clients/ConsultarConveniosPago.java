 ...
 * /rest/cartera/consultarConveniosPago
 */
public class ConsultarConveniosPago extends ServiceClient {
 	...
 	public ConsultarConveniosPago (TipoSolicitanteMovimientoAporteEnum tipoSolicitante,String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
