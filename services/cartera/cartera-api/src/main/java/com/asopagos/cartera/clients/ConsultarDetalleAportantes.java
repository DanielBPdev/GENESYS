 ...
 * /rest/cartera/{lineaCobro}/consultarDetalleAportantes
 */
public class ConsultarDetalleAportantes extends ServiceClient {
 	...
 	public ConsultarDetalleAportantes (TipoLineaCobroEnum lineaCobro,TipoAccionCobroEnum accionCobro,String usuarioAnalista){
 		super();
