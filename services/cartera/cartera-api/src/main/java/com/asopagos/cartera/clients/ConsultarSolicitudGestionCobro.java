 ...
 * /rest/cartera/{numeroRadicacion}/consultarSolicitudGestionCobro
 */
public class ConsultarSolicitudGestionCobro extends ServiceClient {
 	...
 	public ConsultarSolicitudGestionCobro (String numeroRadicacion){
 		super();
