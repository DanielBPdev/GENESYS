 ...
 * /rest/cartera/guardarSolicitudPreventiva
 */
public class GuardarSolicitudPreventiva extends ServiceClient { 
    	private SolicitudPreventivaModeloDTO solicitudPreventivaDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Long result;
  
 	public GuardarSolicitudPreventiva (SolicitudPreventivaModeloDTO solicitudPreventivaDTO){
 		super();
