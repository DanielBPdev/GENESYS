 ...
 * /rest/cartera/consultarHistoricoCicloManual
 */
public class ConsultarHistoricoCicloManual extends ServiceClient {
 	...
 	public ConsultarHistoricoCicloManual (Long fechaFin,Long fechaInicio){
 		super();
