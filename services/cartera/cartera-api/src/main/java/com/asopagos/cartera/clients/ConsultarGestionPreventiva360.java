 ...
 * /rest/cartera/consultarGestionPreventiva360
 */
public class ConsultarGestionPreventiva360 extends ServiceClient { 
    	private GestionCarteraDTO gestionCarteraDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private GestionCarteraDTO result;
  
 	public ConsultarGestionPreventiva360 (GestionCarteraDTO gestionCarteraDTO){
 		super();
