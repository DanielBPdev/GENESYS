 ...
 * /rest/cartera/{numeroRadicacion}/consultarAportantesSolicitudDesafiliacion
 */
public class ConsultarAportantesSolicitudDesafiliacion extends ServiceClient {
 	...
 	public ConsultarAportantesSolicitudDesafiliacion (String numeroRadicacion){
 		super();
