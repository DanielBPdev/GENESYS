 ...
 * /rest/subsidioMonetarioComposite/rechazarLiquidacionMasivaPrimerNivelComposite/{numeroSolicitud}/{idTarea}
 */
public class RechazarLiquidacionMasivaPrimerNivelComposite extends ServiceClient { 
  	private String numeroSolicitud;
  	private String idTarea;
    	private AprobacionRechazoSubsidioMonetarioDTO aprobacionRechazoSubsidioMonetarioDTO;
  
  
 	public RechazarLiquidacionMasivaPrimerNivelComposite (String numeroSolicitud,String idTarea,AprobacionRechazoSubsidioMonetarioDTO aprobacionRechazoSubsidioMonetarioDTO){
 		super();
