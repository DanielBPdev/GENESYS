 ...
 * /rest/subsidioMonetarioComposite/validarArchivoBloqueoCM
 */
public class ValidarArchivoBloqueoCM extends ServiceClient { 
    	private CargueArchivoBloqueoCMDTO cargue;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private ResultadoValidacionArchivoBloqueoCMDTO result;
  
 	public ValidarArchivoBloqueoCM (CargueArchivoBloqueoCMDTO cargue){
 		super();
		this.cargue=cargue;
 	}
