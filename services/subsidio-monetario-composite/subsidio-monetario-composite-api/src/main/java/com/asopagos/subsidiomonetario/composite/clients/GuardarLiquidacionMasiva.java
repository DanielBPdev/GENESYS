 ...
 * /rest/subsidioMonetarioComposite/guardarLiquidacionMasiva
 */
public class GuardarLiquidacionMasiva extends ServiceClient { 
 	...
 	public GuardarLiquidacionMasiva (Long periodo,SolicitudLiquidacionSubsidioModeloDTO liquidacion){
 		super();
