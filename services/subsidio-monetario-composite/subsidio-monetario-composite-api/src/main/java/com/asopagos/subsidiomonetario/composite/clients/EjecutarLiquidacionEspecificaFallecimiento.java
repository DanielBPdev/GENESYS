 ...
 * /rest/subsidioMonetarioComposite/ejecutarLiquidacionEspecificaFallecimiento
 */
public class EjecutarLiquidacionEspecificaFallecimiento extends ServiceClient { 
    	private LiquidacionEspecificaDTO liquidacionEspecifica;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private RespuestaGenericaDTO result;
  
 	public EjecutarLiquidacionEspecificaFallecimiento (LiquidacionEspecificaDTO liquidacionEspecifica){
 		super();
