 ...
 * /rest/subsidioMonetarioComposite/ejecutarLiquidacionEspecificaComposite
 */
public class EjecutarLiquidacionEspecificaComposite extends ServiceClient { 
    	private LiquidacionEspecificaDTO liquidacionEspecifica;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private RespuestaGenericaDTO result;
  
 	public EjecutarLiquidacionEspecificaComposite (LiquidacionEspecificaDTO liquidacionEspecifica){
 		super();
