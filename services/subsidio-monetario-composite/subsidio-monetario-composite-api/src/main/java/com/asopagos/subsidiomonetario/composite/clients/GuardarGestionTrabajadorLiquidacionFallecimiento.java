 ...
 * /rest/subsidioMonetarioComposite/guardar/gestionTrabajador/liquidacionFallecimiento/{numeroRadicacion}
 */
public class GuardarGestionTrabajadorLiquidacionFallecimiento extends ServiceClient { 
  	private String numeroRadicacion;
   	private Long idCondicionPersona;
  	private ConjuntoValidacionSubsidioEnum validacion;
   
  
 	public GuardarGestionTrabajadorLiquidacionFallecimiento (String numeroRadicacion,Long idCondicionPersona,ConjuntoValidacionSubsidioEnum validacion){
 		super();
