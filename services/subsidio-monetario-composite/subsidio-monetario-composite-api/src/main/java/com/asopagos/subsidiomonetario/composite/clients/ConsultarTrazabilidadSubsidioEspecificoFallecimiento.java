 ...
 * /rest/subsidioMonetarioComposite/consultarTrazabilidadSubsidioEspecificoFallecimiento/{numeroRadicacion}
 */
public class ConsultarTrazabilidadSubsidioEspecificoFallecimiento extends ServiceClient {
 	...
 	public ConsultarTrazabilidadSubsidioEspecificoFallecimiento (String numeroRadicacion){
 		super();
