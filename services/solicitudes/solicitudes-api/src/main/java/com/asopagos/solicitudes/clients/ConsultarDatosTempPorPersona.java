 ...
 * /rest/solicitudes/consultarDatosTemporales
 */
public class ConsultarDatosTempPorPersona extends ServiceClient {
 	...
 	public ConsultarDatosTempPorPersona (String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
