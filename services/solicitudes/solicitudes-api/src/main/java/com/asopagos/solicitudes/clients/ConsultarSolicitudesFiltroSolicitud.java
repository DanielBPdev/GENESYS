 ...
 * /rest/solicitudes/consultarSolicitudesFiltroSolicitud
 */
public class ConsultarSolicitudesFiltroSolicitud extends ServiceClient { 
    	private FiltroSolicitudDTO filtroSolicitud;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private List<ResultadoConsultaSolicitudDTO> result;
  
 	public ConsultarSolicitudesFiltroSolicitud (FiltroSolicitudDTO filtroSolicitud){
 		super();
