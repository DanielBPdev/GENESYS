 ...
 */
public class IniciarProcesoAfliliacionEmpleadoresPresencialSat extends ServiceClient { 
    	private ProcesoAfiliacionEmpleadoresPresencialDTO inDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Long result;
  
 	public IniciarProcesoAfliliacionEmpleadoresPresencialSat (ProcesoAfiliacionEmpleadoresPresencialDTO inDTO){
 		super();
		this.inDTO=inDTO;
 	}
