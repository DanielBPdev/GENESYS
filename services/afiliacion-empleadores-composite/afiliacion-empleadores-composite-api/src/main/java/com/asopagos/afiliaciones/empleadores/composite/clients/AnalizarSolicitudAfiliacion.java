 ...
 * /rest/solicitudAfiliacionEmpleador/analizarSolicitudAfiliacion
 */
public class AnalizarSolicitudAfiliacion extends ServiceClient { 
    	private AnalizarSolicitudAfiliacionDTO inDTO;
  
  
 	public AnalizarSolicitudAfiliacion (AnalizarSolicitudAfiliacionDTO inDTO){
 		super();
		this.inDTO=inDTO;
 	}
