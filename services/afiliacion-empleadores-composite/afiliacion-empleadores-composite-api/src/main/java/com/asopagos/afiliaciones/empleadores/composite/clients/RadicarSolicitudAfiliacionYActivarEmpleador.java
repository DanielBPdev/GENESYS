 ...
 */
public class RadicarSolicitudAfiliacionYActivarEmpleador extends ServiceClient { 
    	private RadicarSolicitudAfiliacionDTO inDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Map<String,Object> result;
  
 	public RadicarSolicitudAfiliacionYActivarEmpleador (RadicarSolicitudAfiliacionDTO inDTO){
 		super();
		this.inDTO=inDTO;
 	}
