...
public class InfoBasicaPersonaInDTO implements Serializable{
     ...
     */
    public InfoBasicaPersonaInDTO(TipoIdentificacionEnum tipoID, String identificacion) {
        this.tipoID = tipoID;
