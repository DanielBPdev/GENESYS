 ...
 * /rest/reportes/obtenerCategoriasConyugeAfiliado
 */
public class ObtenerCategoriasConyugeAfiliado extends ServiceClient {
 	...
 	public ObtenerCategoriasConyugeAfiliado (TipoIdentificacionEnum tipoIdAfiliado,TipoAfiliadoEnum tipoAfiliado,String numeroIdAfiliado){
 		super();
