...
/**
 * <b>Descripcion:</b> Clase que implementa el Reporte Único de Empleadores - Resolución 0074 de 2016<br/>
 * <b>Módulo:</b> Asopagos - HU <br/>
 *
 * @author <a href="mailto:abaquero@heinsohn.com.co"> Alfonso Baquero E.</a>
 */

public class ReporteNormativoRegistroUnicoEmpleadores extends ReporteNormativoAbstract {
    
    
    private final EntityManager entityManager;
    
    
    public ReporteNormativoRegistroUnicoEmpleadores(EntityManager entityManager) {
    ...
    public Integer pregenerarReporte(ReporteNormativoEnum reporteNormativo, Date fechaInicio, Date fechaFin) {
         ...
         try {
             resultado = Integer.parseInt(entityManager.createNamedQuery("Consultar.reporteNormativo.Count.UnicoEmpleadores")
	...
	protected List<String[]> generarData(GeneracionReporteNormativoDTO generacionReporteDTO) {  	
    	Date fechaFin = generacionReporteDTO.getFechaFin();
         ...
         try {
             data = entityManager.createNamedQuery("Consultar.reporteNormativo.UnicoEmpleadores")
                     .setParameter("fechaFin", fechaFin, TemporalType.DATE)
                     .getResultList();
         } catch (Exception e) {
             throw new TechnicalException(MensajesGeneralConstants.ERROR_TECNICO_INESPERADO, e);
