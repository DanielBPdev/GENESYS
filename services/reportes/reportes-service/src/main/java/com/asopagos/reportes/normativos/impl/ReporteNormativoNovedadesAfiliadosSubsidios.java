...
/**
 * <b>Descripcion:</b> Clase que implementa el reporte Archivo de novedades de afiliados y 
 * subsidios de compensación familiar <br/>
 * <b>Módulo:</b> Asopagos - reportes normativos<br/>
 *
 * @author  <a href="mailto:mosorio@heinsohn.com.co"> Miguel Angel osorio</a>
 */

public class ReporteNormativoNovedadesAfiliadosSubsidios extends ReporteNormativoAbstract {

    private final EntityManager entityManager;
    
    public ReporteNormativoNovedadesAfiliadosSubsidios(EntityManager entityManager){
    ...
    public Integer pregenerarReporte(ReporteNormativoEnum reporteNormativo, Date fechaInicio, Date fechaFin) {
         ...
         try {
             resultado= Integer.parseInt(entityManager.createNamedQuery("Consultar.reporteNormativo.Count.NovedadesAfiliadosSubsidios")
    ...
    protected List<String[]> generarData(GeneracionReporteNormativoDTO generacionReporteDTO) {   	
    	...
    	List<String[]> data = null;
         try {
             data = entityManager.createNamedQuery("Consultar.reporteNormativo.NovedadesAfiliadosSubsidios")
                     .setParameter("fechaFin", fechaFin, TemporalType.DATE)                    
                     .getResultList();
