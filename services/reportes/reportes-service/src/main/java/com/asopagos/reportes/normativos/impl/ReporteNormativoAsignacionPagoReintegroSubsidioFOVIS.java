 ...
 * <b>Código en la norma:</b> 5-443A <br>
 * <b>Descripción del reporte:</b> Reportar la información de Consolidado histórico asignaciones, pagos y reintegros.<br>
 ...
 */
public class ReporteNormativoAsignacionPagoReintegroSubsidioFOVIS extends ReporteNormativoAbstract {

    private final EntityManager entityManager;

    public ReporteNormativoAsignacionPagoReintegroSubsidioFOVIS(EntityManager entityManager) {
    ...
    public Integer pregenerarReporte(ReporteNormativoEnum reporteNormativo, Date fechaInicio, Date fechaFin) {
    	 Integer resultado = null;
          try {
              resultado= Integer.parseInt(entityManager.createNamedQuery("Consultar.reporteNormativo.count.AsignacionEntregaPagosFOVIS")
    ...
    protected List<String[]> generarEncabezado() {
        ...
        String[] encabezado = { "Año vigencia de asignación del subsidio","Código tipo plan de vivienda", "Estado del subsidio", 
        		"Cantidad de subsidios", "Valor subsidios" };
    ...
    protected List<String[]> generarData(GeneracionReporteNormativoDTO generacionReporteDTO) {    	
    	...
    	List<String[]> data = null;
          try {
              data = entityManager.createNamedQuery(NamedQueriesConstants.CONSULTAR_HISTORICO_ASIGNACIONES_PAGOS_REINTEGROS_FOVIS)
                      .setParameter("fechaFin", fechaFin, TemporalType.DATE)                   
                      .getResultList();         
          } catch (Exception e) {
              throw new TechnicalException(MensajesGeneralConstants.ERROR_TECNICO_INESPERADO, e);
