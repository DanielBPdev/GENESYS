...
public class ReporteNormativoEmpleadoresMorosos extends ReporteNormativoAbstract{

    private final EntityManager entityManager;
    
    public ReporteNormativoEmpleadoresMorosos(EntityManager entityManager){
    ...
    public Integer pregenerarReporte(ReporteNormativoEnum reporteNormativo, Date fechaInicio, Date fechaFin) {
        ...
        try {
            resultado= Integer.parseInt(entityManager.createNamedQuery("Consultar.reporteNormativo.Count.EmpleadoresMorosos")                    
    ...
    protected List<String[]> generarEncabezado() {
        ...
        String[] encabezado = {"Nombre de la empresa","NIT","Dirección","Ciudad","Representante legal", "Número de periodos sin pago",
        		"Presunto valor de cartera"};
    ...
    protected List<String[]> generarData(GeneracionReporteNormativoDTO generacionReporteDTO) {  
        ...
        try {
            data = entityManager.createNamedQuery("Consultar.reporteNormativo.EmpleadoresMorosos")                    
                    .setParameter("fechaFin", fechaFin, TemporalType.DATE)
                    .getResultList();
