...
public class ReporteNormativoAportantesProcesoEnUnidad extends ReporteNormativoAbstract{

    private final EntityManager entityManager;
    
    public ReporteNormativoAportantesProcesoEnUnidad(EntityManager entityManager){
    ...
    public String generarNombreArchivo(GeneracionReporteNormativoDTO generacionReporteDTO) {
        return GeneradorNombreArchivoUtil.generarNombreArchivoUGPP(generacionReporteDTO);
    }
    ...
    public Integer pregenerarReporte(ReporteNormativoEnum reporteNormativo, Date fechaInicio, Date fechaFin) {
        Integer resultado = null;      
            resultado= Integer.parseInt(entityManager.createNamedQuery(NamedQueriesConstants.CONSULTAR_RM_APORTANTES_PROCESO_EN_LA_UNIDAD_COUNT)
    ...
    protected List<String[]> generarData(GeneracionReporteNormativoDTO generacionReporteDTO) {     	
    	...
    	List<String[]> data = null;      
            data = entityManager.createNamedQuery(NamedQueriesConstants.CONSULTAR_RM_APORTANTES_PROCESO_EN_LA_UNIDAD)
                    .setParameter("fechaFin", fechaFin, TemporalType.DATE)                   
                    .getResultList();      
        return data;
    }
    ...
    public String obtenerValorTotalDeuda(Date fechaFin) {       
        String resultadoS = "";      
        resultadoS= entityManager.createNamedQuery(NamedQueriesConstants.CONSULTAR_RM_APORTANTES_PROCESO_EN_LA_UNIDAD_V_TOTAL)
                    .setParameter("fechaFin", fechaFin, TemporalType.DATE)                    
                    .getSingleResult().toString();        
        
        return resultadoS.substring(0, resultadoS.indexOf('.'));
    }
    */
