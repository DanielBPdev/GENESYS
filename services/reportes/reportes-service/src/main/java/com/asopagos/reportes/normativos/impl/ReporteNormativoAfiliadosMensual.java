...
public class ReporteNormativoAfiliadosMensual extends ReporteNormativoAbstract{

    private final EntityManager entityManager;
    
    public ReporteNormativoAfiliadosMensual(EntityManager entityManager){
    ...
    public Integer pregenerarReporte(ReporteNormativoEnum reporteNormativo, Date fechaInicio, Date fechaFin) {
       ...
       // try {
            resultado= Integer.parseInt(entityManager.createNamedQuery("Consultar.reporteNormativo.Count.AfiliadosMensual")
    ...
    protected List<String[]> generarData(GeneracionReporteNormativoDTO generacionReporteDTO) {  
    	...
    	List<String[]> data = null;      
            data = entityManager.createNamedQuery("Consultar.reporteNormativo.AfiliadosMensual")
                    //.setParameter("fechaInicio", fechaInicio, TemporalType.DATE)
                    .setParameter("fechaFin", fechaFin, TemporalType.DATE)
                    .getResultList();      
        return data;
