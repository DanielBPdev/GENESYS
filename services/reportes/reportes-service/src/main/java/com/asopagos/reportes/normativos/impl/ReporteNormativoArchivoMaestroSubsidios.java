...
public class ReporteNormativoArchivoMaestroSubsidios extends ReporteNormativoAbstract{
    
private final EntityManager entityManager;
    
    public ReporteNormativoArchivoMaestroSubsidios(EntityManager entityManager){
    ...
    public Integer pregenerarReporte(ReporteNormativoEnum reporteNormativo, Date fechaInicio, Date fechaFin) {
        ...
        try {
            resultado= Integer.parseInt(entityManager.createNamedQuery("Consultar.reporteNormativo.Count.ArchivoMaestroSubsidios")
    ...
    protected List<String[]> generarData(GeneracionReporteNormativoDTO generacionReporteDTO) {  
        ...
        try {
            data = entityManager.createNamedQuery("Consultar.reporteNormativo.ArchivoMaestroSubsidios")
                    .setParameter("fechaFin", fechaFin, TemporalType.DATE)                    
                    .getResultList();
