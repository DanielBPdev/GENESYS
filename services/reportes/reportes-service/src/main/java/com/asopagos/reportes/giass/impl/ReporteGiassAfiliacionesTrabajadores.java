...
public class ReporteGiassAfiliacionesTrabajadores extends ReporteGiassAbstract {

	private final EntityManager entityManager;

	public ReporteGiassAfiliacionesTrabajadores(EntityManager entityManager) {
		...
		this.fileName = "AFILIACIONES_TRABAJADORES";
	}
	...
	public List<String[]> obtenerDatos() {
		...
		List<Object[]> resultadoConsultaNativa = entityManager
				.createNamedQuery(NamedQueriesConstants.CONSULTAR_AFILIACIONES_TRABAJADORES_GIASS).getResultList();
