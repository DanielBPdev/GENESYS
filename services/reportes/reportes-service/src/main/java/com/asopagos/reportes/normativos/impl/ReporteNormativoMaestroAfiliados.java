...
public class ReporteNormativoMaestroAfiliados extends ReporteNormativoAbstract{

    private final EntityManager entityManager;
    
    public ReporteNormativoMaestroAfiliados(EntityManager entityManager){
    ...
    public Integer pregenerarReporte(ReporteNormativoEnum reporteNormativo, Date fechaInicio, Date fechaFin) {
       ...
       // try {
            resultado= Integer.parseInt(entityManager.createNamedQuery("Consultar.reporteNormativo.Count.MaestroAfiliados")                    
    ...
    protected List<String[]> generarEncabezado() {
        ...
        String[] encabezado = {"tipoRegistro","tipoIdentificacionAfiliado","numeroIdentificacionAfiliado","tipoIdentificacionPoblacion","numeroIdentificacionPoblacion","codigoGenero","fechaNacimiento","primerApellido","segundoApellido","primerNombre","segundoNombre","departamentoResidencia","MunicipioResidencia","fechaAfiliacion","codigoCaja","codTipoAfiliado","tipoIdentificacionAportante","numeroIdentificacionAportante","digitoVerficacionAportante","razonSocialAportante","fechaVinculacion","departamentroLaboral","municipioLaboral","alDia","codigoTipoMiembro","codigoCondicionBeneficiario","tipoRelacionConAfiliado"};
    ...
    protected List<String[]> generarData(GeneracionReporteNormativoDTO generacionReporteDTO) {   	
       ...
       // try {
            data = entityManager.createNamedQuery("Consultar.reporteNormativo.MaestroAfiliados")
                    .setParameter("fechaFin", fechaFin, TemporalType.DATE)                   
                    .getResultList();
        /*
        } catch (Exception e) {
