 ...
 * /rest/fovisComposite/cambiarEstadoProveedor
 */
public class CambiarEstadoProveedor extends ServiceClient {
 	...
 	public CambiarEstadoProveedor (EstadoOferenteEnum nuevoEstado,String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
