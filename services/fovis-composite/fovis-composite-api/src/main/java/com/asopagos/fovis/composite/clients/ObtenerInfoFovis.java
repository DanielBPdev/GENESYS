 ...
 * /rest/externalAPI/fovis/obtenerInfoFovis
 */
public class ObtenerInfoFovis extends ServiceClient {
 	...
 	public ObtenerInfoFovis (String numeroRad,String numeroID,TipoIdentificacionEnum tipoID){
 		super();
