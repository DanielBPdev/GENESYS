 ...
 * /rest/fovisComposite/verificarGestionPNCPostulacion
 */
public class VerificarGestionPNCPostulacion extends ServiceClient { 
    	private VerificacionGestionPNCPostulacionDTO datosVerificacion;
  
  
 	public VerificarGestionPNCPostulacion (VerificacionGestionPNCPostulacionDTO datosVerificacion){
 		super();
