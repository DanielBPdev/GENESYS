 ...
 * /rest/asignacionFovisComposite/cancelarEjecucionAsignacion
 */
public class CancelarEjecucionAsignacion extends ServiceClient { 
   	private Long idCicloAsignacion;
   
  
 	public CancelarEjecucionAsignacion (Long idCicloAsignacion){
 		super();
