 ...
 * /rest/fovisComposite/asignarSolicitudPostulacion
 */
public class AsignarSolicitudPostulacion extends ServiceClient { 
    	private AsignarSolicitudPostulacionDTO entrada;
  
  
 	public AsignarSolicitudPostulacion (AsignarSolicitudPostulacionDTO entrada){
 		super();
