 ...
 * /rest/asignacionFovisComposite/almacenarResultadoAsignacion
 */
public class AlmacenarResultadoAsignacion extends ServiceClient { 
 	...
 	public AlmacenarResultadoAsignacion (SolicitudAsignacionFOVISModeloDTO solicitudAsignacion){
 		super();
