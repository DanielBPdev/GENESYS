 ...
 * /rest/fovisComposite/gestionarPNCPostulacion
 */
public class GestionarPNCPostulacion extends ServiceClient { 
    	private GestionPNCPostulacionDTO entrada;
  
  
 	public GestionarPNCPostulacion (GestionPNCPostulacionDTO entrada){
 		super();
