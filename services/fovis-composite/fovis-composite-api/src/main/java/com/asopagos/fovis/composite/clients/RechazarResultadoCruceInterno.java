 ...
 * /rest/asignacionFovisComposite/rechazarResultadoCruceInterno
 */
public class RechazarResultadoCruceInterno extends ServiceClient { 
    	private AsignaResultadoCruceDTO asignarResultadoCruce;
  
  
 	public RechazarResultadoCruceInterno (AsignaResultadoCruceDTO asignarResultadoCruce){
 		super();
