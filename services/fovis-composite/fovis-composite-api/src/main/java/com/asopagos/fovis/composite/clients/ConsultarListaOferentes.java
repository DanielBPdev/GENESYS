 ...
 * /rest/fovisComposite/consultarListaOferentes
 */
public class ConsultarListaOferentes extends ServiceClient {
 	...
 	private List<OferenteDTO> result;
  
 	public ConsultarListaOferentes (String primerApellido,String primerNombre,String segundoApellido,String numeroIdentificacion,Short digitoIdentificacion,TipoIdentificacionEnum tipoIdentificacion,String segundoNombre,String razonSocial){
 		super();
	...
	protected void getResultData(Response response) {
		this.result = (List<OferenteDTO>) response.readEntity(new GenericType<List<OferenteDTO>>(){});
	}
	
	/**
	 * Retorna el resultado del llamado al servicio
	 */
	 public List<OferenteDTO> getResult() {
		return result;
	}
