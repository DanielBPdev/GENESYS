 ...
 * /rest/asignacionFovisComposite/consultarInformacionDocumentoSoporteActaAsignacion
 */
public class ConsultarInformacionDocumentoSoporteActaAsignacion extends ServiceClient {
 	...
 	public ConsultarInformacionDocumentoSoporteActaAsignacion (Long idSolicitudGlobal){
 		super();
