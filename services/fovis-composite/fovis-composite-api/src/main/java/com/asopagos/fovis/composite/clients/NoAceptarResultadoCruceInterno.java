 ...
 * /rest/asignacionFovisComposite/noAceptarResultadoCruceInterno
 */
public class NoAceptarResultadoCruceInterno extends ServiceClient { 
    	private AsignaResultadoCruceDTO asignarResultadoCruce;
  
  
 	public NoAceptarResultadoCruceInterno (AsignaResultadoCruceDTO asignarResultadoCruce){
 		super();
