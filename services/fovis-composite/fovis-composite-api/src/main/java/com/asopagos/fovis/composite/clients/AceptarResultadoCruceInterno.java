 ...
 * /rest/asignacionFovisComposite/aceptarResultadoCruceInterno
 */
public class AceptarResultadoCruceInterno extends ServiceClient { 
    	private AsignaResultadoCruceDTO asignarResultadoCruce;
  
  
 	public AceptarResultadoCruceInterno (AsignaResultadoCruceDTO asignarResultadoCruce){
 		super();
