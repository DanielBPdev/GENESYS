 ...
 * /rest/asignacionFovisComposite/rechazarResultadoSolicitudAsignacion
 */
public class RechazarResultadoSolicitudAsignacion extends ServiceClient { 
 	...
 	public RechazarResultadoSolicitudAsignacion (SolicitudAsignacionFOVISModeloDTO solicitudAsignacion){
 		super();
