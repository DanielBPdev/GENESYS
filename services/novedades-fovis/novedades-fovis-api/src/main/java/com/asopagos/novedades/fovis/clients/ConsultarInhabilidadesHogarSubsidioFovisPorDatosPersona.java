 ...
 * /rest/novedadesFovis/consultarInhabilidadesHogarSubsidioFovisPorDatosPersona
 */
public class ConsultarInhabilidadesHogarSubsidioFovisPorDatosPersona extends ServiceClient {
 	...
 	public ConsultarInhabilidadesHogarSubsidioFovisPorDatosPersona (String numeroIdentificacion,TipoIdentificacionEnum tipoIdentificacion){
 		super();
