 ...
 * /rest/novedadesFovis/consultarSolicitudAnalisis
 */
public class ConsultarSolicitudAnalisis extends ServiceClient {
 	...
 	public ConsultarSolicitudAnalisis (Long idSolicitud){
 		super();
