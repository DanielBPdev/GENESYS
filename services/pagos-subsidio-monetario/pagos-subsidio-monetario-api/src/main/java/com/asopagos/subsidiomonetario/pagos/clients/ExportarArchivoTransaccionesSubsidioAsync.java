 ...
 * /rest/pagosSubsidioMonetario/exportarArchivoTransaccionesSubsidioAsync
 */
public class ExportarArchivoTransaccionesSubsidioAsync extends ServiceClient { 
    	private DetalleTransaccionAsignadoConsultadoDTO transaccionConsultada;
  
  
 	public ExportarArchivoTransaccionesSubsidioAsync (DetalleTransaccionAsignadoConsultadoDTO transaccionConsultada){
 		super();
