 ...
 * /rest/pagosSubsidioMonetario/generarArchivoDetallesSubsidio
 */
public class GenerarArchivoDetallesSubsidio extends ServiceClient { 
    	private DetalleTransaccionAsignadoConsultadoDTO transaccionConsultada;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Map<String,String> result;
  
 	public GenerarArchivoDetallesSubsidio (DetalleTransaccionAsignadoConsultadoDTO transaccionConsultada){
 		super();
