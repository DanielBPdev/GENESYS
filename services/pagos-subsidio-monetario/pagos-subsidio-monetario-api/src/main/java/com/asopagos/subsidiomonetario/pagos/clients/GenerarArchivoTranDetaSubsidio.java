 ...
 * /rest/pagosSubsidioMonetario/generarArchivoTranDetaSubsidio
 */
public class GenerarArchivoTranDetaSubsidio extends ServiceClient { 
    	private DetalleTransaccionAsignadoConsultadoDTO transaccionConsultada;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Map<String,String> result;
  
 	public GenerarArchivoTranDetaSubsidio (DetalleTransaccionAsignadoConsultadoDTO transaccionConsultada){
 		super();
