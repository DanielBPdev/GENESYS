 ...
 * /rest/pagosSubsidioMonetario/dispersarPagos/estadoEnviado/origenAnulacion
 */
public class DispersarPagosEstadoEnviadoOrigenAnulacion extends ServiceClient {
 
  
  	private List<Long> identificadoresCuentas;
  
  
 	public DispersarPagosEstadoEnviadoOrigenAnulacion (List<Long> identificadoresCuentas){
 		super();
