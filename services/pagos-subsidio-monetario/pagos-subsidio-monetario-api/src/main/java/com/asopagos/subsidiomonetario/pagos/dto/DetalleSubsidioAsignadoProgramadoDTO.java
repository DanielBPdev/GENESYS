 ...
 */
@XmlRootElement
public class DetalleSubsidioAsignadoProgramadoDTO implements Serializable, Cloneable {
     ...
     * Constructor vacio
     */
    public DetalleSubsidioAsignadoProgramadoDTO() {
    }
     ...
     */
    public DetalleSubsidioAsignadoProgramadoDTO(DetalleSubsidioAsignado detalleSubsidioAsignado) {
     ...
     */
    public DetalleSubsidioAsignadoProgramadoDTO(DetalleSubsidioAsignado detalleSubsidioAsignado, Empleador empleador, Afiliado afiliado,
     ...
     */
    @Override
    public DetalleSubsidioAsignadoProgramadoDTO clone() {
        DetalleSubsidioAsignadoProgramadoDTO obj = null;
        try {
            obj = (DetalleSubsidioAsignadoProgramadoDTO) super.clone();
