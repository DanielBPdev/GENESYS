 ...
 * /rest/pagosSubsidioMonetario/anularSubsidioMonetarioConReemplazo
 */
public class AnularSubsidioMonetarioConReemplazo extends ServiceClient { 
 	...
 	public AnularSubsidioMonetarioConReemplazo (Boolean resultadoValidacion,SubsidioAnulacionDTO subsidioAnulacionDTO){
 		super();
