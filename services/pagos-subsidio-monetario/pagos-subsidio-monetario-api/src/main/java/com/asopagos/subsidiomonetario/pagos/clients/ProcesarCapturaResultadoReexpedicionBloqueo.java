 ...
 * /rest/pagosSubsidioMonetario/procesarCapturaResultadoReexpedicionBloqueo
 */
public class ProcesarCapturaResultadoReexpedicionBloqueo extends ServiceClient { 
    	private List<ResultadoReexpedicionBloqueoInDTO> listaConsulta;
  
  
 	public ProcesarCapturaResultadoReexpedicionBloqueo (List<ResultadoReexpedicionBloqueoInDTO> listaConsulta){
 		super();
