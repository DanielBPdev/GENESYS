 ...
 * /rest/pagosSubsidioMonetario/anularSubsidioMonetarioSinReemplazo
 */
public class AnularSubsidioMonetarioSinReemplazo extends ServiceClient { 
 	...
 	public AnularSubsidioMonetarioSinReemplazo (Boolean resultadoValidacion,SubsidioAnulacionDTO subsidioAnulacionDTO){
 		super();
