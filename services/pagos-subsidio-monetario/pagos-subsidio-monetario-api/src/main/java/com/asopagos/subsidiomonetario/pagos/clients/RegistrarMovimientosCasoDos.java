 ...
 * /rest/pagosSubsidioMonetario/registrarMovimientosCasoDos
 */
public class RegistrarMovimientosCasoDos extends ServiceClient { 
   	private Long idPersona;
   	private ResultadoReexpedicionBloqueoInDTO resultadoReexpedicion;
  
  
 	public RegistrarMovimientosCasoDos (Long idPersona,ResultadoReexpedicionBloqueoInDTO resultadoReexpedicion){
 		super();
