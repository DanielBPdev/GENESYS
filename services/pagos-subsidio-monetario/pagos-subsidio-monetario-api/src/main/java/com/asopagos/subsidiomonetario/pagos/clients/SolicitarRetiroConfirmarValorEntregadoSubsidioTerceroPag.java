 ...
 * /rest/pagosSubsidioMonetario/solicitarRetiro/solicitarRetiroConfirmarValorEntregadoSubsidioTerceroPag
 */
public class SolicitarRetiroConfirmarValorEntregadoSubsidioTerceroPag extends ServiceClient {
 	...
 	public SolicitarRetiroConfirmarValorEntregadoSubsidioTerceroPag (String departamento,BigDecimal valorSolicitado,Long idConvenio,Long idSitioPago,String idTransaccionTercerPagador,BigDecimal saldoActualSubsidio,String municipio,String numeroIdAdmin,String user,TipoMedioDePagoEnum medioDePago,Boolean isVentanilla,Long fecha,String usuario,TipoIdentificacionEnum tipoIdAdmin){
 		super();
	...
	protected Response invoke(WebTarget webTarget, String path) {
		Response response = webTarget.path(path)
						...
						.queryParam("idSitioPago", idSitioPago)
