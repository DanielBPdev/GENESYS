 ...
 * /rest/pagosSubsidioMonetario/consultar/cuentasAdministrador/medioTarjeta
 */
public class ConsultarCuentasAdminSubsidio extends ServiceClient {
 	...
 	public ConsultarCuentasAdminSubsidio (List<Long> listaIds){
 		super();
 	}
