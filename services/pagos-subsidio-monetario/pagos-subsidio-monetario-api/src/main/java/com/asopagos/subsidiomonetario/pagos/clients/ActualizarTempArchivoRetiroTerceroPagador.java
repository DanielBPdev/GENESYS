 ...
 * /rest/pagosSubsidioMonetario/actualizarTempArchivoRetiroTerceroPagador
 */
public class ActualizarTempArchivoRetiroTerceroPagador extends ServiceClient { 
    	private TempArchivoRetiroTerceroPagadorEfectivoDTO TempArchivoRetiroTerceroPagadorEfectivoDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Long result;
  
 	public ActualizarTempArchivoRetiroTerceroPagador (TempArchivoRetiroTerceroPagadorEfectivoDTO TempArchivoRetiroTerceroPagadorEfectivoDTO){
 		super();
