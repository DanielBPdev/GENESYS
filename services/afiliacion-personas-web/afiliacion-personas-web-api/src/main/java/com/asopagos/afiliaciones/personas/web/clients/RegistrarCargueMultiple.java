 ...
 * /rest/afiliacionesPersonasWebMultiple/registrarCargueMultiple/{idEmpleador}
 */
public class RegistrarCargueMultiple extends ServiceClient { 
 	...
 	public RegistrarCargueMultiple (Long idEmpleador,CargueMultipleDTO cargueMultipleDTO){
 		super();
