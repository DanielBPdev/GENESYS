 ...
 * /rest/legalizacionFovis/consultarPersonaOferente
 */
public class ConsultarPersonaOferente extends ServiceClient {
 	...
 	public ConsultarPersonaOferente (Long idPostulacionFovis){
 		super();
