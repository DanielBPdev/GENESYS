...
/**
 * Clase que contiene la lógica para Inactivar Beneficios Ley 1429 Año 2010
 * 
 ...
 *
 */
public class ActualizarInactivarBeneficiosLey1429 implements NovedadCore{

	private final ILogger logger = LogManager.getLogger(ActualizarInactivarBeneficiosLey1429.class);
	...
	public ServiceClient transformarServicio(SolicitudNovedadDTO solicitudNovedadDTO) {
		...
		/*Se instancia el servicio de la novedad Inactivar Beneficios Ley 1429 de 2010*/
		InactivarBeneficios inactivarBeneficiosLey1429 = new InactivarBeneficios(TipoBeneficioEnum.LEY_1429, datosEmpleador.getIdEmpleadoresPersona());

		return inactivarBeneficiosLey1429;
	}
