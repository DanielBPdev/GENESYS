...
import com.asopagos.personas.clients.InactivarCertificadoEscolaridad;
import com.asopagos.rest.security.dto.UserDTO;
import com.asopagos.services.common.ServiceClient;

/**
 * <b>Descripción:</b> Clase que contiene la lógica para Actualizar Vencimiento
 * de Certificado de escolaridad.
 * 
 ...
 *
 */
public class ActualizarVenciCertificadoEscolaridad implements NovedadCore{

	private final ILogger logger = LogManager.getLogger(ActualizarVenciCertificadoEscolaridad.class);
	...
	public ServiceClient transformarServicio(SolicitudNovedadDTO solicitudNovedadDTO) {
		logger.debug("Inicio de método ActualizarVenciCertificadoEscolaridad.transformarServicio");
		...
		InactivarCertificadoEscolaridad inactivarCertificadoEscolaridad = new InactivarCertificadoEscolaridad(datosPersona.getIdBeneficiarios());
		logger.debug("Fin de método ActualizarVenciCertificadoEscolaridad.transformarServicio");
		return inactivarCertificadoEscolaridad;
	}
