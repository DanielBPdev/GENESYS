 ...
 * /rest/novedadesComposite/consultarSolicitudNovedadDiferencia
 */
public class ConsultarSolicitudDiferencia extends ServiceClient {
 	...
 	public ConsultarSolicitudDiferencia (Long idSolicitud){
 		super();
