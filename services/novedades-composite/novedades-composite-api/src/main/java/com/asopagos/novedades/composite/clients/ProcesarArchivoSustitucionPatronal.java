 ...
 * /rest/novedadesMasivasComposite/procesarArchivoSustitucionPatronal
 */
public class ProcesarArchivoSustitucionPatronal extends ServiceClient { 
 	...
 	public ProcesarArchivoSustitucionPatronal (InformacionActualizacionNovedadDTO informacionActualizacionNovedadDTO){
 		super();
