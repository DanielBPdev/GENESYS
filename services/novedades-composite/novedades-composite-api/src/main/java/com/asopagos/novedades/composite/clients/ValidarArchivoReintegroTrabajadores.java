 ...
 * /rest/novedadesMasivasComposite/validarArchivoReintegroTrabajadores
 */
public class ValidarArchivoReintegroTrabajadores extends ServiceClient { 
   	private TipoArchivoRespuestaEnum tipoArchivo;
   	private CargueArchivoActualizacionDTO cargue;
  
  
 	public ValidarArchivoReintegroTrabajadores (TipoArchivoRespuestaEnum tipoArchivo,CargueArchivoActualizacionDTO cargue){
 		super();
