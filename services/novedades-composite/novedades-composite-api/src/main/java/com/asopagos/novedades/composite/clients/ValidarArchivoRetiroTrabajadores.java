 ...
 * /rest/novedadesMasivasComposite/validarArchivoRetiroTrabajadores
 */
public class ValidarArchivoRetiroTrabajadores extends ServiceClient { 
   	private TipoArchivoRespuestaEnum tipoArchivo;
   	private CargueArchivoActualizacionDTO cargue;
  
  
 	public ValidarArchivoRetiroTrabajadores (TipoArchivoRespuestaEnum tipoArchivo,CargueArchivoActualizacionDTO cargue){
 		super();
