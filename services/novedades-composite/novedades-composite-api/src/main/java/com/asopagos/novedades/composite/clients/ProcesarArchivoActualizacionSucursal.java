 ...
 * /rest/novedadesMasivasComposite/procesarArchivoActualizacionSucursal
 */
public class ProcesarArchivoActualizacionSucursal extends ServiceClient { 
 	...
 	public ProcesarArchivoActualizacionSucursal (InformacionActualizacionNovedadDTO informacionActualizacionNovedadDTO){
 		super();
