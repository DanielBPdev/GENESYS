 ...
 * /rest/novedadesMasivasComposite/validarArchivoConfirmacionAbonosBancario
 */
public class ValidarArchivoConfirmacionAbonosBancario extends ServiceClient { 
   	private TipoArchivoRespuestaEnum tipoArchivo;
   	private CargueArchivoActualizacionDTO cargue;
  
  
 	public ValidarArchivoConfirmacionAbonosBancario (TipoArchivoRespuestaEnum tipoArchivo,CargueArchivoActualizacionDTO cargue){
 		super();
