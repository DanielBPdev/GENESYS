 ...
 * /rest/novedadesMasivasComposite/validarNameArchivoSustitucionPatronal
 */
public class ValidarNameArchivoSustitucionPatronal extends ServiceClient { 
 	...
 	public ValidarNameArchivoSustitucionPatronal (TipoArchivoRespuestaEnum tipoArchivo,CargueArchivoActualizacionDTO cargue){
 		super();
