 ...
 * /rest/novedadesComposite/registrarNovedadInactivarBeneficiario
 */
public class RegistrarNovedadInactivarBeneficiario extends ServiceClient { 
    	private ProcesarNovedadCargueArchivoDTO procesarNovedadDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private SolicitudNovedadDTO result;
  
 	public RegistrarNovedadInactivarBeneficiario (ProcesarNovedadCargueArchivoDTO procesarNovedadDTO){
 		super();
