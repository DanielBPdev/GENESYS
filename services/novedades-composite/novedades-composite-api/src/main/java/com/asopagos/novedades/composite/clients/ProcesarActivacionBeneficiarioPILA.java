 ...
 * /rest/novedadesComposite/procesarActivacionBeneficiarioPILA
 */
public class ProcesarActivacionBeneficiarioPILA extends ServiceClient { 
    	private NovedadAportesDTO novedadAportesDTO;
  
  
 	public ProcesarActivacionBeneficiarioPILA (NovedadAportesDTO novedadAportesDTO){
 		super();
