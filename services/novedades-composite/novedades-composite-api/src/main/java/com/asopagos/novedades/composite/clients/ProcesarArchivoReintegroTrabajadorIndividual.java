 ...
 * /rest/novedadesMasivasComposite/procesarArchivoReintegroTrabajadorIndividual
 */
public class ProcesarArchivoReintegroTrabajadorIndividual extends ServiceClient { 
 	...
 	public ProcesarArchivoReintegroTrabajadorIndividual (InformacionActualizacionNovedadDTO informacionActualizacionNovedadDTO){
 		super();
