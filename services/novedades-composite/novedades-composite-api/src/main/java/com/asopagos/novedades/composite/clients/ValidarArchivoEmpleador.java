 ...
 * /rest/novedadesComposite/validarArchivoEmpleador
 */
public class ValidarArchivoEmpleador extends ServiceClient { 
    	
    private CargueArchivoActualizacionDTO cargue;
  
  
 	public ValidarArchivoEmpleador (CargueArchivoActualizacionDTO cargue){
 		super();
		this.cargue=cargue;
 	}
