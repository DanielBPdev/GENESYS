 ...
 * /rest/novedadesComposite/radicarSolicitudNovedadMasiva
 */
public class RadicarSolicitudNovedadMasiva extends ServiceClient { 
    	private SolicitudNovedadDTO solNovedadDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private SolicitudNovedadDTO result;
  
 	public RadicarSolicitudNovedadMasiva (SolicitudNovedadDTO solNovedadDTO){
 		super();
