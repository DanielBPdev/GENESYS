 ...
 * /rest/novedadesMasivasComposite/validarNameArchivoConfirmacionAbonosBancario
 */
public class ValidarNameArchivoConfirmacionAbonosBancario extends ServiceClient { 
 	...
 	public ValidarNameArchivoConfirmacionAbonosBancario (TipoArchivoRespuestaEnum tipoArchivo,CargueArchivoActualizacionDTO cargue){
 		super();
