...
public class VerificarEstructuraArchivoNovedadMasivaCambioMedioDePagoTransferencia extends ServiceClient{
    ...
    private TipoArchivoRespuestaEnum tipoArchivoRespuesta;
 	...
 	public VerificarEstructuraArchivoNovedadMasivaCambioMedioDePagoTransferencia (TipoArchivoRespuestaEnum tipoArchivoRespuesta,InformacionArchivoDTO archivo){
 		super();
