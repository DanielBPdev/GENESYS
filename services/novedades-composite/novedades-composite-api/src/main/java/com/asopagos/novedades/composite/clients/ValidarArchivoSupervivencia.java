 ...
 * /rest/novedadesComposite/validarArchivoSupervivencia
 */
public class ValidarArchivoSupervivencia extends ServiceClient { 
    	private ArchivoSupervivenciaDTO archivoSuperVivenciaDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private ResultadoValidacionArchivoDTO result;
  
 	public ValidarArchivoSupervivencia (ArchivoSupervivenciaDTO archivoSuperVivenciaDTO){
 		super();
