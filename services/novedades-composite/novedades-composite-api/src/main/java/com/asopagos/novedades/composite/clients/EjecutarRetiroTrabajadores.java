 ...
 * /rest/novedadesEspecialesComposite/ejecutarRetiroTrabajadores
 */
public class EjecutarRetiroTrabajadores extends ServiceClient { 
    	private RolAfiliadoModeloDTO rolAfiliadoModeloDTO;
  
  
 	public EjecutarRetiroTrabajadores (RolAfiliadoModeloDTO rolAfiliadoModeloDTO){
 		super();
