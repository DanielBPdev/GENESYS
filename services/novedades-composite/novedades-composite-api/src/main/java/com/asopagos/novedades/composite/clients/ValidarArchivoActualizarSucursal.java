 ...
 * /rest/novedadesMasivasComposite/validarArchivoActualizarSucursal
 */
public class ValidarArchivoActualizarSucursal extends ServiceClient { 
   	private TipoArchivoRespuestaEnum tipoArchivo;
   	private CargueArchivoActualizacionDTO cargue;
  
  
 	public ValidarArchivoActualizarSucursal (TipoArchivoRespuestaEnum tipoArchivo,CargueArchivoActualizacionDTO cargue){
 		super();
