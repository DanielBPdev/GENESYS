 ...
 * /rest/novedadesMasivasComposite/procesarArchivoRetiroBenficiarioIndividual
 */
public class ProcesarArchivoRetiroBenficiarioIndividual extends ServiceClient { 
 	...
 	public ProcesarArchivoRetiroBenficiarioIndividual (InformacionActualizacionNovedadDTO informacionActualizacionNovedadDTO){
 		super();
