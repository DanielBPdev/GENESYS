 ...
 * /rest/novedadesEspecialesComposite/ejecutarTrasladoBeneficiariosGrupoFamiliar
 */
public class EjecutarTrasladoBeneficiariosGrupoFamiliar extends ServiceClient { 
    	private BeneficiarioGrupoAfiliadoDTO beneficiarioGrupoAfiliadoDTO;
  
  
 	public EjecutarTrasladoBeneficiariosGrupoFamiliar (BeneficiarioGrupoAfiliadoDTO beneficiarioGrupoAfiliadoDTO){
 		super();
