 ...
 * /rest/novedadesComposite/validarArchivoCertificadoEscolar
 */
public class ValidarArchivoCertificadoEscolar extends ServiceClient { 
    	private CargueArchivoActualizacionDTO cargue;
  
  
 	public ValidarArchivoCertificadoEscolar (CargueArchivoActualizacionDTO cargue){
 		super();
		this.cargue=cargue;
 	}
