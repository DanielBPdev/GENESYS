 ...
 * /rest/novedadesComposite/registrarIntentoNovedad
 */
public class RegistrarIntentoFallido extends ServiceClient { 
    	private IntentoNovedadDTO intentoNovedadDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Long result;
  
 	public RegistrarIntentoFallido (IntentoNovedadDTO intentoNovedadDTO){
 		super();
