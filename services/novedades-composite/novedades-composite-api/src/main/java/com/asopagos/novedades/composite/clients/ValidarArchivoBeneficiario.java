 ...
 * /rest/novedadesComposite/validarArchivoBeneficiario
 */
public class ValidarArchivoBeneficiario extends ServiceClient { 
    	private CargueArchivoActualizacionDTO cargue;
  
  
 	public ValidarArchivoBeneficiario (CargueArchivoActualizacionDTO cargue){
 		super();
		this.cargue=cargue;
 	}
