 ...
 * /rest/novedadesComposite/validarArchivoAfiliado
 */
public class ValidarArchivoAfiliado extends ServiceClient { 
    	private CargueArchivoActualizacionDTO cargue;
  
  
 	public ValidarArchivoAfiliado (CargueArchivoActualizacionDTO cargue){
 		super();
		this.cargue=cargue;
 	}
