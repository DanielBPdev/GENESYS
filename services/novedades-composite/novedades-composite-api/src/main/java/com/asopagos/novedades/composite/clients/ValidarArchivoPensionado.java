 ...
 * /rest/novedadesComposite/validarArchivoPensionado
 */
public class ValidarArchivoPensionado extends ServiceClient { 
    	private CargueArchivoActualizacionDTO cargue;
  
  
 	public ValidarArchivoPensionado (CargueArchivoActualizacionDTO cargue){
 		super();
		this.cargue=cargue;
 	}
