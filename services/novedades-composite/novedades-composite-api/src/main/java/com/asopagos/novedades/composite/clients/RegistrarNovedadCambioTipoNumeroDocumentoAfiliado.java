 ...
 * /rest/novedadesComposite/registrarNovedadCambioTipoNumeroDocumentoAfiliado
 */
public class RegistrarNovedadCambioTipoNumeroDocumentoAfiliado extends ServiceClient { 
        private ProcesarNovedadCargueArchivoDTO procesarNovedadDTO;
  
    /** Atributo que almacena los datos resultado del llamado al servicio */
    private SolicitudNovedadDTO result;
  
    public RegistrarNovedadCambioTipoNumeroDocumentoAfiliado (ProcesarNovedadCargueArchivoDTO procesarNovedadDTO){
        super();
