 ...
 */
public class RadicarSolicitudNovedadArchivoActualizacion extends ServiceClient { 
 	...
 	public RadicarSolicitudNovedadArchivoActualizacion (Long idSolicitud,SolicitudNovedadDTO solNovedadDTO){
 		super();
