 ...
 * /rest/novedadesComposite/registrarNovedadCambioTipoNumeroDocumentoBeneficiario
 */
public class RegistrarNovedadCambioTipoNumeroDocumentoBeneficiario extends ServiceClient { 
        private ProcesarNovedadCargueArchivoDTO procesarNovedadDTO;
  
    /** Atributo que almacena los datos resultado del llamado al servicio */
    private SolicitudNovedadDTO result;
  
    public RegistrarNovedadCambioTipoNumeroDocumentoBeneficiario (ProcesarNovedadCargueArchivoDTO procesarNovedadDTO){
        super();
