...
public class PersonaComoAfiPpalGrupoFamiliarIDDTO implements Serializable {
    ...
    private List<BeneficiarioIDGrupoFamiliarDTO> beneficiarios;

    /**
     * Constructor por defecto
     */
    public PersonaComoAfiPpalGrupoFamiliarIDDTO() {
        super();
    }
     ...
     * @param beneficiarios
     */
    public PersonaComoAfiPpalGrupoFamiliarIDDTO(TipoIdentificacionEnum adminTipoIdentificacion, String adminNumeroIdentificacion,
            ...
            List<BeneficiarioIDGrupoFamiliarDTO> beneficiarios) {
     ...
     */
    public PersonaComoAfiPpalGrupoFamiliarIDDTO(String adminTipoIdentificacion, String adminNumeroIdentificacion, String adminPrimerNombre,
            ...
            String direccion, String codigoPostal, String indicativoTelFijo, String telefonoFijo, String telefonoCelular, String correo,
            Date fechaInicioAdminSubsidio, Boolean medioPagoActivo) {
        super();
     ...
     */
    public List<BeneficiarioIDGrupoFamiliarDTO> getBeneficiarios() {
     ...
     */
    public void setBeneficiarios(List<BeneficiarioIDGrupoFamiliarDTO> beneficiarios) {
