 ...
 * /rest/empleadores/validarRegistroRUES
 */
public class ValidarRegistroRUESFovis extends ServiceClient {
    	private DatosBasicosIdentificacionDTO datosBasicosIdentificacionDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Boolean result;
  
 	public ValidarRegistroRUESFovis(DatosBasicosIdentificacionDTO datosBasicosIdentificacionDTO){
 		super();
