 ...
 */
public class ValidarImpedimentosGIASSFovis extends ServiceClient {
    	private DatosBasicosIdentificacionDTO datosBasicosIdentificacionDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Boolean result;
  
 	public ValidarImpedimentosGIASSFovis(DatosBasicosIdentificacionDTO datosBasicosIdentificacionDTO){
 		super();
