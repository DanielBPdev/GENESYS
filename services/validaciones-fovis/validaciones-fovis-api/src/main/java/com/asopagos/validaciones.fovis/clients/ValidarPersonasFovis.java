 ...
 * /rest/validacionesFovisAPI/personas/validar
 */
public class ValidarPersonasFovis extends ServiceClient {
 	...
 	public ValidarPersonasFovis(String bloque, ProcesoEnum proceso, String objetoValidacion, Map<String,String> datosValidacion){
 		super();
		this.bloque=bloque;
