 ...
 */
public class ValidarDeudasPendientesFovis extends ServiceClient {
    	private DatosBasicosIdentificacionDTO datosBasicosIdentificacionDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Boolean result;
  
 	public ValidarDeudasPendientesFovis(DatosBasicosIdentificacionDTO datosBasicosIdentificacionDTO){
 		super();
