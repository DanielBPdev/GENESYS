 ...
 */
public class ValidarCargaMultipleAfiliacionesFovis extends ServiceClient {
 	...
 	public ValidarCargaMultipleAfiliacionesFovis(String bloque, ProcesoEnum proceso, String objetoValidacion, List<AfiliarTrabajadorCandidatoDTO> candidatosDTO){
 		super();
		this.bloque=bloque;
