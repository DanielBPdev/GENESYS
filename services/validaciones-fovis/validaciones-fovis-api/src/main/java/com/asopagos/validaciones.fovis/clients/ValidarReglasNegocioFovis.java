 ...
 * /rest/validacionesAPI/validarReglasNegocio
 */
public class ValidarReglasNegocioFovis extends ServiceClient {
 	...
 	public ValidarReglasNegocioFovis(String bloque, ProcesoEnum proceso, String objetoValidacion, Map<String,String> datosValidacion){
 		super();
		this.bloque=bloque;
