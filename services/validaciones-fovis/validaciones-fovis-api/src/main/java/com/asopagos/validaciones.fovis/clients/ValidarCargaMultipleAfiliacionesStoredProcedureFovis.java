 ...
 */
public class ValidarCargaMultipleAfiliacionesStoredProcedureFovis extends ServiceClient {
 	...
 	public ValidarCargaMultipleAfiliacionesStoredProcedureFovis(String bloque, ProcesoEnum proceso, String objetoValidacion, List<AfiliarTrabajadorCandidatoDTO> candidatosDTO){
 		super();
		this.bloque=bloque;
