 ...
 */
public class ExisteEnListasNegrasFovis extends ServiceClient {
    	private DatosBasicosIdentificacionDTO datosBasicosIdentificacionDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private Boolean result;
  
 	public ExisteEnListasNegrasFovis(DatosBasicosIdentificacionDTO datosBasicosIdentificacionDTO){
 		super();
