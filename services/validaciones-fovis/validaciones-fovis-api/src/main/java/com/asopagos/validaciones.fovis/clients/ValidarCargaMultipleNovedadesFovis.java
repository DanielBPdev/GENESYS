 ...
 * /rest/validacionesAPI/validarCargaMultipleNovedades
 */
public class ValidarCargaMultipleNovedadesFovis extends ServiceClient {
   	private String bloque;
  	private ProcesoEnum proceso;
  	private String objetoValidacion;
   	private List<TrabajadorCandidatoNovedadDTO> candidatosDTO;
  
  	/** Atributo que almacena los datos resultado del llamado al servicio */
 	private ListaDatoValidacionDTO result;
  
 	public ValidarCargaMultipleNovedadesFovis(String bloque, ProcesoEnum proceso, String objetoValidacion, List<TrabajadorCandidatoNovedadDTO> candidatosDTO){
 		super();
		this.bloque=bloque;
	...
	public ListaDatoValidacionDTO getResult() {
 	...
 	public String getObjetoValidacion (){
  	...
  	public void setCandidatosDTO (List<TrabajadorCandidatoNovedadDTO> candidatosDTO){
 		this.candidatosDTO=candidatosDTO;
 	}
 	
 	public List<TrabajadorCandidatoNovedadDTO> getCandidatosDTO (){
