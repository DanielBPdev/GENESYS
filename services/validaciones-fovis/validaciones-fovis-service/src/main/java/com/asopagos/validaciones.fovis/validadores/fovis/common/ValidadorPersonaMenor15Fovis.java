 ...
 */
public class ValidadorPersonaMenor15Fovis extends ValidadorFovisAbstract {
		...
		try {
			...
			if (datosValidacion != null && !datosValidacion.isEmpty()) {
				...
				if (fechaNacimientoLong == null || fechaNacimientoLong.equals("")) {
					...
					String fechaNacimiento = ValidacionFovisPersonaUtils.convertirFecha(fechaNacimientoLong);
					if (tipoIdentificacion != null && numeroIdentificacion != null
						...
						if (existe && personaDetalle.getFechaNacimiento() != null) {
							 ...
							 * nacimiento guardada
							 */
							fechaNacimiento = ValidacionFovisPersonaUtils
									.convertirFecha(personaDetalle.getFechaNacimiento().getTime() + "");

						}
						int edadPersona = ValidacionFovisPersonaUtils.calcularEdadAnos(fechaNacimiento);
