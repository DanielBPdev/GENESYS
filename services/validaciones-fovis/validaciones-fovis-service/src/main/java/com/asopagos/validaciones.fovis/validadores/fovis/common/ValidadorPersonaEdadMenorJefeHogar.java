...
/**
 * Clase que contiene la lógica para validar cuando la persona es menor al jefe hogar
 * 
 * @author Jose Arley Correa Salama <jocorrea@heinsohn.com.co>
 */
public class ValidadorPersonaEdadMenorJefeHogar extends ValidadorFovisAbstract {

    @Override
    public ValidacionDTO execute(Map<String, String> datosValidacion) {
        try {
            logger.debug("Inicio ValidadorPersonaEdadMenorJefeHogar");
            ...
            if (fechaNacimiento == null || fechaNacimiento.equals("")) {
                return crearMensajeExitoso(ValidacionCoreEnum.VALIDACION_PERSONA_MENOR_JEFE);
            }
            ...
            if (personaEncontrado != null && personaDetalle != null) {
                ...
                if (fNacimiento.getTime() > personaDetalle.getFechaNacimiento().getTime()) {
                    return crearValidacion(myResources.getString(ConstantesValidaciones.KEY_PERSONA_MENOR_JEFE),
                            ResultadoValidacionEnum.NO_APROBADA, ValidacionCoreEnum.VALIDACION_PERSONA_MENOR_JEFE,
    ...
    private ValidacionDTO crearMensajeNoEvaluado() {
        return crearValidacion(
                myResources.getString(ConstantesValidaciones.KEY_MENSAJE_NO_EV) + SEPARADOR
                        + myResources.getString(ConstantesValidaciones.KEY_PERSONA_MENOR_JEFE),
                ResultadoValidacionEnum.NO_EVALUADA, ValidacionCoreEnum.VALIDACION_PERSONA_MENOR_JEFE,
