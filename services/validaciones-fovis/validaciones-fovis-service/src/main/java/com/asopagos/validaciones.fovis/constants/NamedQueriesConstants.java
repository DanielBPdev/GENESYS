...
public class NamedQueriesConstants {
    ...
    /**
     * GLPI 89391 Consulta los tipo de trabsaciones de las solicitudes de novedades que pueda tener asociadas la persona al momento de la consulta
     */
    ...
    public static final String CONSULTAR_ASIGNACION_MISMO_ANIO = "Validaciones.Postulacion.Asignada.Mismo.Anio";
