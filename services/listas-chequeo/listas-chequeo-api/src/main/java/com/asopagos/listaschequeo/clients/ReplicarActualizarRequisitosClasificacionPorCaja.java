 ...
 * /rest/requisitos/clasificacionesPorCaja
 */
public class ReplicarActualizarRequisitosClasificacionPorCaja extends ServiceClient { 
    	private List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion;
  
  
 	public ReplicarActualizarRequisitosClasificacionPorCaja (List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion){
 		super();
	...
	protected Response invoke(WebTarget webTarget, String path) {
		Response response = webTarget.path(path)
			...
			.put(requisitosCajaClasificacion == null ? null : Entity.json(requisitosCajaClasificacion));
		return response;
	}
