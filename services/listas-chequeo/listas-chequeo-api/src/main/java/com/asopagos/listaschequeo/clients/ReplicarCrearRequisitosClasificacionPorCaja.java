 ...
 */
public class ReplicarCrearRequisitosClasificacionPorCaja extends ServiceClient { 
    	private List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion;
  
  
 	public ReplicarCrearRequisitosClasificacionPorCaja (List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion){
 		super();
