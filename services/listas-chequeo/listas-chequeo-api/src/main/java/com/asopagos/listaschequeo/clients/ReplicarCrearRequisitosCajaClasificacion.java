 ...
 */
public class ReplicarCrearRequisitosCajaClasificacion extends ServiceClient { 
    	private List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion;
  
  
 	public ReplicarCrearRequisitosCajaClasificacion (List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion){
 		super();
