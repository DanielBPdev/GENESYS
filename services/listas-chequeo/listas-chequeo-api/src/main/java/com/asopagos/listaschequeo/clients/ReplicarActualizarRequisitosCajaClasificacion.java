 ...
 */
public class ReplicarActualizarRequisitosCajaClasificacion extends ServiceClient { 
    	private List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion;
  
  
 	public ReplicarActualizarRequisitosCajaClasificacion (List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion){
 		super();
