 ...
 */
public class ActualizarRequisitosCajaClasificacion extends ServiceClient { 
    	private List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion;
  
  
 	public ActualizarRequisitosCajaClasificacion (List<RequisitoCajaClasificacionDTO> requisitosCajaClasificacion){
 		super();
