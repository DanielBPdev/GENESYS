 ...
 * /rest/subsidioMonetario/consultarCondicionesPorAnio
 */
public class ConsultarCondicionesPorAnio extends ServiceClient {
 	...
 	public ConsultarCondicionesPorAnio (Integer anio){
 		super();
		this.anio=anio;
 	}
