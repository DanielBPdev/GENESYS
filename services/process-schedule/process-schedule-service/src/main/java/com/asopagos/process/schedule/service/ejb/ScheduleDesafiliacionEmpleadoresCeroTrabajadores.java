...
/**
 * <b>Descripción:</b> EJB Singleton que ejecuta el proceso automático de Desafiliación de Empleadores por Cero
 * Trabajadores.
 * Novedad 30.
 * 
...
@Singleton
@Startup
public class ScheduleDesafiliacionEmpleadoresCeroTrabajadores extends ScheduleAbstract {

    /**
     * Instancia del gestor de registro de eventos.
     */
    private static final ILogger logger = LogManager.getLogger(ScheduleDesafiliacionEmpleadoresCeroTrabajadores.class);
     ...
     * 
     */
    private static final ProcesoAutomaticoEnum CURRENT_PROCESS = ProcesoAutomaticoEnum.DESAFILIAR_AUTOMATICAMENTE_EMPLEADORES_CERO_TRABAJADORES;
    ...
    public void run(Timer timer) {
        logger.debug("Inicio de método ScheduleDesafiliacionEmpleadoresCeroTrabajadores.run(Timer timer)");
        ...
        try {
            ...
            solNovedadDTO.setTipoTransaccion(TipoTransaccionEnum.DESAFILIAR_AUTOMATICAMENTE_EMPLEADORES_CERO_TRABAJADORES);
            ...
            logger.debug("Fin de método ScheduleDesafiliacionEmpleadoresCeroTrabajadores.run(Timer timer)");

        } catch (Exception e) {
            logger.error("Ocurrió un error inesperado en ScheduleDesafiliacionEmpleadoresCeroTrabajadores.run(Timer timer)", e);
