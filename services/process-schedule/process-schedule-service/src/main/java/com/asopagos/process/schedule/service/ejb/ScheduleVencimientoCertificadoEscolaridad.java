...
@Singleton
@Startup
public class ScheduleVencimientoCertificadoEscolaridad extends ScheduleAbstract {

    /**
     * Instancia del gestor de registro de eventos.
     */
    private static final ILogger logger = LogManager.getLogger(ScheduleVencimientoCertificadoEscolaridad.class);

    /**
     * 
     */
    private static final ProcesoAutomaticoEnum CURRENT_PROCESS = ProcesoAutomaticoEnum.VENCIMIENTO_AUTOMATICO_CERTIFICADOS;
    ...
    public void run(Timer timer) {
        logger.debug("Inicio de método ScheduleVencimientoCertificadoEscolaridad.run(Timer timer)");
        try {
            ...
            solNovedadDTO.setTipoTransaccion(TipoTransaccionEnum.VENCIMIENTO_AUTOMATICO_CERTIFICADOS);
            ...
            logger.debug("Fin de método ScheduleVencimientoCertificadoEscolaridad.run(Timer timer)");
        } catch (Exception e) {
            logger.error("Ocurrió un error inesperado en ScheduleVencimientoCertificadoEscolaridad.run(Timer timer)", e);
