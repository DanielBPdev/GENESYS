...
@Singleton
@Startup
public class ScheduleCargaArchivosDescuento extends ScheduleAbstract {

    /**
     * Instancia del gestor de registro de eventos.
     */
    private static final ILogger logger = LogManager.getLogger(ScheduleCargaArchivosDescuento.class);

    /**
     * 
     */
    private final static ProcesoAutomaticoEnum CURRENT_PROCESS = ProcesoAutomaticoEnum.CARGA_AUTOMATICA_ARCHIVOS_DESCUENTO;
    ...
    public void run(Timer timer) {
        ...
        try {
            ...
            CargarAutomaticamenteArchivosEntidadDescuentoComposite cargaAutomatica = new CargarAutomaticamenteArchivosEntidadDescuentoComposite();
