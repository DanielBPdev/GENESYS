...
@Singleton
@Startup
public class ScheduleCambioCategoriaCircularUnicaEntreEdades extends ScheduleAbstract {

    private final static ProcesoAutomaticoEnum CURRENT_PROCESS = ProcesoAutomaticoEnum.CAMBIO_AUTOMATICO_CATEGORIA_BENEFICIARIO_CIRCULAR_UNICA_ENTRE_X_EDAD;
    ...
    public void run(Timer timer) {
        ...
        try {            
            ...
            solNovedadDTO.setObservaciones("sinCertificado");
